...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'glow': '0 0 20px rgba(200, 73, 42, 0.25)',
        'glow-lg': '0 0 40px rgba(200, 73, 42, 0.35)',
        'glow-amber': '0 0 30px rgba(232, 150, 10, 0.15)',
        'glow-gold': '0 0 30px rgba(232, 150, 10, 0.4)',
        'glow-terra': '0 0 30px rgba(200, 73, 42, 0.2)',
        ...
        'glow-clay': '0 0 30px rgba(200, 73, 42, 0.3)',
        'inner-glow': 'inset 0 1px 0 0 rgba(255, 255, 255, 0.1)',
        'card-hover': '0 20px 40px -12px rgba(28, 25, 23, 0.1), 0 8px 20px -8px rgba(200, 73, 42, 0.08)',
        'cta': '0 4px 14px 0 rgba(200, 73, 42, 0.3)',
        'cta-hover': '0 8px 25px 0 rgba(200, 73, 42, 0.4)',
      ...
      backgroundImage: {
        ...
        'gradient-primary': 'linear-gradient(135deg, #E0723F 0%, #A23A1F 100%)',
        ...
        'gradient-hero-warm': 'linear-gradient(135deg, #5A2011 0%, #A23A1F 50%, #E0723F 100%)',
        ...
        'gradient-terra': 'linear-gradient(135deg, #A23A1F 0%, #E0723F 50%, #EA9670 100%)',
      ...
      keyframes: {
        ...
        pulseSubtle: {
          '0%, 100%': { boxShadow: '0 4px 14px 0 rgba(200, 73, 42, 0.3)' },
          '50%': { boxShadow: '0 8px 30px 0 rgba(200, 73, 42, 0.45)' },
        },
        'gradient-x': {
