  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        dureeVie: '15-20 ans',
        idealPour:
          "Petits logements bien isolés, résidences secondaires, budgets d'installation serrés",
      },
      {
        name: 'Pompe à chaleur air/eau',
        avantages: [
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        dureeVie: '50-100 ans',
        idealPour:
          'Toitures plates ou faible pente, architecture contemporaine, extensions, Paris/Haussmann',
      },
    ],
    verdict:
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        idealPour:
          'Régions ensoleillées (Sud, Ouest), maisons avec toiture sud, démarche écologique',
      },
    ],
    verdict:
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        dureeVie: '25-40 ans',
        idealPour:
          'Terrasses de vie, usage 4 saisons, investissement durable, maisons contemporaines',
      },
      {
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        dureeVie: '50-100 ans',
        idealPour:
          'Lofts, intérieurs industriels, escaliers extérieurs, architecture contemporaine',
      },
      {
        name: 'Escalier béton',
        avantages: [
...

  {
    ...
    options: [
      ...
      },
      {
        ...
        dureeVie: '15-20 ans',
        idealPour:
          'Maisons avec chauffage central, projets de rénovation globale, éligibles aux aides',
      },
    ],
    verdict:
    ...
    options: [
      {
        ...
        idealPour:
          'Rénovation rapide, pièces humides, plafonds abîmés ou irréguliers, design contemporain',
      },
      {
        ...
        dureeVie: '20-40 ans',
        idealPour:
          'Isolation thermique/phonique, intégration de spots, passage de gaines, budget maîtrisé',
      },
    ],
    verdict:
    ...
    options: [
      {
        ...
        dureeVie: '30-50 ans',
        idealPour:
          'Rez-de-chaussée, zones à risque, besoin de sécurité maximale, construction neuve',
      },
      {
...

  {
    ...
    options: [
      ...
      },
      {
        ...
        dureeVie: '25-50 ans',
        idealPour:
          'Rénovation avec chauffage au sol, bon compromis qualité/prix, pose rapide souhaitée',
      },
      {
        name: 'Sol stratifié',
        avantages: [
    ...
    options: [
      {
        ...
        idealPour:
          'Grandes ouvertures, personnes âgées ou PMR, projet domotique, confort au quotidien',
      },
      {
    ...
    options: [
      {
        ...
        dureeVie: '30-50 ans',
        idealPour:
          'Style contemporain, grandes surfaces vitrées, entretien minimal, toutes régions',
      },
      {
        ...
        idealPour:
          'Maisons de caractère, style traditionnel, sensibilité écologique, bel investissement',
      },
      {
        name: 'Véranda en PVC',
        avantages: [
