...
export const servicePricings: ServicePricing[] = [
  ...
  },
  {
    ...
    interventions: [
      ...
      {
        name: 'Installation point lumineux',
        prixMin: 80,
        prixMax: 200,
        unite: 'point lumineux',
        tendance: 'stable',
        variation: 1.2,
      },
      {
        name: 'Pose prise électrique',
        prixMin: 60,
        prixMax: 150,
        unite: 'intervention',
        tendance: 'stable',
  ...
  // Pivot full RGE 2026-05-03 : entrée 'serrurier' retirée (commodity hors RGE).
  {
    ...
    interventions: [
      ...
      {
        name: 'Remplacement chaudière gaz',
        prixMin: 3000,
        prixMax: 7000,
        unite: 'intervention',
        tendance: 'hausse',
      ...
      {
        name: 'Installation plancher chauffant',
        prixMin: 50,
        prixMax: 120,
        unite: 'm²',
        tendance: 'stable',
  ...
  },
  {
    ...
    interventions: [
      ...
      {
        name: 'Peinture boiseries et huisseries',
        prixMin: 15,
        prixMax: 35,
        unite: 'ml',
        tendance: 'stable',
  ...
  },
  {
    ...
    interventions: [
      {
        name: 'Pose fenêtre double vitrage',
        prixMin: 300,
        prixMax: 800,
        unite: 'intervention',
        tendance: 'hausse',
  ...
  },
  {
    ...
    interventions: [
      {
        name: 'Construction mur en parpaings',
        prixMin: 40,
        prixMax: 100,
        unite: 'm²',
        tendance: 'hausse',
      ...
      {
        name: 'Ouverture dans mur porteur',
        prixMin: 1500,
        prixMax: 5000,
        unite: 'intervention',
        tendance: 'hausse',
