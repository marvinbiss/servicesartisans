...
export const existingArticles: Record<string, BlogArticle> = {
  'comment-choisir-son-plombier': {
    ...
    content: [
      ...
      "## 2. Demandez plusieurs devis détaillés\n\n### La règle des trois devis\n\nNe vous contentez jamais d'un seul devis. Comparez au moins trois propositions pour avoir une idée réaliste des prix du marché. Selon une étude de l'UFC-Que Choisir, les écarts de prix entre artisans peuvent atteindre 50 % pour une même prestation.\n\n### Ce que doit contenir un bon devis\n\nChaque devis doit obligatoirement mentionner :\n\n1. Les coordonnées complètes de l'entreprise et son numéro SIRET\n2. La description détaillée de chaque prestation\n3. Les quantités et prix unitaires des matériaux\n4. Le coût de la main-d'œuvre\n5. Le montant total HT et TTC avec le taux de TVA applicable\n6. La durée de validité du devis\n7. Les conditions et l'échéancier de paiement\n\n:::warning Attention\nMéfiez-vous des devis anormalement bas qui peuvent cacher des matériaux de mauvaise qualité, une absence d'assurance ou des coûts supplémentaires non annoncés. Un devis 30 % en dessous du marché est un signal d'alerte.\n:::\n\nPour approfondir l'analyse de vos devis, consultez notre guide sur [comment lire et comprendre un devis de travaux](/blog/devis-travaux-comprendre).",
      "## 3. Consultez les avis et références clients\n\n### Les avis en ligne\n\nLes avis en ligne sont précieux mais doivent être analysés avec discernement. Sur ServicesArtisans, tous nos artisans sont évalués par leurs clients après chaque intervention. Privilégiez les professionnels avec :\n\n- Une note supérieure à 4/5\n- Au moins 10 avis vérifiés\n- Des commentaires détaillés mentionnant la ponctualité, la propreté et la qualité du travail\n\n### Les références de chantier\n\nDemandez des références de chantiers similaires au vôtre. Un plombier sérieux sera fier de vous montrer des photos de ses réalisations précédentes et de vous mettre en contact avec d'anciens clients satisfaits.\n\n:::info Bon à savoir\nLes avis Google, bien que populaires, sont moins fiables que ceux des plateformes spécialisées car ils ne sont pas systématiquement vérifiés. Privilégiez les plateformes qui exigent une preuve d'intervention avant de publier un avis.\n:::",
      "## 4. Vérifiez les assurances obligatoires\n\n### La responsabilité civile professionnelle\n\nUn plombier professionnel doit obligatoirement disposer d'une assurance responsabilité civile professionnelle (RC Pro). Cette assurance couvre les dommages causés à des tiers pendant l'intervention : dégât des eaux chez un voisin, détérioration d'un revêtement, blessure accidentelle.\n\n### La garantie décennale\n\nPour les travaux importants touchant au gros œuvre ou aux éléments indissociables du bâtiment (canalisations encastrées, système de chauffage central), la [garantie décennale](/blog/garantie-decennale-tout-savoir) est obligatoire. Elle couvre pendant 10 ans les dommages compromettant la solidité de l'ouvrage ou le rendant impropre à sa destination.\n\n:::warning Attention\nDemandez systématiquement une copie de l'attestation d'assurance en cours de validité avant le début des travaux. Un artisan qui refuse de la fournir ne doit pas être retenu, quel que soit son prix.\n:::",
      "## 5. Évaluez la réactivité et le professionnalisme\n\n### La communication, un critère clé\n\nLa communication est essentielle dans la relation avec votre plombier. Un bon professionnel :\n\n- Répond rapidement à vos demandes (sous 24 à 48 heures)\n- Se présente à l'heure aux rendez-vous\n- Explique clairement les travaux à réaliser et les différentes options\n- Vous tient informé de l'avancement du chantier\n- Fournit un devis écrit avant toute intervention\n\n### Les signaux d'alerte\n\nMéfiez-vous d'un artisan qui :\n\n- Refuse de fournir un devis écrit\n- Demande un acompte supérieur à 30 % du montant total\n- Exige un paiement en espèces\n- Ne dispose pas d'un numéro SIRET vérifiable\n- Fait du [démarchage à domicile](/blog/artisan-pas-cher-attention-arnaques) non sollicité",
      "## 6. Comprenez les tarifs et modes de facturation\n\n### Les différents modes de tarification\n\nLes plombiers facturent généralement selon trois modes :\n\n- **Au forfait** : prix global pour une prestation définie (le plus sécurisant pour vous)\n- **À l'heure** : tarif horaire + fournitures (attention aux dépassements)\n- **Au mètre linéaire** : pour les travaux de canalisation\n\n:::budget\n| Prestation | Prix moyen en 2026 |\n| Tarif horaire (province) | 40 - 70 € HT |\n| Tarif horaire (Île-de-France) | 60 - 90 € HT |\n| Débouchage canalisation | 80 - 250 € |\n| Remplacement robinet | 80 - 150 € |\n| Réparation de fuite | 100 - 300 € |\n| Installation chauffe-eau | 300 - 800 € (hors fournitures) |\n:::\n\nPour un panorama complet des tarifs, consultez notre article dédié sur le [prix d'un plombier en 2026](/blog/prix-plombier-2026-tarifs-horaires).",
      "## 7. Privilégiez le bouche-à-oreille et les plateformes vérifiées\n\n### Le réseau personnel\n\nLe bouche-à-oreille reste le moyen le plus fiable de trouver un bon plombier. Interrogez votre entourage : famille, amis, voisins, collègues. Une recommandation personnelle vaut souvent mieux que des dizaines d'avis en ligne.\n\n### Les plateformes spécialisées\n\nSur ServicesArtisans, chaque professionnel est [vérifié via le numéro SIREN](/blog/trouver-artisan-verifie-siren) auprès de l'INSEE. Nous contrôlons l'existence légale de l'entreprise, son statut d'activité et la validité de ses assurances.",

      "## Erreurs à éviter lors du choix d'un plombier",
  ...
  'tendances-salle-de-bain-2026': {
    ...
    content: [
      ...
      "## Les couleurs : chaleur et sérénité\n\n### Terracotta et tons chauds\n\nLes teintes chaudes comme le terracotta, le caramel et l'ocre doré remplacent les blancs cliniques. Ces couleurs créent une ambiance apaisante et cocooning, rappelant les tons de la terre et de la Méditerranée.\n\n### Le vert sauge et les tons naturels\n\nLes verts doux — sauge, olive, céladon — s'imposent comme la palette complémentaire idéale. Associés à des éléments en bois et en pierre, ils renforcent l'atmosphère naturelle et zen de la salle de bain.\n\n:::tip Conseil pro\nPour une salle de bain intemporelle, adoptez la règle 60-30-10 : 60 % de couleur principale (murs, sol), 30 % de couleur secondaire (meubles, carrelage accent), 10 % de couleur d'accentuation (accessoires, robinetterie).\n:::",
      "## La douche à l'italienne : toujours incontournable\n\n### Un design qui traverse les années\n\nLa douche à l'italienne reste incontournable en 2026. Son design épuré, sans marche ni rebord, offre un maximum d'espace et une esthétique minimaliste. Elle répond également aux [normes d'accessibilité PMR](/blog/accessibilite-pmr-logement-normes), ce qui en fait un choix pérenne.\n\n### Les évolutions 2026\n\n- **La douche ouverte (walk-in)** : sans porte ni paroi, avec un simple receveur extra-plat\n- **La niche encastrée** : pour ranger shampooings et savons sans étagère visible\n- **Le caniveau linéaire** : évacuation discrète intégrée au sol\n- **La pomme de tête XXL** : format 40 x 40 cm pour un effet pluie enveloppant\n\n:::budget\n| Type d'installation | Prix moyen (pose comprise) |\n| Douche à l'italienne standard | 2 500 - 5 000 € |\n| Douche walk-in haut de gamme | 4 000 - 8 000 € |\n| Remplacement baignoire par douche | 3 000 - 7 000 € |\n:::",
      "## Les robinetteries et le design biophilique\n\n### Le noir mat : le classique moderne\n\nLe noir mat s'impose comme la finition tendance pour les robinets, pommeaux de douche et accessoires. Un choix élégant qui contraste avec les tons clairs des murs et du carrelage.\n\n### Le laiton brossé et le doré\n\nLe laiton brossé apporte une touche de chaleur et de sophistication. Moins brillant que le doré traditionnel, il vieillit avec élégance et s'accorde parfaitement avec les matériaux naturels.\n\n### Le design biophilique\n\nLe design biophilique consiste à intégrer des éléments naturels dans l'espace intérieur pour favoriser le bien-être. Dans la salle de bain, cela se traduit par des plantes tropicales adaptées à l'humidité, un éclairage naturel et des matériaux organiques. La grande nouveauté 2026 : les murs végétaux en mousse stabilisée, qui ne nécessitent ni arrosage ni entretien. Comptez 150 à 400 €/m².\n\n:::takeaway\n- Les matériaux naturels (travertin, teck, terrazzo) dominent les tendances 2026\n- Les couleurs chaudes (terracotta, sauge) remplacent le blanc clinique\n- La douche à l'italienne évolue vers le format walk-in ouvert\n- Le noir mat et le laiton brossé sont les finitions robinetterie phares\n- Le design biophilique et les technologies connectées enrichissent l'expérience\n- Un budget de 8 000 à 15 000 € permet une rénovation tendance et complète\n:::",
    ],
  ...
  'devis-travaux-comprendre': {
    ...
    content: [
      ...
      "## Le détail des prestations\n\n### Exigez la précision\n\nChaque ligne du devis doit décrire précisément la prestation : nature des travaux, quantités exactes, matériaux utilisés avec marque et référence, prix unitaire et prix total par ligne.\n\n### Les formulations à refuser\n\nMéfiez-vous des descriptions vagues telles que :\n\n- « Travaux divers » ou « travaux de rénovation »\n- « Fournitures courantes » ou « matériaux standards »\n- « Selon les besoins du chantier »\n\n:::tip Conseil pro\nDemandez systématiquement les références exactes des matériaux proposés. Cela vous permet de vérifier les prix en magasin et d'avoir la certitude de la qualité posée.\n:::",
      "## La TVA applicable\n\n### Les trois taux en vigueur\n\nLe taux de TVA varie selon le type de travaux et l'ancienneté du logement :\n\n- **20 %** : constructions neuves et logements de moins de 2 ans\n- **10 %** : travaux de rénovation dans les logements de plus de 2 ans\n- **5,5 %** : travaux d'amélioration de la performance énergétique\n\n:::info Bon à savoir\nUn même devis peut comporter plusieurs taux de TVA si les travaux sont de nature différente. Vérifiez que l'artisan ventile correctement sa facture. Consultez notre [guide TVA travaux](/blog/tva-reduite-travaux-renovation-guide) pour tous les cas de figure.\n:::",
      "## Les conditions de paiement\n\n### L'échéancier type\n\nLe devis doit préciser clairement l'échéancier de paiement :\n\n1. **Acompte à la signature** : 20 à 30 % du montant total\n2. **Versement intermédiaire** : 30 à 40 % en cours de travaux\n3. **Solde à la réception** : 30 à 50 %, après vérification des travaux\n\n### La retenue de garantie de 5 %\n\nPour les marchés importants, la loi du 16 juillet 1971 autorise le maître d'ouvrage à retenir 5 % du montant total jusqu'à la [levée des réserves](/blog/reception-travaux-proces-verbal-reserves).\n\n:::warning Attention\nNe versez jamais plus de 30 % d'acompte à la signature. Un artisan qui exige 50 % ou plus d'avance présente un risque financier majeur. Refusez systématiquement les demandes de paiement en espèces au-delà de 1 000 €.\n:::",
      "## Les pièges courants et la négociation\n\n### Les pièges à déjouer\n\n- **Le devis trop vague** : un total global sans décomposition empêche toute vérification\n- **Le devis « compétitif » incomplet** : un prix bas cache souvent des prestations manquantes\n- **Les travaux supplémentaires non encadrés** : exigez un accord écrit pour tout ajout\n- **L'absence de date de fin** : sans délai, aucun levier en cas de retard\n\n### Leviers de négociation\n\n- **Le prix des fournitures** : proposez de les acheter vous-même\n- **Le regroupement de travaux** : un chantier global est plus rentable\n- **Le calendrier** : un artisan avec un creux peut consentir 5 à 10 % de remise\n\nPour aller plus loin, consultez notre guide [Devis travaux : comment comparer et choisir](/blog/devis-travaux-comment-comparer-choisir).\n\n:::takeaway\n- Vérifiez les mentions obligatoires avant de signer tout devis\n- Exigez un détail ligne par ligne avec références des matériaux\n- Contrôlez le taux de TVA applicable à chaque poste\n- Ne versez jamais plus de 30 % d'acompte\n:::",
    ],
  ...
  'electricite-normes-securite': {
    ...
    content: [
      ...
      "## Le diagnostic électrique obligatoire\n\n### Quand est-il obligatoire ?\n\nLe diagnostic électrique est obligatoire :\n\n- Pour la **vente** d'un logement dont l'installation a plus de 15 ans (validité : 3 ans)\n- Pour la **location** d'un logement dont l'installation a plus de 15 ans (validité : 6 ans)\n\n### Que vérifie-t-il ?\n\nLe diagnostiqueur certifié contrôle 87 points selon la norme XP C 16-600, répartis en 6 grands domaines :\n\n1. L'appareil général de commande et de protection\n2. La protection différentielle à l'origine de l'installation\n3. La prise de terre et les liaisons équipotentielles\n4. Les dispositifs de protection contre les surintensités\n5. L'absence de matériel vétuste ou inadapté\n6. Les conditions de sécurité dans les salles d'eau\n\n:::warning Attention\nUn diagnostic révélant des anomalies graves n'oblige pas légalement le vendeur à effectuer les travaux. Cependant, il engage sa responsabilité en cas d'accident. Négociez le coût de la mise aux normes lors de l'achat.\n:::",
      "## Les signes d'une installation vétuste\n\n### Les signaux d'alerte à ne pas ignorer\n\nPlusieurs symptômes indiquent qu'une mise aux normes est nécessaire :\n\n- Disjoncteurs qui sautent fréquemment\n- Prises qui chauffent ou noircissent\n- Éclairage qui vacille ou grésille\n- Odeur de brûlé près d'un interrupteur\n- Prises sans terre (ancien modèle à deux broches)\n- Fils électriques apparents ou gainés tissu\n- Tableau électrique avec fusibles à broches\n\n:::warning Attention\nSi vous constatez l'un de ces signes, faites intervenir un [électricien qualifié](/services/electricien) dans les plus brefs délais. Une installation défaillante peut provoquer un incendie ou une électrocution à tout moment.\n:::",
      "## Le coût d'une mise aux normes\n\n### Les tarifs en 2026\n\nLe prix d'une mise aux normes électrique varie considérablement selon l'étendue des travaux et la superficie du logement :\n\n:::budget\n| Intervention | Prix moyen |\n| Remplacement du tableau électrique | 800 - 2 000 € |\n| Mise aux normes complète (appartement 60 m²) | 5 000 - 8 000 € |\n| Mise aux normes complète (maison 100 m²) | 8 000 - 15 000 € |\n| Ajout d'un circuit dédié | 150 - 300 € |\n| Installation disjoncteur différentiel 30 mA | 200 - 400 € |\n| Remplacement des prises (par unité) | 60 - 120 € |\n:::\n\nPour des tarifs détaillés, consultez notre guide des [prix d'un électricien en 2026](/blog/prix-electricien-2026-tarifs-travaux).\n\n:::tip Conseil pro\nDemandez plusieurs devis et vérifiez que l'électricien est certifié Qualifelec. À la fin des travaux, exigez une attestation de conformité Consuel (obligatoire pour les installations neuves ou entièrement rénovées).\n:::\n\n:::takeaway\n- La norme NF C 15-100 est la référence pour toutes les installations électriques\n- Le diagnostic est obligatoire pour la vente ou la location de logements de plus de 15 ans\n- Disjoncteurs qui sautent, prises qui chauffent : ces signes exigent une intervention urgente\n- Comptez 50 à 100 €/m² pour une mise aux normes complète\n- Faites appel à un électricien certifié Qualifelec pour garantir la conformité\n- Les travaux de mise aux normes bénéficient de la TVA réduite à 10 %\n:::",
    ],
  ...
  'chauffage-solution-economique': {
    ...
    content: [
      ...
      "## Le poêle à granulés : le confort au meilleur prix\n\n### Un combustible économique\n\nLe granulé de bois (ou pellet) est le combustible le moins cher du marché, avec un coût d'environ 6 à 8 centimes par kWh en 2026. Un poêle à granulés peut chauffer une maison de 100 m² pour environ 500 à 800 euros par an.\n\n### Les atouts du poêle à granulés\n\n- **Coût d'installation** : 2 500 à 6 000 € (pose et conduit compris)\n- **Coût annuel de fonctionnement** : 500 à 800 € pour 100 m²\n- **Rendement** : 85 à 95 %\n- **Autonomie** : 12 à 72 heures selon la capacité du réservoir\n- **Éligible aux aides** : MaPrimeRénov', CEE, TVA 5,5 %\n\n:::info Bon à savoir\nLe poêle à granulés est idéal en chauffage principal pour les maisons bien isolées (moins de 100 m²) ou en chauffage d'appoint pour les maisons plus grandes. Pour une maison de plus de 120 m², envisagez une chaudière à granulés avec distribution par radiateurs.\n:::",
      "## La chaudière gaz à condensation : le remplacement malin\n\n### Toujours pertinente en rénovation\n\nPlus performante qu'une chaudière classique, la chaudière à condensation récupère la chaleur des fumées pour préchauffer l'eau de retour. Elle offre un rendement supérieur à 100 % (sur PCI) et s'installe facilement en remplacement d'une ancienne chaudière.\n\n- **Coût d'installation** : 3 000 à 7 000 €\n- **Coût annuel de fonctionnement** : 1 000 à 1 500 € pour 100 m²\n- **Durée de vie** : 15 à 25 ans\n\n:::warning Attention\nDepuis la [RE2020](/blog/reglementation-thermique-re2020-impact), l'installation de chaudières gaz est interdite dans les logements neufs. En rénovation, la chaudière gaz à condensation reste autorisée mais les aides MaPrimeRénov' pour ce type d'équipement ont été supprimées depuis 2024. La chaudière gaz est amenée à disparaître progressivement.\n:::",
      "## Les aides au changement de chauffage\n\n### Un financement généreux\n\nLe remplacement d'un ancien système de chauffage est éligible à de nombreuses aides qui peuvent couvrir jusqu'à 50 % du coût des travaux :\n\n- **MaPrimeRénov'** : 3 000 à 11 000 € selon l'équipement et les revenus\n- **CEE** : 2 500 à 5 000 € selon l'équipement\n- **TVA réduite** : 5,5 % au lieu de 20 %\n- **Éco-PTZ** : jusqu'à 15 000 € sans intérêts\n\n:::budget\n| Solution | Installation | Fonctionnement/an | Aides possibles |\n| PAC air-eau | 8 000 - 16 000 € | 500 - 900 € | 5 000 - 11 000 € |\n| Poêle à granulés | 2 500 - 6 000 € | 500 - 800 € | 1 500 - 3 000 € |\n| Chaudière gaz condensation | 3 000 - 7 000 € | 1 000 - 1 500 € | CEE uniquement |\n| Chaudière biomasse | 10 000 - 20 000 € | 400 - 700 € | CEE / parcours d'ampleur |\n:::\n\nDepuis le 1er janvier 2026, la chaudière biomasse n'est plus financée par MaPrimeRénov' par geste : elle relève des CEE (Coup de pouce), de la TVA à 5,5 % et de l'éco-PTZ, ou de MaPrimeRénov' en parcours d'ampleur (les poêles à granulés et à bûches restent éligibles par geste).\n\nConsultez notre guide complet des [aides à la rénovation énergétique](/blog/renovation-energetique-aides-2026) pour optimiser votre financement.\n\n:::takeaway\n- La pompe à chaleur air-eau offre le meilleur rapport performance/économies\n- Le poêle à granulés est la solution la plus abordable à l'installation\n- La chaudière gaz reste pertinente en remplacement mais les aides diminuent\n- Isolez d'abord, chauffez ensuite : une bonne isolation réduit le dimensionnement\n- Les aides cumulées peuvent couvrir 50 % ou plus du coût d'installation\n- Faites toujours réaliser une étude thermique avant de choisir\n:::",
    ],
  ...
  'combien-coute-un-plombier-tarifs-devis': {
    ...
    content: [
      ...
      "## Les interventions courantes et leurs prix\n\n### Dépannages\n\n:::budget\n| Intervention | Prix moyen (main-d'œuvre + fournitures) |\n| Débouchage canalisation simple | 80 - 200 € |\n| Débouchage avec furet ou haute pression | 150 - 400 € |\n| Remplacement d'un robinet | 80 - 150 € |\n| Remplacement mitigeur | 100 - 250 € |\n| Réparation de fuite apparente | 100 - 300 € |\n| Réparation de fuite encastrée | 200 - 600 € |\n| Remplacement chasse d'eau | 100 - 200 € |\n| Remplacement joint de robinet | 50 - 100 € |\n:::\n\n### Installations\n\n| Installation | Prix moyen (fournitures comprises) |\n| --- | --- |\n| Chauffe-eau électrique (pose) | 300 - 800 € |\n| Chauffe-eau thermodynamique (pose) | 800 - 1 500 € |\n| Cumulus (remplacement complet) | 600 - 1 500 € |\n| WC complet | 300 - 600 € |\n| Lave-vaisselle (raccordement) | 80 - 150 € |",
      "## Le devis gratuit et les frais de déplacement\n\n### Le devis planifié\n\nLa plupart des plombiers proposent un devis gratuit pour les travaux planifiés. Le professionnel se déplace, évalue la situation et vous remet un devis détaillé sous 24 à 72 heures.\n\n### Le déplacement en urgence\n\nEn revanche, un déplacement en urgence peut être facturé 30 à 80 euros même si les travaux ne sont pas réalisés. Ce forfait couvre le temps de trajet et le diagnostic sur place.\n\n:::info Bon à savoir\nLe plombier doit vous informer du coût du déplacement avant de se déplacer. S'il constate sur place que l'intervention dépasse 150 €, il doit vous remettre un devis écrit avant d'intervenir (article L.111-3 du Code de la consommation).\n:::",
      "## Comment économiser sur la plomberie\n\n### Nos conseils pratiques\n\n1. **Privilégiez les interventions en semaine** et aux heures ouvrables (8h-18h) pour éviter les majorations\n2. **Regroupez les petits travaux** pour réduire les frais de déplacement : faites une liste de toutes les réparations nécessaires\n3. **Entretenez régulièrement** : un détartrage annuel du chauffe-eau et un nettoyage des canalisations évitent les pannes coûteuses\n4. **Apprenez les gestes simples** : changer un joint de robinet ou déboucher un siphon ne nécessite pas de plombier\n\n:::tip Conseil pro\nSur ServicesArtisans, vous pouvez [vérifier les artisans](/blog/comment-verifier-artisan-avant-engager) et obtenir plusieurs devis gratuits en quelques clics. Comparer les offres est le meilleur moyen de maîtriser votre budget plomberie.\n:::\n\n:::takeaway\n- Le tarif horaire moyen est de 40-70 € HT en province, 60-90 € HT en Île-de-France\n- Les majorations nuit/week-end peuvent doubler le tarif de base\n- Débouchage simple : 80-200 €, réparation de fuite : 100-300 €\n- Un déplacement d'urgence coûte 30-80 € même sans intervention\n- Regroupez les travaux pour économiser sur les frais de déplacement\n- Privilégiez les interventions en semaine aux heures ouvrables\n:::",
    ],
  ...
  'trouver-artisan-verifie-siren': {
    ...
    content: [
      ...
      "## Comment vérifier un artisan ?\n\n### Sur ServicesArtisans\n\nSur notre plateforme, chaque artisan est vérifié automatiquement via l'API SIREN de l'INSEE. Nous contrôlons :\n\n1. L'existence et l'activité de l'entreprise\n2. La cohérence du code APE avec le métier déclaré\n3. La validité des assurances professionnelles\n4. Les éventuelles procédures collectives\n\n### Par vous-même\n\nVous pouvez aussi vérifier vous-même sur :\n\n- **sirene.fr** (base officielle INSEE) : recherche gratuite par numéro ou nom\n- **Infogreffe.fr** : informations financières et légales\n- **societe.com** : synthèse des informations publiques\n- **Annuaire des entreprises** (entreprise.data.gouv.fr) : base de données officielle\n\n:::tip Conseil pro\nRecherchez le SIRET plutôt que le SIREN : le SIRET identifie l'établissement exact, ce qui vous permet de vérifier que l'adresse correspond bien à celle de l'artisan qui vous a contacté.\n:::",
      "## Les autres vérifications essentielles\n\n### Au-delà du SIREN\n\nLe SIREN confirme l'existence de l'entreprise, mais ne garantit pas la qualité du travail. Vérifiez également :\n\n- **L'assurance RC professionnelle** : demandez l'attestation en cours de validité\n- **La garantie décennale** : obligatoire pour les travaux de gros œuvre. Voir notre guide sur la [garantie décennale](/blog/garantie-decennale-tout-savoir)\n- **Les qualifications professionnelles** : RGE pour les travaux énergétiques, Qualibat, Qualifelec. Consultez notre article sur les [certifications du bâtiment](/blog/qualibat-qualifelec-certifications-batiment)\n- **L'inscription au Registre des Métiers** : obligatoire pour les artisans\n\n:::info Bon à savoir\nDepuis 2023, l'inscription au Registre National des Entreprises (RNE) a remplacé le Répertoire des Métiers et le Registre du Commerce. Vérifiez l'inscription de l'artisan sur formalites.entreprises.gouv.fr.\n:::",
      "## Que faire en cas de problème ?\n\n### Si vous avez fait appel à un artisan non déclaré\n\nVos recours sont extrêmement limités. Sans contrat légal, sans facture officielle, sans assurance, vous ne pouvez pas :\n\n- Faire jouer la garantie décennale\n- Saisir le tribunal pour obtenir réparation\n- Bénéficier de la médiation de la consommation\n\n### Les bons réflexes\n\nPrivilégiez toujours des professionnels vérifiés pour bénéficier des garanties légales :\n\n1. Vérifiez le SIRET avant tout engagement\n2. Demandez les attestations d'assurance\n3. Exigez un devis écrit et détaillé\n4. Conservez tous les documents (devis, factures, échanges)\n5. Formalisez la [réception des travaux](/blog/reception-travaux-proces-verbal-reserves) par un PV écrit\n\n:::takeaway\n- Le SIREN/SIRET est la carte d'identité de l'entreprise : vérifiez-le systématiquement\n- Un artisan sans SIREN = pas d'assurance, pas de garantie, pas de recours\n- Vérifiez sur sirene.fr, Infogreffe ou ServicesArtisans\n- Au-delà du SIREN, contrôlez les assurances et les qualifications\n- Faire appel au travail dissimulé vous expose à des sanctions pénales\n- Conservez tous les documents pour protéger vos droits\n:::",
    ],
  ...
  'artisan-pas-cher-attention-arnaques': {
    ...
    content: [
      ...
      "## Comment se protéger efficacement\n\n### La méthode en 4 étapes\n\n1. **Vérifiez systématiquement le SIRET** sur ServicesArtisans ou sur societe.com avant tout engagement\n2. **Demandez des références** de chantiers similaires et contactez les anciens clients\n3. **Ne payez jamais plus de 30 % d'acompte** à la signature du devis\n4. **Refusez tout paiement en espèces** : exigez un virement ou un chèque avec facture officielle\n\n### Les vérifications complémentaires\n\n- Recherchez l'artisan sur les réseaux sociaux et les avis en ligne\n- Vérifiez les assurances ([RC Pro et garantie décennale](/blog/garantie-decennale-tout-savoir))\n- Consultez le Registre des Métiers pour confirmer l'inscription\n- Appelez l'assureur mentionné sur l'attestation pour vérifier sa validité\n\n:::tip Conseil pro\nAvant de signer un devis important, faites une recherche rapide sur le nom de l'entreprise suivi de « arnaque » ou « avis négatif » sur un moteur de recherche. Cela peut révéler des témoignages d'autres victimes.\n:::",
      "## En cas d'arnaque : les recours\n\n### Les démarches immédiates\n\n1. **Portez plainte** auprès de la police ou de la gendarmerie\n2. **Signalez l'artisan à la DGCCRF** via signal.conso.gouv.fr\n3. **Contactez votre assurance habitation** : certaines garanties couvrent les malfaçons\n4. **Consultez une association de consommateurs** (UFC-Que Choisir, CLCV) pour obtenir un accompagnement juridique\n\n### La médiation et la justice\n\nPour les litiges inférieurs à 5 000 €, la médiation est obligatoire avant toute action en justice. Au-delà, vous pouvez saisir directement le tribunal judiciaire. Consultez notre guide sur les [recours en cas de litige avec un artisan](/blog/litige-artisan-recours-mediation-justice).\n\n:::takeaway\n- Un devis 30 % en dessous du marché est un signal d'arnaque\n- Vérifiez toujours le SIRET, les assurances et les références\n- Le démarchage téléphonique pour la rénovation énergétique est interdit\n- Ne payez jamais plus de 30 % d'acompte et refusez les espèces\n- En cas de démarchage à domicile, vous avez 14 jours pour vous rétracter\n- Portez plainte et signalez à la DGCCRF en cas d'arnaque avérée\n:::",
    ],
  ...
  'prix-plombier-2026-tarifs-horaires': {
    ...
    content: [
      ...
      "## En bref — prix d'un plombier en 2026\n\n:::budget\n| Prestation | Prix moyen TTC 2026 |\n| Tarif horaire | 45 - 95 € HT/h |\n| Dépannage simple (fuite, débouchage) | 90 - 280 € |\n| Remplacement chauffe-eau (cumulus) | 800 - 2 200 € |\n| Salle de bain complète (pose) | 3 000 - 8 000 € |\n:::",
  ...
  'prix-electricien-2026-tarifs-travaux': {
    ...
    content: [
      ...
      "## En bref — prix d'un électricien en 2026\n\n:::budget\n| Prestation | Prix moyen TTC 2026 |\n| Tarif horaire | 40 - 85 € HT/h |\n| Dépannage simple | 90 - 200 € |\n| Remplacement tableau électrique | 800 - 2 000 € |\n| Mise aux normes complète (60 m²) | 5 600 - 10 500 € |\n:::",
  ...
  'prix-peintre-batiment-2026-guide-complet': {
    ...
    content: [
      ...
      "## En bref — prix d'un peintre en 2026\n\n:::budget\n| Prestation | Prix moyen TTC 2026 |\n| Peinture murs (par un pro) | 20 - 45 €/m² |\n| Peinture plafond | 25 - 50 €/m² |\n| Chambre complète (12 m²) | 400 - 800 € |\n| Salon complet (25 m²) | 700 - 1 500 € |\n:::",
  ...
  'garantie-decennale-tout-savoir': {
    ...
    content: [
      ...
      "## Quels travaux sont couverts ?\n\n### Les travaux de gros œuvre\n\n- Fondations, dalles, murs porteurs\n- Toiture et charpente\n- Escaliers structurels\n- Canalisations encastrées\n\n### Les éléments d'équipement indissociables\n\n- Chauffage central (canalisations, radiateurs encastrés)\n- Installation électrique encastrée\n- Carrelage scellé (par opposition au carrelage collé)\n- Plomberie encastrée\n\n### Les vices rendant le logement inhabitable\n\n- Infiltrations rendant des pièces inutilisables\n- Défauts d'isolation thermique ou phonique graves\n- Fissures structurelles évolutives\n\n:::warning Attention\nLa garantie décennale ne couvre pas les défauts esthétiques mineurs (micro-fissures non évolutives, léger défaut de teinte du carrelage) ni les équipements dissociables (robinetterie, volets, portes intérieures), qui relèvent de la garantie biennale.\n:::",
      "## Comment vérifier et activer la garantie\n\n### Avant les travaux\n\nDemandez à l'artisan son attestation de garantie décennale avant le début des travaux. L'attestation doit :\n\n- Être en cours de validité\n- Mentionner les activités couvertes (vérifiez que vos travaux y figurent)\n- Indiquer le nom de l'assureur et le numéro de police\n- Préciser la zone géographique de couverture\n\n### En cas de malfaçon\n\n1. **Envoyez une lettre recommandée avec AR** à l'artisan décrivant précisément les désordres constatés\n2. **Joignez des photos datées** et le procès-verbal de réception\n3. **Fixez un délai** de 30 jours pour la réparation\n4. Si l'artisan ne réagit pas, **contactez son assureur** directement (coordonnées sur l'attestation)\n5. En dernier recours, **saisissez le tribunal judiciaire** avec l'aide d'un expert\n\n### Le rôle de l'assurance dommages-ouvrage\n\nSi vous avez souscrit une [assurance dommages-ouvrage](/blog/assurance-dommages-ouvrage-guide-complet), elle vous indemnise rapidement (sous 90 jours) sans attendre la désignation du responsable. L'assureur DO se retourne ensuite contre l'artisan fautif.\n\n:::tip Conseil pro\nConservez précieusement l'attestation de garantie décennale de chaque artisan pendant 10 ans après la réception. En cas de revente dans ce délai, vous devrez la transmettre à l'acquéreur.\n:::\n\n:::takeaway\n- La garantie décennale couvre les malfaçons graves pendant 10 ans après réception\n- Elle repose sur une présomption de responsabilité favorable au propriétaire\n- Exigez l'attestation d'assurance AVANT le début des travaux\n- En cas de sinistre : LRAR à l'artisan, puis contact de l'assureur\n- L'assurance dommages-ouvrage accélère considérablement l'indemnisation\n- Conservez tous les documents pendant 10 ans minimum\n:::",
    ],
  ...
  'comment-choisir-cuisine-equipee-guide': {
    ...
    content: [
      ...
      "## Choisir les matériaux\n\n### Plan de travail\n\n| Matériau | Prix au mètre linéaire | Avantages | Inconvénients |\n| --- | --- | --- | --- |\n| Stratifié | 40 - 150 € | Économique, large choix | Sensible à la chaleur et aux coupures |\n| Quartz | 200 - 500 € | Très résistant, sans entretien | Prix élevé |\n| Granit | 250 - 600 € | Naturel, résistant | Poreux (à imperméabiliser), lourd |\n| Bois massif | 150 - 400 € | Chaleureux, réparable | Entretien régulier |\n| Inox | 200 - 500 € | Professionnel, hygiénique | Rayures visibles |\n\n### Façades de meubles\n\nMélaminé (économique), laqué (moderne, facile d'entretien), bois massif (chaleureux, haut de gamme), stratifié haute pression (résistant).\n\n:::info Bon à savoir\nLe quartz composite (Silestone, Caesarstone) est le matériau qui offre le meilleur rapport résistance/entretien pour un plan de travail. Contrairement au granit, il ne nécessite aucun traitement et résiste aux taches.\n:::",
      "## Le budget à prévoir\n\n### Les gammes de prix\n\n:::budget\n| Gamme | Prix (hors pose) | Caractéristiques |\n| Entrée de gamme | 3 000 - 5 000 € | Mélaminé, stratifié, quincaillerie basique |\n| Milieu de gamme | 5 000 - 12 000 € | Laqué/bois, quartz, quincaillerie qualité |\n| Haut de gamme | 12 000 - 25 000 €+ | Matériaux nobles, sur mesure, électroménager premium |\n:::\n\nAjoutez 2 000 à 5 000 € pour la pose par un cuisiniste professionnel, incluant les raccordements [plomberie](/services/plombier) et électricité.\n\n## Les erreurs à éviter\n\n### Les pièges classiques\n\n- **Sous-estimer le rangement** : prévoyez 30 % de rangements de plus que ce que vous pensez nécessaire\n- **Oublier l'éclairage** : un éclairage LED sous les meubles hauts est indispensable pour le plan de travail\n- **Négliger la ventilation** : une hotte performante (débit minimum 400 m³/h) est essentielle\n- **Choisir des matériaux inadaptés** : la cuisine subit chaleur, humidité et projections quotidiennes\n- **Mal positionner les prises** : prévoyez au moins 6 prises au-dessus du plan de travail (norme NF C 15-100)\n\n:::warning Attention\nLes cuisines en kit des grandes surfaces nécessitent souvent des adaptations coûteuses (coupe sur mesure, fileurs, joues). Le prix final peut dépasser celui d'une cuisine sur mesure posée par un cuisiniste. Comparez les devis complets.\n:::\n\nPour l'aspect tendances et design, consultez nos articles sur les [tendances salle de bain 2026](/blog/tendances-salle-de-bain-2026).\n\n:::takeaway\n- Respectez le triangle d'activité pour une cuisine fonctionnelle\n- Le quartz est le meilleur compromis pour le plan de travail\n- Budget : 3 000-5 000 € (entrée de gamme) à 12 000-25 000 € (haut de gamme)\n- Ajoutez 2 000-5 000 € pour la pose professionnelle\n- Prévoyez 30 % de rangements supplémentaires\n- Ne négligez pas l'éclairage du plan de travail et la ventilation\n:::",
    ],
  ...
  'renovation-salle-de-bain-budget-etapes': {
    ...
    content: [
      ...
      "## L'ordre des travaux\n\n### Le planning optimal\n\nRespecter l'ordre des travaux est essentiel pour éviter les reprises :\n\n1. **Démolition** de l'existant (carrelage, sanitaires, cloisons)\n2. **Plomberie** : modification des alimentations et évacuations\n3. **Électricité** : mise aux normes selon les volumes de sécurité [NF C 15-100](/blog/electricite-normes-securite)\n4. **Étanchéité** : pose du système d'étanchéité sous carrelage (SPEC)\n5. **Carrelage** : murs d'abord, puis sol\n6. **Installation des sanitaires** : douche/baignoire, vasque, WC\n7. **Peinture et finitions** : plafond, parties non carrelées, joints silicone\n\n:::warning Attention\nNe négligez jamais l'étanchéité sous carrelage, surtout pour une douche à l'italienne. Un défaut d'étanchéité est la première cause de dégâts des eaux en salle de bain, avec un coût de réparation pouvant atteindre 5 000 à 15 000 € (reprise du carrelage, traitement de l'humidité, réparation chez le voisin du dessous).\n:::",
      "## Les choix de matériaux et erreurs à éviter\n\n### Carrelage et revêtements\n\n- **Grès cérame** : le plus durable, large choix de formats et de finitions (30-80 €/m²)\n- **Faïence** : pour les murs, légère et facile à poser (15-50 €/m²)\n- **Mosaïque** : pour les touches décoratives et les receveurs de douche (40-120 €/m²)\n- **Béton ciré** : tendance mais nécessite un applicateur qualifié (80-150 €/m²)\n\n### Les erreurs classiques\n\n- **Négliger l'étanchéité** : source de dégâts des eaux coûteux\n- **Sous-dimensionner la ventilation** : une VMC insuffisante provoque moisissures et dégradations\n- **Oublier les rangements** : prévoyez des niches encastrées, un meuble vasque avec rangements\n- **Choisir des matériaux non adaptés** : le bois non traité et certains métaux ne supportent pas l'humidité constante\n\nPour une rénovation accessible, consultez notre guide sur les [normes PMR en salle de bain](/blog/accessibilite-pmr-logement-normes).\n\n:::tip Conseil pro\nPrévoyez un siphon de sol (obligatoire en copropriété pour les douches à l'italienne) et une pente de 1-2 % vers l'évacuation. Faites appel à un étancheur certifié pour la pose du SPEC (Système de Protection à l'Eau sous Carrelage).\n:::\n\n:::takeaway\n- Budget : 1 500-3 000 € (légère), 5 000-10 000 € (standard), 8 000-20 000 € (complète)\n- Respectez l'ordre : démolition → plomberie → électricité → étanchéité → carrelage → sanitaires\n- L'étanchéité sous carrelage est non négociable, surtout pour les douches à l'italienne\n- Le grès cérame offre le meilleur rapport durabilité/prix pour le sol\n- Conserver les emplacements existants réduit considérablement le budget plomberie\n:::",
    ],
