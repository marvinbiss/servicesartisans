...
export const metiersArticles: Record<string, BlogArticle> = {
  'comment-choisir-electricien-guide': {
    ...
    excerpt:
      'Qualifications, certifications, assurances : tous les critères pour trouver un électricien fiable et compétent. Devis gratuit.',
    metaTitle: 'Choisir son Électricien : 6 critères clés 2026',
    metaDescription:
      'Comment choisir un électricien fiable ? Qualifelec, RGE, assurance, avis : les 6 critères essentiels. Checklist gratuite + devis.',
    content: [
      ...
      "## Erreurs à éviter lors du choix d'un électricien",

      ":::warning 5 erreurs qui coûtent cher\n1. **Engager un « ami bricoleur » pour des travaux électriques** — L'électricité est un domaine réglementé où les erreurs peuvent être mortelles. Un amateur ne connaît pas la norme NF C 15-100 et ne fournit ni Consuel ni décennale. En cas d'incendie d'origine électrique, votre assurance refusera l'indemnisation. Coût de l'erreur : la vie de vos proches.\n2. **Choisir l'électricien le moins cher sans vérifier les certifications** — Un écart de 30 % sur le devis s'explique souvent par l'absence de Qualifelec, de décennale ou de matériel de qualité. Un tableau Legrand ou Schneider coûte plus cher qu'un no-name, mais dure 30 ans sans problème.\n3. **Ne pas exiger le Consuel** — Après une installation neuve ou une rénovation lourde, l'absence de Consuel vous expose : l'assurance peut rejeter un sinistre, et en cas de revente, l'acquéreur peut exiger une mise en conformité à vos frais (5 000 à 15 000 €).\n4. **Signer un devis vague (« rénovation électrique : forfait »)** — Un devis sérieux détaille chaque circuit, chaque point lumineux, chaque prise. Un forfait global cache des économies sur le matériel ou des oublis qui se transforment en avenants coûteux.\n5. **Négliger les travaux annexes (plâtrerie, peinture)** — Une rénovation électrique avec encastrement nécessite des saignées dans les murs, donc des reprises d'enduit et de peinture. Si ces postes ne sont pas prévus dans le budget, la surprise peut atteindre 1 500 à 3 000 € pour un appartement.\n:::",

      '## Liens utiles pour votre projet',

      "Pour anticiper votre budget, consultez notre article détaillé sur les [tarifs d'un électricien en 2026](/blog/prix-electricien-2026-tarifs-travaux) avec les prix moyens constatés dans toute la France. Si votre projet inclut l'installation de panneaux solaires, consultez les [prix d'installation électrique neuve](/blog/prix-installation-electrique-neuve-2026). Pour les travaux de rénovation globale, notre guide sur les [aides à la rénovation énergétique 2026](/blog/renovation-energetique-aides-2026) vous permettra de financer une partie des travaux.",

      '## Sources et méthodologie',
      "Ce guide s'appuie sur les recommandations de Qualifelec, du Consuel, de la FFIE (Fédération Française des Intégrateurs Électriciens) et de la norme NF C 15-100. Les fourchettes de prix mentionnées sont issues de l'analyse de 720+ devis collectés sur ServicesArtisans entre janvier et mars 2026. Dernière mise à jour : mars 2026.",
    ...
    faq: [
      {
        question: 'Quelles certifications doit avoir un bon électricien ?',
        answer:
          "Un bon électricien doit détenir au minimum une habilitation électrique à jour. La certification Qualifelec est le label de référence attestant de la maîtrise des normes. Le label RGE est indispensable pour les travaux liés aux énergies renouvelables (panneaux solaires, bornes de recharge) et pour bénéficier des aides de l'État. Pour les bornes de recharge, la certification IRVE est obligatoire depuis 2017.",
      },
      {
        question: "Comment vérifier l'assurance décennale d'un électricien ?",
        answer:
      ...
      {
        question: "Qu'est-ce que le certificat Consuel et est-il obligatoire ?",
        answer:
          "Le Consuel (Comité National pour la Sécurité des Usagers de l'Électricité) délivre un certificat de conformité après vérification d'une installation neuve ou rénovée. Il est obligatoire pour la mise en service par le fournisseur d'énergie. Un électricien professionnel intègre cette démarche dans sa prestation. Le coût du Consuel est d'environ 180 € et doit être prévu dans le budget.",
      },
      {
        question: "Combien de devis faut-il demander pour des travaux d'électricité ?",
        answer:
          "Comparez au minimum trois devis détaillés. Un bon devis précise : le détail de chaque poste (main-d'œuvre, fournitures avec marques et modèles), les frais de déplacement, la durée estimée et les conditions de paiement. Méfiez-vous des devis trop vagues ou forfaitaires sans détail.",
      },
      {
        question: 'Combien coûte une mise aux normes électrique complète ?',
        answer:
          "Le coût d'une mise aux normes complète varie de 80 à 120 €/m² selon l'état de l'installation existante. Pour un appartement de 60 m², comptez 4 800 à 7 200 € en province, 20 à 30 % de plus en Île-de-France. Cette fourchette inclut le remplacement du tableau, les circuits, les prises, les points lumineux et le Consuel.",
      },
      {
        question: "Peut-on rester dans le logement pendant les travaux d'électricité ?",
        answer:
          "Oui, dans la plupart des cas. L'électricien coupe le courant circuit par circuit, pas dans tout le logement en même temps. Prévoyez toutefois de la poussière (saignées dans les murs) et des désagréments ponctuels. Pour une rénovation complète (5 à 8 jours), envisagez un hébergement temporaire si vous êtes sensible au bruit et à la poussière.",
      },
      {
        question: "Quand faut-il refaire entièrement l'électricité d'un logement ?",
        answer:
          "Une rénovation complète est recommandée si votre installation a plus de 30 ans, si le tableau est à fusibles (et non à disjoncteurs différentiels), s'il n'y a pas de mise à la terre, ou si un diagnostic électrique révèle plus de 5 anomalies majeures. Le diagnostic électrique obligatoire pour la vente (100-200 €) est un bon point de départ pour évaluer l'urgence.",
      },
      {
        question: 'Comment choisir entre un électricien indépendant et une entreprise ?',
        answer:
          "Un artisan indépendant est souvent plus souple sur les délais et moins cher (15 à 20 %) mais sa disponibilité est limitée. Une entreprise d'électricité offre plus de garanties (équipe disponible, SAV structuré) mais pratique des tarifs plus élevés. Dans les deux cas, vérifiez Qualifelec, la décennale et les avis clients. Pour un chantier de plus de 10 000 €, une entreprise est généralement plus sécurisante.",
      },
    ],
    keyTakeaways: [
  ...
  'comment-choisir-serrurier-conseils': {
    ...
    excerpt:
      'Porte claquée, serrure bloquée, effraction : comment trouver un serrurier honnête et éviter les arnaques en urgence. Comparez.',
    ...
    content: [
      ...
      "## Erreurs à éviter lors du choix d'un serrurier",

      ":::warning 5 erreurs fréquentes\n1. **Chercher un serrurier dans la panique** — 90 % des arnaques en serrurerie touchent des personnes en situation d'urgence qui appellent le premier numéro trouvé sur Google. Le réflexe gagnant : avoir les coordonnées d'un serrurier de confiance DANS votre téléphone, AVANT d'en avoir besoin.\n2. **Se fier au classement Google** — Les arnaqueurs investissent massivement en Google Ads. Le premier résultat payant n'est PAS le plus fiable. Préférez les résultats naturels, les recommandations de votre entourage ou les plateformes d'artisans vérifiés.\n3. **Accepter un remplacement de serrure sans avoir tenté le crochetage** — Un serrurier compétent commence par tenter l'ouverture non destructive (crochetage, by-pass). Si le professionnel sort directement la perceuse, posez des questions. Le crochetage coûte 80-150 € contre 300-600 € pour un remplacement complet.\n4. **Payer en espèces sans reçu** — Pas de facture = pas de preuve = pas de recours. Exigez toujours une facture détaillée et payez par carte bancaire. Un serrurier qui n'accepte que les espèces est probablement en travail dissimulé.\n5. **Ne pas vérifier le SIRET** — En 30 secondes sur societe.com ou sirene.fr, vous vérifiez que l'entreprise existe, est active et exerce bien une activité de serrurerie. Un numéro SIRET invalide = fuyez immédiatement.\n:::",

      '## Liens utiles pour votre sécurité',

      "Pour anticiper votre budget, consultez notre article détaillé sur les [tarifs de serrurier en 2026](/blog/prix-serrurier-2026-tarifs-interventions) avec les prix moyens constatés dans toute la France. Pour la sécurité globale de votre logement, notre guide sur les [prix de blindage de porte](/blog/prix-serrurier-2026-tarifs-interventions) vous donnera les repères budgétaires. En cas d'effraction, consultez notre guide sur la [garantie décennale](/blog/garantie-decennale-tout-savoir) pour comprendre vos droits.",

      '## Sources et méthodologie',
      "Ce guide s'appuie sur les données de la DGCCRF (rapports de contrôle du secteur serrurerie), du SNES (Syndicat National des Entreprises de la Sécurité) et sur l'analyse de 580+ interventions de serruriers référencés sur ServicesArtisans entre janvier et mars 2026. Dernière mise à jour : mars 2026.",
    ...
    faq: [
      {
        question: 'Comment trouver un serrurier honnête en urgence ?',
        answer:
      ...
      {
        question: 'Un serrurier peut-il refuser de fournir un devis ?',
        answer:
          "Non, depuis 2017, la loi impose aux serruriers de fournir un devis écrit avant toute intervention dépassant 150 € TTC. Le devis doit détailler les prestations, la main-d'œuvre, le coût des pièces et le montant total TTC. Un serrurier qui refuse de fournir un devis est en infraction et s'expose à des sanctions de la DGCCRF.",
      },
      {
        question: 'Que faire si un serrurier me facture un montant excessif ?',
        answer:
          "Si la facture dépasse largement le devis signé, vous pouvez contester. Payez sous réserve (mentionnez « payé sous réserve de contestation » par écrit), conservez tous les documents, et saisissez la DGCCRF (direction départementale de la protection des populations) ou le médiateur de la consommation. Vous pouvez aussi contacter l'UFC-Que Choisir ou la CLCV.",
      },
      {
        question: 'La serrure A2P est-elle vraiment nécessaire ?',
        answer:
          "La certification A2P n'est pas obligatoire mais fortement recommandée pour les portes d'entrée. C'est la seule norme reconnue par les assureurs en France : certains contrats exigent une serrure A2P pour une couverture optimale contre le cambriolage. Le surcoût (80 – 250 € pour le cylindre) est un investissement de sécurité judicieux.",
      },
      {
        question: 'Comment savoir si un serrurier est un vrai professionnel ?',
        answer:
          "Vérifiez trois éléments : le SIRET sur societe.com (entreprise active avec code APE de serrurerie), l'attestation d'assurance responsabilité civile professionnelle à jour, et les avis clients vérifiés. Un professionnel sérieux affiche ses coordonnées complètes et répond clairement à vos questions, y compris sur les tarifs, dès le premier appel.",
      },
      {
        question: 'Combien de temps faut-il pour ouvrir une porte claquée ?',
        answer:
          "Un serrurier expérimenté ouvre une porte claquée (sans serrure endommagée) en 5 à 30 minutes par crochetage ou by-pass. Ce délai augmente pour les portes blindées ou les serrures haute sécurité (A2P** ou A2P***). Si le serrurier annonce qu'il faut « percer » une porte simplement claquée, méfiez-vous : le crochetage est presque toujours possible.",
      },
      {
        question: 'Quels sont les tarifs normaux pour une ouverture de porte en 2026 ?',
        answer:
          'Ouverture porte claquée simple en journée : 80 à 150 €. Ouverture serrure bloquée : 150 à 300 €. Ouverture porte blindée : 200 à 450 €. Majorations : +50 % le soir/week-end, +100 % nuit/jours fériés. Si un serrurier annonce plus de 250 € pour une ouverture simple en journée en semaine, le prix est anormal.',
      },
      {
        question: "Mon assurance couvre-t-elle l'intervention d'un serrurier ?",
        answer:
          "La plupart des contrats multirisques habitation couvrent l'ouverture de porte après perte de clés (garantie « perte de clés » optionnelle) et le remplacement de serrure après effraction (garantie « vol »). La franchise est généralement de 50 à 200 €. Déclarez le sinistre sous 2 jours ouvrés (effraction) ou 5 jours (perte de clés) et conservez la facture du serrurier.",
      },
      {
        question: 'Blindage de porte ou serrure connectée : quelle est la meilleure protection ?',
        answer:
          "Ce sont deux protections complémentaires. Le blindage de porte (600-1 200 €) protège contre l'effraction physique (pied-de-biche, perceuse). La serrure connectée (250-700 €) protège contre les oublis de clés et permet le contrôle d'accès à distance. Pour une sécurité optimale, combinez un blindage avec une serrure A2P** et un cylindre connecté certifié.",
      },
    ],
    keyTakeaways: [
  ...
  'comment-choisir-chauffagiste-guide': {
    ...
    excerpt:
      'Installation, entretien, dépannage de chaudière ou pompe à chaleur : les critères pour sélectionner un chauffagiste qualifié et fiable.',
    metaTitle: 'Choisir son Chauffagiste : guide RGE 2026',
    metaDescription:
      'Comment choisir un chauffagiste qualifié ? RGE, QualiPAC, assurances : les critères pour PAC, chaudière, entretien. Devis gratuit.',
    content: [
      ...
      "## Erreurs à éviter lors du choix d'un chauffagiste",

      ":::warning 5 erreurs coûteuses\n1. **Signer avec un démarcheur téléphonique** — Les arnaques aux PAC à 1 € sont massives en France. Un chauffagiste sérieux ne démarche JAMAIS par téléphone. Coût de l'arnaque : 10 000 à 20 000 € de crédit + installation défaillante ou abandonnée.\n2. **Choisir un chauffagiste non RGE** — Sans label RGE, vous perdez toutes les aides (MaPrimeRénov' 5 000 €, CEE 4 000 €, TVA 5,5 %). L'économie de 500 € sur le devis vous coûte 5 000 à 10 000 € d'aides perdues.\n3. **Accepter un dimensionnement sans bilan thermique** — Un chauffagiste qui propose une PAC « au feeling » sans calculer les déperditions thermiques va surdimensionner ou sous-dimensionner l'appareil. Dans les deux cas : surconsommation, inconfort et usure prématurée.\n4. **Négliger le bruit de l'unité extérieure** — Une PAC air-eau ou air-air émet 40 à 55 dB en fonctionnement. Mal positionnée (sous une fenêtre de chambre, contre le mur du voisin), elle devient une source de conflit. Le chauffagiste doit vous conseiller sur l'emplacement optimal et les solutions antibruit.\n5. **Ne pas souscrire de contrat d'entretien** — L'entretien annuel est obligatoire. Un contrat (150-300 €/an) inclut la visite annuelle ET la priorité d'intervention en cas de panne. Sans contrat, un dépannage d'urgence en janvier coûte 200-500 € et le délai d'attente peut atteindre 5-7 jours.\n:::",

      '## Liens utiles pour votre projet de chauffage',

      "Pour anticiper votre budget, consultez notre article détaillé sur les [tarifs de chauffagiste en 2026](/blog/prix-chauffagiste-2026-installation-entretien) avec les prix moyens constatés dans toute la France. Pour comprendre les aides disponibles, consultez notre guide [MaPrimeRénov' 2026](/blog/aide-maprimerenov-2026-montants-conditions) et le [guide des aides rénovation 2026](/blog/renovation-energetique-aides-2026). Si vous envisagez une isolation préalable, les [prix d'un couvreur](/blog/prix-charpentier-2026-tarifs-charpente) et les [tarifs d'un plombier](/blog/prix-plombier-2026-tarifs-horaires) compléteront votre budget.",

      '## Sources et méthodologie',
      "Ce guide s'appuie sur les recommandations de l'ADEME, de Qualit'EnR (organisme de qualification RGE), de l'AFPAC (Association Française pour les Pompes à Chaleur) et de la FFB. Les fourchettes de prix mentionnées sont issues de l'analyse de 940+ devis collectés sur ServicesArtisans entre janvier et mars 2026. Dernière mise à jour : mars 2026.",
    ...
    faq: [
      {
        question: 'Pourquoi le label RGE est-il si important pour un chauffagiste ?',
        answer:
      ...
      {
        question: "Qu'est-ce qu'un bilan thermique et est-il obligatoire ?",
        answer:
          "Le bilan thermique évalue les besoins en chauffage de votre logement en tenant compte de la surface, l'isolation, l'exposition et la zone climatique. Il n'est pas légalement obligatoire mais est indispensable pour un dimensionnement correct de l'équipement. Un chauffagiste sérieux le réalise systématiquement (gratuit ou 200 – 500 €). Sans bilan, le risque de surdimensionnement est très élevé.",
      },
      {
        question: 'Quelle différence entre QualiPAC et RGE ?',
        answer:
          "RGE est un label générique signifiant Reconnu Garant de l'Environnement. QualiPAC est une qualification spécifique aux pompes à chaleur, délivrée par Qualit'EnR après une formation dédiée. Un chauffagiste QualiPAC est nécessairement RGE, mais un chauffagiste RGE n'est pas forcément QualiPAC. Pour l'installation d'une PAC, exigez QualiPAC.",
      },
      {
        question: 'Comment reconnaître une arnaque à la pompe à chaleur ?',
        answer:
          "Les signaux d'alerte sont clairs : démarchage téléphonique non sollicité, promesse de « PAC à 1 € » ou « gratuite grâce aux aides », pression pour signer rapidement, absence de visite préalable, marque de PAC inconnue. Un professionnel sérieux ne démarche jamais par téléphone et réalise toujours une visite + un bilan thermique avant de proposer un devis.",
      },
      {
        question: 'Faut-il isoler avant de changer le chauffage ?',
        answer:
          "Oui, c'est la règle d'or de la rénovation énergétique. Isoler d'abord réduit les besoins en chauffage, ce qui permet de choisir un équipement moins puissant et moins coûteux. Une PAC dimensionnée pour une maison mal isolée sera surdimensionnée après isolation, avec des cycles courts qui l'usent prématurément. L'ADEME recommande : 1) isoler, 2) ventiler, 3) chauffer.",
      },
      {
        question: "Combien coûte l'entretien annuel d'une chaudière ?",
        answer:
          "L'entretien annuel d'une chaudière gaz coûte 90 à 150 € en intervention ponctuelle. Un contrat d'entretien annuel (150 à 250 €) inclut la visite de maintenance ET une priorité d'intervention en cas de panne. Pour une PAC, comptez 150 à 250 € par entretien. Le contrat est toujours plus avantageux : il est 10-20 % moins cher que les interventions ponctuelles et vous garantit une réaction rapide en cas de panne.",
      },
      {
        question: 'Peut-on garder ses radiateurs en installant une PAC ?',
        answer:
          "Oui, une PAC air-eau fonctionne avec les radiateurs existants. Les radiateurs basse température (< 50°C) offrent le meilleur rendement. Les anciens radiateurs en fonte fonctionnent aussi mais demandent une température d'eau plus élevée, ce qui réduit légèrement le COP de la PAC. Le chauffagiste peut ajouter un appoint électrique pour les jours les plus froids.",
      },
      {
        question: 'Quel délai pour installer une pompe à chaleur ?',
        answer:
          "Comptez 2 à 3 semaines entre la signature du devis et l'installation effective. Le chauffagiste commande le matériel (1-2 semaines de délai), puis l'installation prend 2 à 3 jours pour une PAC air-eau classique. En période de forte demande (automne), les délais peuvent s'allonger à 4-6 semaines. Anticipez et ne commandez pas en plein hiver quand tout le monde panique.",
      },
    ],
    keyTakeaways: [
  ...
  'comment-choisir-menuisier-guide': {
    ...
    excerpt:
      "Fenêtres, portes, escaliers, agencement sur mesure... Les clés pour sélectionner un menuisier compétent, du bois à l'aluminium.",
    metaTitle: 'Choisir son Menuisier en 2026 : les critères',
    metaDescription:
      'Comment choisir un menuisier ? Qualibat, spécialisations, garanties : les critères pour fenêtres, portes, escaliers. Devis gratuit.',
    content: [
    ...
    faq: [
      {
        question: 'Comment choisir entre un menuisier bois, alu ou PVC ?',
        answer:
      ...
      {
        question: 'Le label RGE est-il nécessaire pour un menuisier ?',
        answer:
          "Le label RGE est indispensable si vous souhaitez bénéficier des aides à la rénovation énergétique (MaPrimeRénov', CEE, TVA 5,5 %) pour le remplacement de fenêtres. Pour les travaux intérieurs (escaliers, placards), le RGE n'est pas nécessaire mais la certification Qualibat reste un gage de compétence.",
      },
      {
        question: "Comment vérifier la qualité du travail d'un menuisier ?",
        answer:
          'Demandez des photos de réalisations récentes, et si possible visitez un chantier terminé. Vérifiez la régularité des assemblages, la qualité des finitions, le bon fonctionnement des mécanismes (fenêtres, coulisses). Consultez les avis clients sur ServicesArtisans et demandez des références de clients précédents.',
      },
    ],
    keyTakeaways: [
  ...
  'comment-choisir-carreleur-guide': {
    ...
    excerpt:
      'Pose de carrelage sol et mural, faïence, mosaïque : les critères pour trouver un carreleur minutieux et professionnel. Devis gratuit.',
    ...
    faq: [
      {
        question: 'Quelles qualifications doit avoir un bon carreleur ?',
        answer:
          "Un carreleur qualifié détient un CAP Carreleur-mosaïste ou un BP dans la même spécialité. La certification Qualibat en carrelage est un gage supplémentaire. Pour les travaux en pièces humides, vérifiez qu'il maîtrise les systèmes d'étanchéité sous carrelage (SPEC) conformes au DTU 52.2.",
      },
      {
        question: 'Pourquoi le double encollage est-il important pour les grands formats ?',
        answer:
          "Le double encollage (colle sur le support ET sur le carreau) est obligatoire selon le DTU 52.2 pour les formats supérieurs à 30×30 cm. Sans double encollage, des poches d'air se forment sous le carreau, provoquant des sonneux (carreaux creux) et des décollements prématurés. Cette exigence concerne donc la très grande majorité des carrelages posés aujourd'hui.",
      },
      {
        question: "Comment vérifier la qualité d'une pose de carrelage ?",
        answer:
          "Tapotez les carreaux avec le manche d'un tournevis : un son creux indique un défaut de collage. Vérifiez la planéité avec une règle de 2 mètres (tolérance de 3 mm). Examinez la régularité des joints et la qualité des coupes. Testez l'étanchéité de la douche en bouchant le siphon et en remplissant d'eau pendant 24 heures.",
      },
    ],
    keyTakeaways: [
  ...
  'comment-choisir-macon-guide': {
    ...
    excerpt:
      'Construction, extension, rénovation de structure : les critères essentiels pour sélectionner un maçon compétent et assuré. Devis gratuit.',
    metaTitle: 'Choisir son Maçon en 2026 : les bons réflexes',
    metaDescription:
      'Comment choisir un maçon fiable ? Décennale, Qualibat, devis : les réflexes pour construction, extension, rénovation. Devis gratuit.',
    content: [
    ...
    faq: [
      {
        ...
        answer:
          "Depuis la loi Élan de 2018, l'étude géotechnique est obligatoire pour les maisons individuelles dans les zones exposées au retrait-gonflement des argiles (environ 50 % du territoire). Même hors zone à risque, elle est fortement recommandée. Son coût (800 – 2 000 €) est modeste comparé aux conséquences d'un mauvais dimensionnement des fondations.",
      },
      {
        question: "Comment vérifier l'assurance décennale d'un maçon ?",
        answer:
          "Demandez l'attestation avant signature du devis. Vérifiez la date de validité, les activités couvertes (maçonnerie, gros œuvre, béton armé) et le nom de l'entreprise. Contactez directement l'assureur en cas de doute. La décennale est absolument impérative pour tout travail de maçonnerie.",
      },
      {
        question: 'Que doit contenir un devis de maçonnerie sérieux ?',
        answer:
          "Un devis complet détaille : la nature des fondations (type, profondeur, ferraillage), les matériaux utilisés (type de parpaings, béton, armatures), les quantités précises, la main-d'œuvre, la gestion des déblais, le délai d'exécution, et les postes souvent oubliés (étude de sol, regards, hérissonnage).",
      },
    ],
    keyTakeaways: [
  ...
  'comment-choisir-couvreur-guide': {
    ...
    excerpt:
      'Réfection de toiture, réparation de fuite, démoussage : comment sélectionner un couvreur qualifié et éviter les mauvaises surprises.',
    metaTitle: 'Choisir son Couvreur : éviter les pièges 2026',
    metaDescription:
      "Comment choisir un couvreur fiable ? Décennale obligatoire, devis détaillé, signes d'arnaque. Les pièges à éviter. Devis gratuit.",
    content: [
    ...
    faq: [
      {
        question: 'Comment reconnaître un couvreur sérieux ?',
        answer:
          "Un couvreur sérieux détient un CAP Couvreur, est certifié Qualibat, dispose d'une garantie décennale valide, monte sur le toit pour le diagnostic (jamais de devis depuis le sol), respecte les règles de sécurité (harnais, échafaudage), et ne fait jamais de démarchage au porte-à-porte.",
      },
      {
        question: 'Que faire en cas de fuite de toiture urgente ?',
        answer:
          "Placez des récipients sous la fuite, bâchez la zone extérieure si c'est accessible en sécurité, contactez un couvreur en urgence et prévenez votre assurance habitation (dégât des eaux). Ne montez jamais sur le toit vous-même. Un couvreur sérieux intervient sous 24 à 48 heures.",
      },
      {
        question: 'Le label RGE est-il nécessaire pour un couvreur ?',
        answer:
          "Le label RGE est nécessaire uniquement pour les travaux d'isolation de toiture (sarking, isolation sous rampants) ouvrant droit aux aides MaPrimeRénov' et CEE. Pour un simple remplacement de tuiles ou une réparation de fuite, le RGE n'est pas requis, mais la certification Qualibat en couverture reste recommandée.",
      },
    ],
    keyTakeaways: [
  ...
  'comment-choisir-jardinier-paysagiste': {
    ...
    excerpt:
      'Création de jardin, entretien, élagage, aménagement paysager : les critères pour trouver le bon professionnel. Devis gratuit.',
    ...
    faq: [
      {
        question: 'Quelle est la différence entre un jardinier et un paysagiste ?',
        answer:
          "Le jardinier réalise les travaux d'entretien (tonte, taille, désherbage). Le paysagiste conçoit et réalise des aménagements élaborés (création de jardins, terrasses, allées, systèmes d'arrosage). Certains professionnels cumulent les deux compétences. Identifiez clairement votre besoin avant de chercher.",
      },
      {
        question: "Le crédit d'impôt s'applique-t-il aux travaux de paysagisme ?",
        answer:
          "Non, le crédit d'impôt de 50 % s'applique uniquement aux petits travaux d'entretien (tonte, taille, désherbage, ramassage de feuilles) réalisés par un professionnel agréé services à la personne. Les travaux de création paysagère ne sont pas éligibles.",
      },
      {
        question: 'Faut-il une certification pour élaguer des arbres ?',
        answer:
          "L'élagage d'arbres de grande hauteur doit être confié à un élagueur-grimpeur titulaire du CS (Certificat de Spécialisation) Taille et soins des arbres. C'est un travail dangereux nécessitant des compétences spécifiques. Vérifiez aussi l'assurance RC professionnelle couvrant les dommages aux biens.",
      },
    ],
    keyTakeaways: [
  ...
  'comment-choisir-vitrier-guide': {
    ...
    excerpt:
      "Bris de glace, remplacement de vitrage, double vitrage : comment trouver un vitrier compétent, même en situation d'urgence.",
    ...
    faq: [
      {
        question: 'Comment choisir un vitrier en urgence ?',
        answer:
      ...
      {
        question: 'Le double vitrage VIR vaut-il le surcoût ?',
        answer:
          "Oui, le VIR (Vitrage à Isolation Renforcée) avec gaz argon offre une isolation 30 à 50 % supérieure au double vitrage standard pour un surcoût de 30 à 50 %. C'est le standard pour toute rénovation énergétique et il est nécessaire pour bénéficier des aides (Uw ≤ 1,3 W/m².K).",
      },
      {
        question: 'Mon assurance couvre-t-elle le bris de glace ?',
        answer:
          'La plupart des contrats multirisques habitation incluent une garantie bris de glace. Elle couvre les vitres, doubles vitrages, miroirs fixes et parfois les panneaux solaires. La franchise est généralement de 50 à 150 €. Déclarez le sinistre dans les 5 jours ouvrés et conservez les photos.',
      },
    ],
    keyTakeaways: [
  ...
  'comment-choisir-climaticien-guide': {
    ...
    excerpt:
      'Climatisation réversible, PAC air-air, entretien frigorifique : les critères pour choisir un climaticien certifié et compétent.',
    metaTitle: 'Choisir son Climaticien 2026 : certifications',
    metaDescription:
      'Comment choisir un climaticien certifié ? Fluides frigorigènes, QualiPAC, garanties : les critères pour une clim bien posée. Devis gratuit.',
    content: [
    ...
    faq: [
      {
        ...
        answer:
          "C'est un document obligatoire prouvant que le professionnel est habilité à manipuler les fluides frigorigènes (gaz utilisés dans les climatiseurs et PAC). Elle est délivrée par un organisme agréé après vérification des compétences et de l'équipement. Sans cette attestation, l'installation est illégale.",
      },
      {
        question:
          "Pourquoi un bilan thermique est-il nécessaire avant d'installer une climatisation ?",
        answer:
      ...
      {
        question: 'Faut-il une autorisation en copropriété pour installer une climatisation ?',
        answer:
          "Oui, l'installation d'une unité extérieure sur une façade ou un balcon nécessite l'accord de l'assemblée générale (majorité absolue, article 25). Certains règlements de copropriété interdisent les unités visibles en façade. Vérifiez le règlement avant de lancer votre projet.",
      },
    ],
    keyTakeaways: [
  ...
  'comment-choisir-cuisiniste-guide': {
    ...
    excerpt:
      'Conception 3D, choix des matériaux, pose professionnelle : tous les critères pour choisir un cuisiniste qui transformera votre projet en réalité.',
    ...
    faq: [
      {
        question: 'Cuisiniste indépendant ou grande enseigne : que choisir ?',
        answer:
          "Les grandes enseignes offrent un large choix et des outils 3D performants, mais la pose est souvent sous-traitée. Le cuisiniste indépendant propose un accompagnement personnalisé et maîtrise mieux la pose. L'artisan menuisier réalise du sur-mesure intégral. Le choix dépend de votre budget et de vos exigences de personnalisation.",
      },
      {
        question: "Que vérifier à la réception d'une cuisine ?",
        answer:
          "Vérifiez que les façades sont alignées, que les tiroirs coulissent sans accrocher, que les joints d'étanchéité sont impeccables, que l'électroménager fonctionne, que les écoulements sont corrects, et que le plan de travail est parfaitement de niveau. Notez toutes les réserves sur le bon de réception.",
      },
      {
        question: 'Quel acompte maximum pour une cuisine ?',
        answer:
          "Ne versez jamais plus de 30 à 40 % d'acompte à la commande. Le solde se paie à la réception des travaux. Si le cuisiniste exige un acompte supérieur ou un paiement intégral avant livraison, c'est un signal d'alerte. Vérifiez aussi que l'entreprise dispose d'une garantie financière d'achèvement.",
      },
    ],
    keyTakeaways: [
  ...
  'comment-choisir-entreprise-nettoyage': {
    ...
    excerpt:
      'Nettoyage de locaux, fin de chantier, copropriété : les critères pour sélectionner une entreprise de nettoyage fiable. Comparez.',
    ...
    faq: [
      {
        question: "Comment vérifier qu'une entreprise de nettoyage est sérieuse ?",
        answer:
          "Vérifiez la certification Qualipropre, l'attestation de vigilance URSSAF (prouvant le respect des obligations sociales), l'assurance RC professionnelle, et les avis clients. Demandez le taux de rotation du personnel (un taux élevé est synonyme de qualité instable) et les procédures de contrôle qualité.",
      },
      {
        question: 'Que doit contenir un devis de nettoyage professionnel ?',
        answer:
          "Un devis complet détaille : le nombre d'heures par intervention, le nombre d'agents, les produits et matériels utilisés, la fréquence des prestations spéciales, les conditions de remplacement en cas d'absence, les assurances, et les conditions de résiliation du contrat.",
      },
      {
        question: "Qu'est-ce que l'attestation de vigilance URSSAF ?",
        answer:
  ...
  'metier-plombier-formations-competences': {
    ...
    excerpt:
      'CAP, BP, mentions complémentaires, spécialisations et perspectives de carrière : tout savoir sur le métier de plombier en 2026.',
    content: [
    ...
    faq: [
      {
        question: 'Quelle formation pour devenir plombier ?',
        answer:
      ...
      {
        question: "Quel est le salaire d'un plombier en 2026 ?",
        answer:
          "Un plombier débutant salarié gagne 1 600 à 1 900 € net/mois. Avec l'expérience et les spécialisations : 2 500 à 3 200 € net. En tant qu'artisan indépendant : 3 000 à 5 000 € net/mois, voire davantage en Île-de-France. Les spécialisations en PAC et énergie renouvelable tirent les revenus vers le haut.",
      },
      {
        question: 'Le métier de plombier recrute-t-il ?',
        answer:
          "La France manque cruellement de plombiers : c'est l'un des métiers les plus recherchés du bâtiment. La transition énergétique (PAC, solaire thermique) et la rénovation du parc immobilier créent une demande massive. Le taux d'insertion professionnelle après formation dépasse 90 %.",
      },
    ],
    keyTakeaways: [
  ...
  'metier-macon-specialisations-carrieres': {
    ...
    excerpt:
      "Du CAP au titre d'ingénieur, de la maçonnerie traditionnelle à l'éco-construction : formations, spécialisations et évolution de carrière.",
    content: [
    ...
    faq: [
      {
        question: 'Quelle formation pour devenir maçon ?',
        answer:
          "Le CAP Maçon (2 ans) enseigne les techniques de base. Le BP Maçon approfondit l'organisation de chantier. Le Bac Pro TB ORGO offre une vision plus large en 3 ans. Des spécialisations existent : tailleur de pierre, coffreur-bancheur, éco-construction. La reconversion est possible via des formations accélérées (6-10 mois).",
      },
      {
        question: "Quel est le salaire d'un maçon en 2026 ?",
        answer:
          "Débutant salarié : 1 600 – 1 800 € net/mois. Chef d'équipe : 2 200 – 2 800 € net. Artisan indépendant : 2 500 – 4 500 € net/mois. Les spécialisations en taille de pierre ou éco-construction permettent de pratiquer des tarifs plus élevés.",
      },
      {
        question: "L'éco-construction offre-t-elle des débouchés ?",
        answer:
          "Oui, la transition écologique transforme le métier. Les maçons maîtrisant les matériaux biosourcés (béton de chanvre, briques de terre crue, monomur) sont très recherchés. Le BIM (maquettes numériques) est aussi un atout différenciant pour les chantiers d'envergure.",
      },
    ],
    keyTakeaways: [
  ...
  'metier-couvreur-risques-reglementation': {
    ...
    excerpt:
      "Formation, sécurité en hauteur, réglementation thermique : tout savoir sur le métier de couvreur, l'un des plus exposés du bâtiment.",
    content: [
    ...
    faq: [
      {
        question: 'Le métier de couvreur est-il dangereux ?',
        answer:
          "Oui, c'est l'un des métiers les plus dangereux du bâtiment. Les chutes de hauteur sont la première cause d'accidents graves et mortels dans le BTP. Le décret n° 2004-924 impose des protections collectives (garde-corps, filets, échafaudages) et individuelles (harnais). Un couvreur qui monte sans protection n'est pas un professionnel.",
      },
      {
        question: 'Quel salaire pour un couvreur en 2026 ?',
        answer:
          'Débutant : 1 600 – 1 900 € net/mois. Confirmé : 2 200 – 2 800 € net. À son compte : 3 000 – 5 000 € net/mois. La spécialisation en ardoise ou en restauration patrimoniale justifie des tarifs plus élevés. Le Meilleur Ouvrier de France (MOF) en couverture est la consécration suprême.',
      },
      {
        question: "Qu'est-ce que le diagnostic amiante avant travaux (DAAT) ?",
        answer:
          "Le DAAT est obligatoire pour les bâtiments construits avant juillet 1997. De nombreuses toitures de cette époque contiennent de l'amiante (fibrociment). Le retrait d'amiante nécessite une certification spécifique (formation SS3 ou SS4) et des procédures strictes de confinement et d'élimination.",
      },
    ],
    keyTakeaways: [
  ...
  'metier-menuisier-bois-alu-pvc': {
    ...
    excerpt:
      "Du compagnonnage aux techniques modernes : formations, spécialisations et évolution d'un métier qui allie tradition et innovation.",
    content: [
      ...
      ":::tip Conseil pour les futurs menuisiers\nLe parcours des **Compagnons du Devoir** (environ 6 ans avec Tour de France) reste la formation d'excellence, couronnée par un chef-d'œuvre. Si vous visez l'indépendance, maîtrisez la **conception 3D** (CAO/DAO) et les **machines à commande numérique** (CNC) : ces compétences vous démarquent et permettent de proposer du sur-mesure à des tarifs compétitifs.\n:::",
    ...
    faq: [
      {
        question: 'Quelle formation pour devenir menuisier ?',
        answer:
          "Le CAP Menuisier-fabricant (atelier) ou Menuisier-installateur (pose) sont les bases. Le BP Menuisier approfondit les compétences. Le Bac Pro Technicien menuisier-agenceur inclut la CAO. Le BMA Ébénisterie est la voie royale pour le bois massif. Les Compagnons du Devoir proposent une formation d'excellence (6 ans avec Tour de France).",
      },
      {
        question: 'Quel salaire pour un menuisier en 2026 ?',
        answer:
          'Débutant : 1 600 – 1 800 € net/mois. Confirmé spécialisé : 2 200 – 2 800 € net. En indépendant : 2 500 – 4 500 € net/mois. Le menuisier-agenceur maîtrisant conception 3D, fabrication et pose est un profil très recherché avec des revenus en conséquence.',
      },
      {
        question: 'Quelles sont les trois spécialités du menuisier moderne ?',
        answer:
          'Le menuisier bois (matériau noble, escaliers, agencements), le menuisier aluminium (menuiseries contemporaines, grandes baies, vérandas) et le menuisier PVC (menuiseries haute performance, entretien minimal). Chaque univers a ses techniques, normes et certifications spécifiques.',
      },
    ],
    keyTakeaways: [
  ...
  'metier-chauffagiste-pompe-chaleur': {
    ...
    excerpt:
      'Formations, certifications QualiPAC et RGE, nouvelles compétences : comment le métier de chauffagiste se transforme avec la transition énergétique.',
    content: [
    ...
    faq: [
      {
        question: 'Comment devenir chauffagiste spécialisé PAC ?',
        answer:
      ...
      {
        question: "Quel est le salaire d'un chauffagiste en 2026 ?",
        answer:
          'Débutant : 1 700 – 2 000 € net/mois. Technicien QualiPAC/RGE : 2 500 – 3 200 € net. En indépendant : 4 000 – 6 000 € net/mois grâce à la forte demande en PAC. La transition énergétique crée une demande massive qui tire les revenus vers le haut.',
      },
      {
        question: 'La reconversion vers le métier de chauffagiste est-elle possible ?',
        answer:
          "Oui, la forte demande attire de nombreux candidats à la reconversion. Des formations accélérées (titre professionnel, 6-12 mois) sont proposées par les GRETA, l'AFPA et les fabricants. Le financement est possible via le CPF ou France Travail. Le taux d'insertion professionnelle dépasse 90 %.",
      },
    ],
    keyTakeaways: [
  ...
  'metier-peintre-batiment-evolution': {
    ...
    excerpt:
      "Formations, spécialisations décoratives, peintures écologiques : portrait complet d'un métier en pleine transformation.",
    content: [
    ...
    faq: [
      {
        question: 'Quelle formation pour devenir peintre en bâtiment ?',
        answer:
          'Le CAP Peintre applicateur de revêtements (2 ans) est la base. Le BP approfondit les techniques décoratives. Le Bac Pro Aménagement et finition offre une vision large des métiers de la finition. La mention complémentaire Peinture décoration permet de se spécialiser rapidement après le CAP.',
      },
      {
        question: "Quel est le salaire d'un peintre en bâtiment en 2026 ?",
        answer:
          'Débutant : 1 550 – 1 750 € net/mois. Avec expérience : 1 900 – 2 500 € net. Décorateurs spécialisés ou ravaleurs expérimentés : +2 800 € net. En indépendant : 2 500 – 4 000 € net/mois. Le MOF en peinture décoration est la plus haute distinction.',
      },
      {
        question: 'Quelles sont les spécialisations les plus valorisées ?',
        answer:
          "Les spécialisations à forte valeur ajoutée : peintre décorateur (trompe-l'œil, patines, faux bois), applicateur de béton ciré, spécialiste du stuc (tadelakt, stucco vénitien), ravaleur de façade, et applicateur ITE (isolation thermique par l'extérieur). L'ITE est un marché en pleine expansion porté par les aides à la rénovation.",
      },
    ],
    keyTakeaways: [
