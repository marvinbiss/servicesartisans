...
export const metiersArticles: Record<string, BlogArticle> = {
  "comment-choisir-electricien-guide": {
    ...
    faq: [
      ...
      { question: "Combien coûte une mise aux normes électrique complète ?", answer: "Le coût d'une mise aux normes complète varie de 80 à 120 €/m² selon l'état de l'installation existante. Pour un appartement de 60 m², comptez 4 800 à 7 200 € en province, 20 à 30 % de plus en Île-de-France. Cette fourchette inclut le remplacement du tableau, les circuits, les prises, les points lumineux et le Consuel." },
      { question: "Peut-on rester dans le logement pendant les travaux d'électricité ?", answer: "Oui, dans la plupart des cas. L'électricien coupe le courant circuit par circuit, pas dans tout le logement en même temps. Prévoyez toutefois de la poussière (saignées dans les murs) et des désagréments ponctuels. Pour une rénovation complète (5 à 8 jours), envisagez un hébergement temporaire si vous êtes sensible au bruit et à la poussière." },
      { question: "Quand faut-il refaire entièrement l'électricité d'un logement ?", answer: "Une rénovation complète est recommandée si votre installation a plus de 30 ans, si le tableau est à fusibles (et non à disjoncteurs différentiels), s'il n'y a pas de mise à la terre, ou si un diagnostic électrique révèle plus de 5 anomalies majeures. Le diagnostic électrique obligatoire pour la vente (100-200 €) est un bon point de départ pour évaluer l'urgence." },
      { question: "Comment choisir entre un électricien indépendant et une entreprise ?", answer: "Un artisan indépendant est souvent plus souple sur les délais et moins cher (15 à 20 %) mais sa disponibilité est limitée. Une entreprise d'électricité offre plus de garanties (équipe disponible, SAV structuré) mais pratique des tarifs plus élevés. Dans les deux cas, vérifiez Qualifelec, la décennale et les avis clients. Pour un chantier de plus de 10 000 €, une entreprise est généralement plus sécurisante." }
    ],
    keyTakeaways: [
  ...
  "comment-choisir-serrurier-conseils": {
    ...
    faq: [
      ...
      { question: "Comment savoir si un serrurier est un vrai professionnel ?", answer: "Vérifiez trois éléments : le SIRET sur societe.com (entreprise active avec code APE de serrurerie), l'attestation d'assurance responsabilité civile professionnelle à jour, et les avis clients vérifiés. Un professionnel sérieux affiche ses coordonnées complètes et répond clairement à vos questions, y compris sur les tarifs, dès le premier appel." },
      { question: "Combien de temps faut-il pour ouvrir une porte claquée ?", answer: "Un serrurier expérimenté ouvre une porte claquée (sans serrure endommagée) en 5 à 30 minutes par crochetage ou by-pass. Ce délai augmente pour les portes blindées ou les serrures haute sécurité (A2P** ou A2P***). Si le serrurier annonce qu'il faut « percer » une porte simplement claquée, méfiez-vous : le crochetage est presque toujours possible." },
      { question: "Quels sont les tarifs normaux pour une ouverture de porte en 2026 ?", answer: "Ouverture porte claquée simple en journée : 80 à 150 €. Ouverture serrure bloquée : 150 à 300 €. Ouverture porte blindée : 200 à 450 €. Majorations : +50 % le soir/week-end, +100 % nuit/jours fériés. Si un serrurier annonce plus de 250 € pour une ouverture simple en journée en semaine, le prix est anormal." },
      { question: "Mon assurance couvre-t-elle l'intervention d'un serrurier ?", answer: "La plupart des contrats multirisques habitation couvrent l'ouverture de porte après perte de clés (garantie « perte de clés » optionnelle) et le remplacement de serrure après effraction (garantie « vol »). La franchise est généralement de 50 à 200 €. Déclarez le sinistre sous 2 jours ouvrés (effraction) ou 5 jours (perte de clés) et conservez la facture du serrurier." },
      { question: "Blindage de porte ou serrure connectée : quelle est la meilleure protection ?", answer: "Ce sont deux protections complémentaires. Le blindage de porte (600-1 200 €) protège contre l'effraction physique (pied-de-biche, perceuse). La serrure connectée (250-700 €) protège contre les oublis de clés et permet le contrôle d'accès à distance. Pour une sécurité optimale, combinez un blindage avec une serrure A2P** et un cylindre connecté certifié." }
    ],
    keyTakeaways: [
