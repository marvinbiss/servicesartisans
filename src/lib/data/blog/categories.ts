...
export const blogCategories: BlogCategory[] = [
  {
    ...
    metaDescription: 'Conseils d\'experts pour réussir vos travaux : choix artisan, matériaux, pièges à éviter. Guides pratiques testés par 500+ pros.',
  },
  {
    slug: 'tarifs',
    label: 'Tarifs',
    ...
    metaDescription: 'Tarifs artisans 2026 vérifiés : plombier 40-90€/h, électricien 40-85€/h, maçon 40-75€/h. Prix par métier + devis gratuit.',
  },
  {
    slug: 'fiches-metier',
    label: 'Fiches métier',
    ...
    metaDescription: 'Comment choisir un plombier, électricien, maçon ? Fiches métier : certifications, compétences, red flags et questions à poser.',
  },
  {
    slug: 'guides',
    label: 'Guides',
    ...
    metaDescription: 'Guides complets rénovation 2026 : maison, extension, isolation, toiture. Étapes, budgets réels et conseils de pros. Devis gratuit.',
  },
  {
    slug: 'reglementation',
    ...
    metaDescription: 'Réglementation travaux 2026 : permis, décennale, normes NF C 15-100, RE2020. Vos droits et obligations expliqués simplement.',
  },
  {
    ...
    metaDescription: 'Toutes les aides rénovation 2026 : MaPrimeRénov\' jusqu\'à 40 000€, CEE, éco-PTZ 50 000€, TVA 5,5%. Comment les cumuler.',
  },
  {
    slug: 'saisonnier',
    label: 'Saisonnier',
  ...
  },
  {
    ...
    metaDescription: 'Réduisez votre facture énergie de 40 à 60% : isolation, PAC, panneaux solaires, VMC. Guides comparatifs et aides 2026.',
  },
  {
    slug: 'diy',
    label: 'DIY',
  ...
  },
  {
    ...
    metaDescription: 'Urgences maison : fuite d\'eau, panne électrique, serrure bloquée. Les bons réflexes, prix réels du dépannage et pièges à éviter.',
  },
]
