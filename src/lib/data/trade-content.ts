...
export const tradeContent: Record<string, TradeContent> = {
  ...
  // Pivot full RGE 2026-05-03 : entrées serrurier, carreleur, vitrier,
  // cuisiniste, ebeniste retirées (commodity / hors thèse RGE — slugs non
  // présents dans SERVICE_SLUGS_CANONICAL côté src/lib/services/catalog.ts).
