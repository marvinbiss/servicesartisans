...
export const tradeContent: Record<string, TradeContent> = {
  ...
  jardinier: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "L'installation d'un arrosage automatique enterré coûte entre 8 et 15 €/m² pour un jardin de 200 à 500 m², incluant les tuyaux, les asperseurs, le programmateur et la main-d'œuvre. Un système goutte-à-goutte pour les massifs et haies est moins cher (3 à 8 €/m²). Le jardinier-paysagiste dimensionne l'installation en fonction de la pression d'eau, du débit disponible et des besoins des plantations.",
      },
    ],
    emergencyInfo:
  ...
  terrassier: {
    ...
    faq: [
      {
        q: 'Combien coûte un terrassement de maison ?',
        a: "Le terrassement pour une maison individuelle de 100 m² au sol coûte entre 3 000 et 10 000 € selon la nature du terrain, la profondeur des fondations et l'accessibilité du chantier.",
      },
      {
        q: 'Faut-il un permis pour terrassement ?',
        a: 'Pas de permis spécifique, mais une déclaration préalable de travaux est nécessaire si le terrassement modifie le relief naturel du terrain de plus de 2 m de hauteur et 100 m² de surface.',
      },
      {
        q: 'Quelle est la meilleure période pour réaliser un terrassement ?',
        a: "Le printemps et l'été sont les saisons idéales, car le sol est sec et stable. Évitez les périodes de gel (le sol gelé est très dur à creuser) et les fortes pluies (risque d'effondrement et de boue). Un terrassier expérimenté adapte ses techniques selon la saison.",
      },
      {
        q: "Qu'est-ce qu'une étude de sol et est-elle obligatoire ?",
        a: "L'étude de sol (ou étude géotechnique G2) analyse la nature du terrain (argile, roche, sable) pour dimensionner les fondations. Elle est obligatoire depuis 2020 pour la vente de terrains constructibles en zone argileuse (loi ELAN). Son coût est de 1 500 à 3 000 € et elle évite des surcoûts majeurs en cas de terrain instable.",
      },
      {
        q: 'Combien de temps dure un terrassement pour une maison ?',
      ...
      {
        q: "Combien coûte le terrassement d'un terrain ?",
        a: "Le prix varie considérablement selon la nature du sol : 20 à 40 €/m³ pour de la terre meuble, 50 à 100 €/m³ pour de la roche nécessitant un brise-roche hydraulique. L'accessibilité du terrain et la distance d'évacuation des déblais impactent également fortement le prix final.",
      },
      {
        q: 'Faut-il une étude de sol avant le terrassement ?',
        a: "C'est fortement recommandé et même obligatoire depuis 2020 en zone argileuse (loi ELAN). L'étude géotechnique G2 coûte entre 1 500 et 3 000 € et permet de dimensionner correctement les fondations, d'anticiper les difficultés (nappe phréatique, roche) et d'éviter des surcoûts importants en cours de chantier.",
      },
      {
        q: "Que devient la terre excavée lors d'un terrassement ?",
        a: "La terre excavée peut être réutilisée en remblai sur le chantier si elle est propre et de bonne qualité (pas de terre végétale pour les fondations). Sinon, elle doit être évacuée vers une décharge agréée (Installation de Stockage de Déchets Inertes), ce qui coûte 15 à 30 €/m³ hors transport. Pensez à négocier l'évacuation dans le devis global.",
      },
    ],
    emergencyInfo:
    ...
    certifications: [
      'Qualibat (qualification 1111/1112 terrassement)',
      "CACES (Certificat d'Aptitude à la Conduite En Sécurité — catégories A à F)",
      "AIPR (Autorisation d'Intervention à Proximité des Réseaux — obligatoire)",
      'Label Qualité TP (Travaux Publics)',
      'NF DTU 12 (terrassement pour le bâtiment — normes de mise en œuvre)',
      'Assurance décennale obligatoire pour tous travaux de terrassement',
      'Certification FNTP (Fédération Nationale des Travaux Publics)',
      'Qualibat 1112 (terrassements spécialisés — niveau confirmé)',
    ],
    averageResponseTime: 'Devis sous 48h, intervention sous 1 à 3 semaines',
  },
  ...
  metallier: {
    ...
    faq: [
      {
        q: "Combien coûte une verrière d'intérieur ?",
        a: 'Une verrière atelier sur mesure coûte entre 800 et 2 500 €/m² selon le matériau (acier, aluminium), le type de vitrage (simple, double, feuilleté) et la complexité de la pose. Une verrière standard de 2 m × 1,5 m revient à 2 500 à 5 000 €, pose comprise.',
      },
      {
        q: 'Acier, inox ou aluminium : quel métal choisir ?',
        a: "L'acier est le plus polyvalent et le moins cher, idéal pour la plupart des ouvrages intérieurs et extérieurs (avec traitement thermolaqué). L'inox (304 ou 316) résiste à la corrosion sans entretien, parfait pour les bords de mer ou de piscine, mais coûte 2 à 3 fois plus cher. L'aluminium est léger et ne rouille pas, adapté aux menuiseries et grandes portées.",
      },
      {
        q: 'Combien coûte un escalier métallique sur mesure ?',
        a: 'Un escalier droit en acier thermolaqué revient à 3 000 à 6 000 €, un quart-tournant à 5 000 à 8 000 € et un escalier hélicoïdal à 6 000 à 12 000 €. Le prix augmente avec les finitions (marches en bois, verre ou acier), le type de garde-corps et la complexité de la pose. Prévoyez 4 à 6 semaines de fabrication.',
      },
      {
        q: "Une verrière d'intérieur isole-t-elle du bruit ?",
        a: "Avec un simple vitrage (6 mm), l'isolation acoustique est faible (environ 25 dB). Un double vitrage 4/16/4 atteint 30 à 35 dB, ce qui est acceptable pour séparer une cuisine d'un salon. Pour une véritable isolation phonique (bureau, chambre), optez pour un vitrage acoustique feuilleté 44.2 qui offre 37 à 42 dB d'affaiblissement.",
      },
      {
        q: 'Faut-il un permis de construire pour une pergola métallique ?',
      ...
      {
        q: 'Peut-on mélanger métal et bois dans un ouvrage ?',
        a: "Oui, c'est une tendance très actuelle en architecture intérieure et extérieure. Le métal apporte la structure et la rigidité, tandis que le bois ajoute chaleur et confort visuel. Les combinaisons les plus populaires sont l'escalier métal-bois (structure acier + marches en chêne), la mezzanine sur ossature métallique avec plancher bois et le garde-corps acier avec main courante en bois. Prévoyez un budget de 10 à 20 % supérieur à un ouvrage tout métal.",
      },
      {
        q: 'Combien coûte un portail coulissant motorisé en métal ?',
        a: 'Un portail coulissant motorisé en acier thermolaqué coûte entre 2 000 et 6 000 € tout compris (portail + rail + motorisation + pose). Le prix varie selon la largeur (3 à 5 m), le design (plein, ajouré, à lames) et la motorisation choisie. Prévoyez un massif béton pour le rail de guidage et une alimentation électrique enterrée. Le délai de fabrication est de 3 à 5 semaines.',
      },
      {
        q: "Qu'est-ce qu'une structure métallique pour mezzanine et combien ça coûte ?",
    ...
    certifications: [
      'Qualibat (qualification 4411/4412 métallerie-serrurerie)',
      'Certification EN 1090 (exécution des structures en acier — marquage CE)',
      "Label Artisanat d'Art (ouvrages décoratifs)",
      'ACQPA (qualification peinture anticorrosion — si thermolaquage)',
      'Certification soudure EN ISO 9606 (qualification du soudeur)',
      'Qualification CTICM (Centre Technique Industriel de la Construction Métallique)',
      "Compagnons du Tour de France (parcours de formation itinérant d'excellence)",
      'Assurance décennale obligatoire (garantie 10 ans sur les ouvrages structurels)',
    ],
  ...
  ferronnier: {
    ...
    faq: [
      {
        q: 'Quelle est la différence entre un ferronnier et un métallier ?',
        a: "Le ferronnier travaille principalement le fer forgé à chaud (forge traditionnelle) pour des ouvrages décoratifs et artistiques. Le métallier travaille l'acier, l'inox et l'aluminium à froid (soudure, pliage) pour des ouvrages structurels. En pratique, beaucoup d'artisans maîtrisent les deux techniques.",
      },
      {
        q: 'Combien coûte un portail en fer forgé ?',
        a: "Un portail en fer forgé sur mesure coûte entre 2 000 et 8 000 € selon les dimensions, la complexité du motif et le type de finition. Un portail battant standard (3 m de largeur) revient à 2 500 à 4 500 €, tandis qu'un modèle très ouvragé avec volutes et pointes peut atteindre 6 000 à 8 000 €. Ajoutez 1 000 à 2 500 € pour la motorisation.",
      },
      {
        q: 'Le fer forgé est-il adapté en bord de mer ?',
        a: "Le fer forgé supporte mal les environnements salins sans traitement adapté. Pour le bord de mer, exigez une galvanisation à chaud (immersion dans un bain de zinc à 450 °C) suivie d'une peinture époxy marine. Ce traitement double le coût de la finition mais garantit 20 à 30 ans de tenue. Alternativement, optez pour de l'inox 316L ou de l'aluminium.",
      },
      {
        q: 'Peut-on restaurer une rampe ou un portail ancien en fer forgé ?',
        a: "Oui, un ferronnier spécialisé en restauration peut décaper, redresser et ressouder des ouvrages anciens. La restauration coûte généralement 30 à 60 % du prix d'un ouvrage neuf équivalent, tout en préservant le cachet d'origine. Le ferronnier peut aussi reproduire à l'identique les éléments manquants (volutes, rosaces). Comptez 4 à 8 semaines de travail en atelier.",
      },
      {
        q: "Le fer forgé est-il plus solide que l'acier soudé ?",
        a: "Le fer forgé traditionnel (travaillé à la forge à 900-1200 °C) offre une structure fibreuse très résistante à la fatigue et aux chocs. L'acier soudé industriel est plus rigide mais les soudures constituent des points de faiblesse potentiels. Pour un garde-corps ou un portail, les deux techniques offrent une solidité largement suffisante. Le fer forgé se distingue surtout par son esthétique unique.",
      },
      {
        q: 'Fer forgé ou aluminium pour un portail ?',
        a: "Le fer forgé est artisanal, durable et noble : chaque portail est unique, avec une durée de vie de 50 ans et plus. En revanche, il nécessite un entretien anticorrosion régulier (tous les 5 à 7 ans). L'aluminium est léger, sans entretien et résistant à la corrosion, mais son aspect reste industriel et standardisé. Le fer forgé est un choix patrimonial, l'aluminium un choix pratique.",
      },
      {
        q: 'Combien coûte un garde-corps en fer forgé ?',
        a: "Un garde-corps en fer forgé coûte entre 150 et 400 €/ml selon la complexité du motif, pose incluse. Pour un balcon standard de 3 à 4 mètres linéaires, comptez 1 500 à 4 000 € tout compris. Un modèle simple à barreaux droits sera en bas de fourchette, tandis qu'un ouvrage avec volutes, feuillages ou motifs personnalisés se situera en haut de gamme.",
      },
      {
        q: "La ferronnerie d'art est-elle éligible aux aides de l'État ?",
        a: "Les ouvrages purement décoratifs (mobilier, sculptures) ne sont pas éligibles aux aides. En revanche, les grilles de défense pour fenêtres peuvent relever de la sécurisation du logement. Par ailleurs, tous les travaux de ferronnerie en rénovation d'un logement de plus de 2 ans bénéficient d'une TVA réduite à 10 % au lieu de 20 %, ce qui représente une économie significative sur des ouvrages coûteux.",
      },
    ],
    emergencyInfo:
    ...
    certifications: [
      "Label Entreprise du Patrimoine Vivant (EPV — délivré par l'État)",
      "Titre de Maître Artisan en métier d'art (Chambre de Métiers)",
      "Compagnons du Devoir (formation d'excellence)",
      'Qualibat (qualification 4411 métallerie-serrurerie)',
      'Compagnons du Tour de France (parcours de formation itinérant)',
      'Certification soudure EN ISO 9606 (qualification du soudeur)',
      'Assurance décennale obligatoire (garantie 10 ans sur les ouvrages structurels)',
      "Label Maître Artisan en Métier d'Art (délivré par la Chambre de Métiers et de l'Artisanat)",
    ],
  ...
  'poseur-de-parquet': {
    ...
    certifications: [
      'Qualibat (qualification 6421 parquets et revêtements en bois)',
      'Label Parquets de France (origine et qualité de fabrication)',
      "Compagnons du Devoir (formation d'excellence)",
    ],
    averageResponseTime: 'Devis sous 48h, intervention sous 1 à 3 semaines',
  },
  ...
  miroitier: {
    ...
    faq: [
      {
        q: 'Quelle épaisseur de verre pour une crédence ?',
        a: 'Une crédence de cuisine nécessite un verre trempé de 6 mm minimum (8 mm recommandé pour les grandes surfaces). Le verre laqué est le plus populaire car il offre un large choix de couleurs et se nettoie facilement. Budget : 150 à 350 €/m², pose comprise.',
      },
      {
        q: "Combien coûte le remplacement d'un double vitrage ?",
        a: "Le remplacement d'un double vitrage standard (4/16/4) coûte entre 150 et 300 €/m² pose comprise. Un vitrage à isolation renforcée (VIR ou ITR) revient à 200 à 400 €/m² mais réduit les déperditions thermiques de 40 %. Pour une fenêtre standard (1,2 m × 1 m), comptez 200 à 400 € tout compris. Le délai est de 1 à 2 semaines (fabrication sur mesure).",
      },
      {
        q: 'Verre trempé ou verre feuilleté : lequel choisir ?',
        a: 'Le verre trempé (securit) est 5 fois plus résistant que le verre ordinaire et se brise en petits morceaux non coupants. Il est obligatoire pour les parois de douche et les tables. Le verre feuilleté (deux verres + film PVB) ne tombe pas en morceaux à la casse : il est obligatoire pour les garde-corps, les toitures vitrées et les vitrines. Certaines applications exigent un verre trempé-feuilleté (cumul des deux propriétés).',
      },
      {
        q: 'Un miroitier peut-il intervenir en urgence ?',
        a: "Oui, la plupart des miroitiers proposent un service d'urgence pour les vitrines de commerce cassées, les fenêtres brisées après effraction ou les dégâts de tempête. L'intervention sous 24h coûte 30 à 50 % de plus qu'une intervention programmée. En attendant, bâchez l'ouverture avec une bâche ou du contreplaqué pour sécuriser le local.",
      },
      {
        q: 'Comment choisir un miroir pour une salle de bain ?',
        a: "Optez pour un miroir avec traitement anti-buée intégré (film chauffant au dos) et bords polis pour résister à l'humidité. Évitez les miroirs bas de gamme dont le tain (couche réfléchissante) se dégrade rapidement en milieu humide. Un miroir sur mesure avec éclairage LED intégré coûte 200 à 800 € selon les dimensions et les options.",
      },
      {
        q: 'Quelle épaisseur de miroir choisir ?',
        a: "3 mm convient pour la décoration légère (cadres, petits miroirs décoratifs). 4 à 5 mm est le standard pour une salle de bain ou un miroir mural de taille moyenne. 6 mm et plus est recommandé pour les grands formats (miroir plein pied, miroir mural de plus d'un mètre) ou les poses lourdes nécessitant une fixation mécanique.",
      },
      {
        q: 'Miroir argenté ou miroir aluminium : quelle différence ?',
        a: "Le miroir argenté offre un reflet plus naturel et plus lumineux : c'est le choix classique pour les salons, les chambres et les entrées. Le miroir aluminium résiste mieux à l'humidité et à la corrosion : il est adapté aux salles de bain, aux piscines et aux environnements humides. L'écart de prix est faible (10 à 15 % de plus pour l'aluminium).",
      },
      {
        q: 'Peut-on poser un miroir sur un mur humide ?',
        a: "Oui, à condition d'utiliser un miroir avec traitement anti-humidité (tain protégé par une couche de cuivre ou d'aluminium) et une colle spéciale type mastic-miroir neutre (ne pas utiliser de colle acide qui attaque le tain). Évitez le contact direct avec l'eau : laissez un espace de 5 mm minimum entre le bas du miroir et la surface mouillée (plan de vasque, rebord de baignoire).",
      },
    ],
    emergencyInfo:
    ...
    certifications: [
      'Qualibat 4423 (miroiterie)',
      'Certification Cekal (vitrages isolants)',
      'NF DTU 39 (mise en œuvre des vitrages)',
      'Label Artisan verrier',
      'Assurance RC professionnelle',
      'Qualibat (qualification 4311/4312 vitrerie-miroiterie)',
      'Certification NF EN 12150 (verres de sécurité trempés)',
      'Certification NF EN 1036 (miroirs argentés)',
    ],
  ...
  storiste: {
    ...
    faq: [
      {
        q: "Combien coûte la motorisation de tous les volets d'une maison ?",
        a: 'Pour une maison de 8 à 10 volets, comptez 2 500 à 5 000 € pour la motorisation complète (moteurs + commandes radio + installation). Une commande centralisée ajoute 300 à 800 €. La motorisation solaire est possible si le câblage électrique est difficile (+30 % de surcoût).',
      },
      {
        q: 'Store banne manuel ou motorisé ?',
        a: "Un store banne manuel (manivelle) coûte 500 à 1 500 € et convient aux petites largeurs (jusqu'à 3 m). Un store motorisé (800 à 3 000 €) est recommandé au-delà de 3 m de largeur, car la manœuvre manuelle devient pénible. La motorisation permet aussi l'ajout de capteurs automatiques (vent, soleil, pluie) qui protègent le store en votre absence.",
      },
      {
        q: "Quelle est la durée de vie d'un store banne ?",
        a: "Un store banne de qualité dure 10 à 15 ans avec un entretien correct. La toile acrylique teinte masse (la plus résistante) conserve ses couleurs 10 à 12 ans. L'armature en aluminium dure 20 ans+. Pour prolonger la durée de vie : rétractez le store en cas de vent fort, laissez sécher la toile avant de la replier et nettoyez-la une fois par an au savon de Marseille.",
      },
      {
        q: 'Quelles aides pour le remplacement de volets roulants ?',
        a: "Le remplacement de volets roulants anciens par des modèles isolants ouvre droit à la TVA réduite à 10 % pour les logements de plus de 2 ans. Si les volets intègrent une isolation thermique renforcée (coefficient Uc ≤ 1,4), vous pouvez bénéficier de MaPrimeRénov' et des CEE (prime énergie) à condition de passer par un installateur RGE.",
      },
      {
        q: 'Pergola bioclimatique ou store banne : que choisir ?',
        a: 'Le store banne (800 à 3 000 €) est idéal pour un ombrage ponctuel et se rétracte entièrement. La pergola bioclimatique (5 000 à 15 000 €) offre une protection permanente avec des lames orientables qui régulent la luminosité et la ventilation. La pergola ajoute de la valeur au bien immobilier et crée un véritable espace de vie extérieur utilisable même par temps de pluie légère.',
      },
      {
        q: 'Store banne ou pergola : que choisir pour sa terrasse ?',
        a: "Le store banne est moins cher (800 à 3 000 €), amovible et facile à installer, mais il est fragile au vent (rétractation obligatoire au-delà de 40 km/h). La pergola bioclimatique (5 000 à 15 000 €) est une structure permanente, solide face aux intempéries, mais elle nécessite des fondations et parfois une déclaration préalable de travaux. Pour un usage occasionnel, le store banne suffit ; pour un véritable espace de vie extérieur toute l'année, la pergola est le meilleur investissement.",
      },
      {
        q: 'Quelle toile choisir pour un store banne ?',
    ...
    certifications: [
      'Qualibat (qualification 3511/3512 stores et fermetures)',
      'RGE (obligatoire pour volets isolants ouvrant droit aux aides)',
      'Expert Somfy (partenaire installateur certifié par le fabricant)',
      'Label Storiste de France (réseau national de storistes professionnels)',
      'Certification ACERMI (performance thermique des stores et fermetures)',
      'NF EN 13561 (norme européenne pour les stores extérieurs)',
      'Qualification Somfy Expert (partenaire certifié motorisation et domotique)',
      'Assurance RC professionnelle (responsabilité civile obligatoire pour les installateurs)',
    ],
    averageResponseTime: 'Devis sous 48h, intervention sous 1 à 2 semaines',
  },
  ...
  'architecte-interieur': {
    ...
    faq: [
      {
        q: "Architecte d'intérieur ou décorateur ?",
        a: "L'architecte d'intérieur peut modifier les volumes (cloisons, ouvertures, mezzanines) et déposer des permis. Le décorateur intervient uniquement sur l'ameublement, les couleurs et les textiles sans toucher au bâti. Pour une rénovation avec travaux structurels, un architecte d'intérieur est indispensable.",
      },
      {
        q: "Combien coûte un architecte d'intérieur pour un appartement ?",
        a: "Les honoraires varient selon le type de mission : une consultation de 2h coûte 150 à 400 €, un projet complet (plans + 3D + shopping list) revient à 50 à 150 €/m², et un suivi de chantier complet ajoute 8 à 15 % du montant des travaux. Pour un appartement de 70 m² avec rénovation lourde, comptez 5 000 à 15 000 € d'honoraires pour la mission complète.",
      },
      {
        q: "Quels livrables attendre d'un architecte d'intérieur ?",
      ...
      {
        q: "L'architecte d'intérieur peut-il déposer un permis de construire ?",
      ...
      {
        q: "Comment choisir le bon architecte d'intérieur ?",
    ...
    certifications: [
      "Diplôme CFAI (Conseil Français des Architectes d'Intérieur — titre protégé)",
      "Inscription à l'Ordre des Architectes (si architecte DPLG/HMONP)",
      'Assurance décennale (obligatoire pour les travaux de structure)',
    ],
  ...
  decorateur: {
    ...
    faq: [
      {
        q: 'Combien coûte un décorateur pour un salon ?',
        a: "Pour un salon de 25 à 35 m², comptez 500 à 2 000 € pour une prestation complète : visite, planche d'ambiance, shopping list et accompagnement achat. Le budget mobilier et accessoires est en sus.",
      },
      {
        q: 'Quelle est la différence entre un décorateur et un home stager ?',
        a: "Le décorateur crée un intérieur personnalisé selon les goûts et le mode de vie du client (projet durable). Le home stager prépare un bien immobilier pour la vente en le dépersonnalisant et en le mettant en valeur pour séduire un maximum d'acheteurs (projet temporaire). Le home staging coûte généralement 1 à 3 % du prix de vente et permet de vendre plus vite et souvent à un meilleur prix.",
      },
      {
        q: 'Un décorateur peut-il intervenir à distance ?',
        a: "Oui, beaucoup de décorateurs proposent des prestations en ligne : vous envoyez les photos et les mesures de votre pièce, et le décorateur vous livre une planche d'ambiance, un plan d'aménagement et une shopping list. Le coût est 30 à 50 % inférieur à une prestation sur place (300 à 1 000 € par pièce). C'est une bonne solution pour les petits budgets ou les zones éloignées.",
      },
      {
        q: 'Quelles sont les tendances déco actuelles ?',
        a: 'Les tendances 2025-2026 privilégient les matériaux naturels (bois brut, pierre, lin), les couleurs terracotta et vert sauge, le mobilier arrondi et les luminaires sculpturaux. Le style japandi (mélange japonais-scandinave) et le maximalisme coloré coexistent. Un bon décorateur vous guidera vers un style intemporel qui ne se démodera pas en quelques mois.',
      },
      {
        q: 'Le décorateur achète-t-il le mobilier à ma place ?',
        a: "Selon la formule choisie, le décorateur peut soit vous fournir une shopping list que vous achetez vous-même, soit se charger de toutes les commandes (accompagnement achat). Dans le second cas, il gère les délais de livraison, vérifie la conformité des produits et coordonne la mise en place. Cette prestation coûte 50 à 120 €/h ou un forfait de 500 à 1 500 € selon le volume d'achats.",
      },
      {
        q: "Quelle différence entre décorateur et architecte d'intérieur ?",
      ...
      {
        q: 'Combien coûte une prestation de décoration complète ?',
      ...
      {
        q: 'Le home staging est-il rentable ?',
        a: "Oui, le home staging est l'un des investissements les plus rentables en immobilier. Selon la FNAIM, le retour sur investissement est de 3 à 5 fois la somme engagée : un home staging à 2 000 € permet de vendre 5 000 à 10 000 € plus cher et réduit le délai de vente de 30 à 50 %. Le home staging virtuel (retouche photo 3D) est une alternative économique (200 à 500 € par bien) pour les annonces en ligne.",
      },
    ],
    emergencyInfo:
    ...
    certifications: [
      "Titre professionnel Décorateur d'intérieur (inscrit au RNCP)",
      "Membre de l'UFDI (Union Francophone des Décorateurs d'Intérieur)",
      'Certification home staging (si spécialisation valorisation immobilière)',
      'Diplôme CFAI ou ESAIL (écoles reconnues en architecture intérieure et décoration)',
      "Certification Conseil en décoration délivrée par la CMA (Chambre de Métiers et de l'Artisanat)",
      'Label Décorateur professionnel (gage de compétence et de déontologie)',
      'Assurance RC professionnelle (responsabilité civile couvrant conseils et préconisations)',
      'Certification Home Staging Europe (formation spécialisée en valorisation immobilière)',
    ],
    averageResponseTime: 'Premier rendez-vous sous 1 semaine',
  },
  ...
  domoticien: {
    ...
    faq: [
      {
        q: 'Quel budget pour domotiser une maison ?',
        a: 'Le budget varie de 3 000 € (kit DIY : éclairage + thermostat + volets) à 30 000 €+ (installation professionnelle KNX complète). Un bon compromis est un système Zigbee/Z-Wave avec box domotique (5 000 à 10 000 €) qui couvre éclairage, chauffage, volets et sécurité.',
      },
      {
        q: 'KNX, Zigbee ou Z-Wave : quel protocole choisir ?',
        a: "Le KNX est le standard professionnel filaire le plus fiable et pérenne (30 ans+), mais il coûte 2 à 3 fois plus cher et nécessite un câblage spécifique (bus EIB). Le Zigbee est le protocole sans fil le plus répandu (compatible Philips Hue, Ikea, Aqara) avec un excellent rapport qualité-prix. Le Z-Wave offre une portée supérieure et moins d'interférences mais un choix de produits plus restreint. En rénovation, Zigbee ou Z-Wave sont les plus adaptés.",
      },
      {
        q: "La domotique permet-elle de réaliser des économies d'énergie ?",
      ...
      {
        q: 'Peut-on domotiser une maison ancienne sans gros travaux ?',
        a: "Oui, grâce aux protocoles sans fil (Zigbee, Z-Wave, Wi-Fi). On remplace les interrupteurs par des modules connectés, on ajoute des capteurs (température, ouverture, mouvement) et on installe une box domotique centrale. L'installation est non invasive et réversible. Comptez 3 000 à 8 000 € pour une maison de 4 pièces avec éclairage, chauffage, volets et sécurité.",
      },
      {
        q: 'La domotique est-elle compatible avec les assistants vocaux ?',
        a: "La plupart des systèmes domotiques sont compatibles avec Google Home, Amazon Alexa et Apple HomeKit. Le contrôle vocal permet de piloter l'éclairage, le chauffage, les volets et les scénarios par la voix. Pour une compatibilité maximale, le nouveau standard Matter (soutenu par Google, Apple, Amazon et Samsung) unifie les protocoles et garantit l'interopérabilité entre marques.",
      },
      {
        q: 'KNX, Zigbee ou Wi-Fi : quel protocole domotique choisir ?',
        a: "Le KNX est un protocole filaire professionnel haut de gamme, extrêmement fiable et pérenne (30 ans+), mais onéreux (2 à 3 fois le prix du sans-fil) et réservé au neuf ou à la rénovation lourde. Le Zigbee est un protocole sans fil fiable à faible consommation, idéal pour les capteurs et interrupteurs (compatible Matter). Le Wi-Fi est le plus simple à mettre en place mais sature le réseau domestique au-delà de 20-30 appareils et consomme davantage d'énergie.",
      },
      {
        q: 'Faut-il un domoticien professionnel pour une maison connectée ?',
        a: "Le DIY est tout à fait possible pour les bases (ampoules connectées, thermostat intelligent, prises connectées) grâce aux kits grand public. En revanche, un domoticien professionnel est nécessaire dès que l'on souhaite une intégration complète multi-protocoles (KNX + Zigbee), la programmation de scénarios avancés, le câblage d'un tableau domotique ou l'interconnexion alarme-caméras-éclairage. Comptez 500 à 1 500 € de main-d'œuvre pour la programmation seule.",
      },
      {
        q: "La domotique augmente-t-elle la valeur d'un bien immobilier ?",
        a: "Oui, selon plusieurs études immobilières, une installation domotique bien intégrée peut augmenter la valeur d'un bien de 3 à 5 %. L'attractivité locative est également renforcée : les locataires sont prêts à payer un loyer supérieur pour un logement connecté (chauffage intelligent, sécurité, confort). L'investissement est d'autant plus rentable si l'installation repose sur des protocoles ouverts et standardisés (KNX, Matter).",
      },
    ],
    emergencyInfo:
    ...
    certifications: [
      'Certification KNX Partner (standard international de la domotique filaire)',
      'Certification Crestron/Control4 (systèmes haut de gamme)',
      'Habilitation électrique (obligatoire)',
      'Qualifelec (mention courants faibles et domotique)',
      'Qualibat 5411 (domotique et gestion technique du bâtiment)',
      'Label Promotelec (installations électriques et domotiques conformes)',
      'Agrément constructeur Somfy (motorisation et domotique volets/stores)',
      'Agrément constructeur Delta Dore (solutions domotiques résidentielles)',
    ],
  ...
  paysagiste: {
    ...
    faq: [
      {
        q: "Combien coûte l'aménagement d'un jardin de 200 m² ?",
        a: 'Pour un jardin de 200 m² avec terrasse, plantations et engazonnement, comptez 8 000 à 20 000 € selon le niveau de finition. Un projet haut de gamme avec piscine peut atteindre 50 000 €+.',
      },
      {
      ...
      {
        q: "Faut-il un permis pour des travaux d'aménagement extérieur ?",
      ...
      {
        q: "Quelles plantes choisir pour un jardin facile d'entretien ?",
      ...
      {
        q: "Comment estimer le budget d'entretien annuel d'un jardin ?",
        a: "Pour un jardin de 200 m², comptez 1 000 à 3 000 €/an en entretien professionnel (tonte bimensuelle, taille des haies 2 fois/an, traitement phytosanitaire, nettoyage). Un contrat annuel d'entretien avec un paysagiste est 20 à 30 % moins cher que des interventions ponctuelles. Le crédit d'impôt « services à la personne » (50 %) s'applique pour l'entretien de jardin chez les particuliers.",
      },
      {
        q: 'Paysagiste ou jardinier : qui contacter ?',
        a: "Le paysagiste intervient pour la conception et la création d'espaces extérieurs (terrasses, massifs, éclairage, arrosage intégré). Le jardinier se charge de l'entretien courant (tonte, taille, désherbage). Certains professionnels cumulent les deux compétences. Pour un projet d'aménagement complet, privilégiez un paysagiste qualifié ; pour un entretien régulier, un jardinier suffit (20 à 40 €/h).",
      },
      {
        q: 'Combien coûte un aménagement de jardin complet ?',
        a: 'Comptez 30 à 80 €/m² pour un jardin simple (engazonnement, quelques plantations, allée). Pour un aménagement haut de gamme incluant terrasse bois ou pierre, plantations structurées et éclairage paysager, le budget monte à 80 à 200 €/m². Un jardin de 300 m² en gamme intermédiaire revient à 15 000 à 30 000 € tout compris.',
      },
      {
        q: 'Faut-il un permis pour aménager son jardin ?',
        a: 'Non, la plupart des aménagements paysagers (plantations, engazonnement, allées) ne nécessitent aucune autorisation. Cependant, une déclaration préalable est obligatoire pour une construction de plus de 5 m² au sol, un mur ou une clôture de plus de 2 m de haut, une piscine de plus de 10 m², ou un abri de jardin dépassant 20 m². Au-delà de 20 m² de surface de plancher, un permis de construire est requis.',
      },
    ],
    emergencyInfo:
    ...
    certifications: [
      'Diplôme ENSP ou DEP Paysage (titre de paysagiste concepteur)',
      "Qualipaysage (certification professionnelle — reconnue par l'État)",
      'Label Écojardin (gestion écologique et durable des espaces verts)',
      'Certiphyto (obligatoire si utilisation de produits phytosanitaires)',
      'Qualibat 1131 (voirie et réseaux divers — terrassement paysager)',
      'BTS Aménagements paysagers (diplôme de référence pour les techniciens)',
      'Assurance décennale (obligatoire pour la maçonnerie paysagère : murets, terrasses, escaliers)',
      "Label Jardins de France (réseau d'excellence des jardins remarquables)",
    ],
  ...
  pisciniste: {
    ...
    certifications: [
      'Qualification FPP (Fédération des Professionnels de la Piscine)',
      'Label Propiscines',
      'Certification NF Piscine',
      'Label QualiPAC (pompe à chaleur piscine)',
      'Certification Qualibat piscine (construction et rénovation)',
      'NF P90-308 (couverture de sécurité piscine)',
      'Assurance décennale obligatoire (structure et étanchéité)',
      'Certification AFNOR NF C15-100 (conformité électrique local technique)',
    ],
  ...
  'alarme-securite': {
    ...
    faq: [
      {
        q: 'Mon assurance baisse-t-elle avec une alarme ?',
        a: "Oui, la plupart des assureurs accordent une réduction de 5 à 15 % sur la prime habitation pour un système d'alarme certifié NF A2P avec télésurveillance. Certains contrats exigent même une alarme pour couvrir les objets de valeur supérieure à un certain montant.",
      },
      {
        q: 'Alarme filaire ou sans fil : que choisir ?',
        a: "L'alarme sans fil est la plus répandue en résidentiel : installation rapide (1 journée), pas de travaux de câblage, et elle se déplace facilement en cas de déménagement. L'alarme filaire est plus fiable (pas de problème de batterie ni d'interférence radio), idéale pour les grandes maisons ou les locaux professionnels, mais nécessite des travaux d'installation plus importants.",
      },
      {
        q: 'Peut-on installer une caméra de vidéosurveillance chez soi sans autorisation ?',
        a: "Chez un particulier, aucune autorisation n'est requise tant que les caméras ne filment que votre propriété privée (jardin, entrée, garage). Il est interdit de filmer la voie publique, le trottoir ou la propriété des voisins. En copropriété, l'installation dans les parties communes nécessite un vote en assemblée générale. Vous devez informer vos visiteurs par un panneau visible.",
      },
      {
        q: "La télésurveillance vaut-elle le coût de l'abonnement ?",
        a: "L'abonnement de télésurveillance (20 à 50 €/mois) inclut la surveillance 24h/24 par un opérateur qui lève le doute en cas d'alerte et prévient les forces de l'ordre si nécessaire. C'est particulièrement utile si vous vous absentez souvent ou si vous avez une résidence secondaire. Sans télésurveillance, l'alarme ne fait que sonner localement, ce qui est peu dissuasif en zone isolée.",
      },
      {
        q: 'Combien de détecteurs faut-il pour protéger une maison ?',
        a: "Pour une maison standard de 100 m² sur un niveau : 1 centrale, 1 détecteur d'ouverture par porte/fenêtre accessible (6 à 10), 2 à 3 détecteurs de mouvement pour les zones de passage intérieures, 1 sirène extérieure et 2 télécommandes. Comptez 500 à 1 500 € pour un kit complet sans fil certifié NF A2P, hors pose professionnelle (200 à 500 €).",
      },
      {
        q: 'Faut-il un abonnement de télésurveillance ?',
        a: "L'abonnement de télésurveillance (20 à 50 €/mois) n'est pas obligatoire mais fortement recommandé. Il permet une intervention rapide en cas d'alerte grâce à un opérateur qui assure la levée de doute vidéo et prévient les forces de l'ordre si nécessaire. Sans abonnement, l'alarme se limite à une sirène locale, peu efficace en zone isolée.",
      },
      {
        q: 'Comment dissuader les cambrioleurs efficacement ?',
        a: "La combinaison de plusieurs dispositifs est la plus dissuasive : une alarme visible avec sirène extérieure, des caméras apparentes aux points d'accès, un éclairage à détection de mouvement autour du domicile et un simulateur de présence (lumières et volets programmés). Les statistiques montrent que 80 % des cambrioleurs renoncent face à une alarme visible.",
      },
      {
        q: 'Les détecteurs de fumée interconnectés sont-ils obligatoires ?',
        a: "Depuis 2015, au moins un détecteur de fumée (DAAF) est obligatoire par logement. L'interconnexion n'est pas imposée par la loi mais est vivement recommandée : lorsqu'un détecteur se déclenche, tous les autres sonnent simultanément, ce qui est crucial dans les grandes maisons à étages. Comptez 20 à 50 € par détecteur interconnecté sans fil, contre 5 à 15 € pour un modèle autonome.",
      },
    ],
    emergencyInfo:
  ...
  antenniste: {
    ...
    faq: [
      {
        q: 'TNT, satellite ou box internet : que choisir ?',
        a: 'La TNT est gratuite et couvre 97 % du territoire mais offre moins de chaînes. Le satellite (Canal+, Fransat) offre plus de chaînes mais nécessite une parabole. La box internet ADSL/fibre propose la TV via le réseau internet avec replay et VOD inclus. En zone blanche (pas de fibre ni de bonne couverture TNT), le satellite reste la meilleure option.',
      },
      {
        q: 'Pourquoi ma réception TNT est-elle mauvaise ?',
        a: 'Les causes les plus fréquentes sont : une antenne mal orientée ou vieillissante, un câble coaxial abîmé ou trop ancien (préférez le câble de type 17 VATC), des interférences 4G/5G (nécessitant un filtre LTE), un amplificateur défaillant ou des prises murales oxydées. Un antenniste peut diagnostiquer le problème en mesurant le signal à chaque point du réseau.',
      },
      {
        q: 'Combien coûte le raccordement fibre optique intérieur ?',
        a: "Le raccordement de la fibre depuis le point de branchement optique (PBO) jusqu'à la prise terminale optique (PTO) est gratuit et réalisé par l'opérateur. En revanche, si vous souhaitez plusieurs prises Ethernet dans différentes pièces ou un câblage encastré, un antenniste facture 100 à 300 € par point de desserte, plus le passage de gaines si nécessaire.",
      },
      {
      ...
      {
        q: 'Mon antenne TNT est-elle compatible avec la nouvelle norme DVB-T2 ?',
        a: "L'antenne elle-même (râteau UHF) est généralement compatible : c'est le décodeur TNT ou le téléviseur qui doit supporter le DVB-T2/HEVC. Les téléviseurs vendus depuis 2020 intègrent généralement cette norme. Si votre téléviseur est plus ancien, un décodeur TNT HD compatible DVB-T2 coûte 30 à 60 €. Vérifiez sur le site recevoirlatnt.fr.",
      },
      {
        q: 'TNT ou satellite : quel choix pour une bonne réception TV ?',
        a: "La TNT est gratuite et ne nécessite aucun abonnement, mais la couverture varie selon votre éloignement de l'émetteur (environ 97 % du territoire). Le satellite (Astra 19.2° pour Fransat ou Canal+) couvre 100 % du territoire français, y compris les zones blanches, mais peut impliquer un abonnement selon le bouquet choisi. En zone bien couverte, la TNT reste le choix le plus économique.",
      },
      {
        q: 'Peut-on installer une antenne parabolique en copropriété ?',
        a: "Oui, la loi du 2 juillet 1966 garantit le « droit à l'antenne » pour tout occupant d'un immeuble collectif. Le syndic ne peut pas s'y opposer si aucune antenne collective ne fournit un service équivalent. Toutefois, le règlement de copropriété peut imposer des contraintes esthétiques : couleur, emplacement discret, fixation non visible depuis la rue. Il est conseillé de notifier le syndic par lettre recommandée avant l'installation.",
      },
      {
        q: 'Comment améliorer la réception TNT dans une zone mal couverte ?',
        a: "Plusieurs solutions existent : installer une antenne directionnelle à gain élevé (type Yagi) orientée précisément vers l'émetteur, ajouter un amplificateur de signal avec filtre 4G/5G, positionner l'antenne le plus haut possible sur le toit, et vérifier l'état du câblage coaxial (remplacer tout câble de plus de 15 ans). Un antenniste peut mesurer le niveau de signal et recommander la meilleure combinaison.",
      },
    ],
    emergencyInfo:
    ...
    certifications: [
      'Titre Professionnel Installateur Antenniste (inscrit au RNCP)',
      'Habilitation électrique (obligatoire)',
      'Habilitation travail en hauteur (obligatoire pour interventions sur toiture)',
      'Formation fibre optique FTTH (raccordement et câblage)',
      'Qualification professionnelle antenniste (Chambre des Métiers)',
      'Certification ACOME (câblage et connectique)',
      "Label Quali'SAT (installateur satellite agréé)",
      'CACES nacelle (interventions en hauteur sur immeubles)',
    ],
  ...
  ascensoriste: {
    ...
    faq: [
      {
        q: 'Quelles aides pour un monte-escalier ?',
        a: "MaPrimeAdapt' (jusqu'à 70 % pour les revenus modestes), TVA réduite à 5,5 %, crédit d'impôt de 25 % (plafonné à 5 000 € pour une personne seule), aides des caisses de retraite et de l'ANAH. Le reste à charge peut être inférieur à 1 000 € pour un ménage modeste.",
      },
      {
        q: 'Peut-on installer un ascenseur dans une maison individuelle ?',
        a: "Oui, il existe des ascenseurs privatifs compacts (cabine de 1 m² environ) qui s'installent dans une trémie de 1,20 × 1,20 m ou à l'extérieur du bâtiment. Le coût varie de 15 000 à 40 000 € selon le nombre d'étages et le type (hydraulique, électrique, pneumatique). Un permis de construire est nécessaire si l'installation modifie la structure ou la façade du bâtiment.",
      },
      {
        q: 'Monte-escalier droit ou tournant : quelle différence de prix ?',
        a: "Un monte-escalier pour escalier droit coûte 3 500 à 5 000 € car le rail est standard. Pour un escalier tournant ou avec palier, le rail est fabriqué sur mesure, ce qui porte le prix à 6 000 à 12 000 €. L'installation prend 2 à 4 heures pour un droit et une journée pour un tournant. Les deux types bénéficient des mêmes aides financières.",
      },
      {
        q: "Quel est le coût de maintenance d'un ascenseur en copropriété ?",
        a: "Le contrat de maintenance annuel coûte 1 500 à 4 000 € selon le type d'ascenseur et le niveau de prestation (normal ou complet). La loi impose un entretien mensuel, un contrôle semestriel de sécurité et un contrôle technique quinquennal par un organisme indépendant (1 000 à 2 000 €). Le budget total annuel pour un ascenseur est de 2 500 à 6 000 €.",
      },
      {
        q: 'Quelles sont les normes de sécurité pour un ascenseur ?',
        a: "Les ascenseurs doivent respecter la directive européenne 2014/33/UE et la norme NF EN 81-20. Les travaux de modernisation obligatoires (loi SAE de 2003) incluent : porte palière verrouillée, dispositif anti-vandalisme, système de télécommunication en cabine, précision d'arrêt et d'horizontalité, et dispositif de protection contre la vitesse excessive.",
      },
      {
        q: 'Combien coûte un ascenseur privatif ?',
        a: "Un ascenseur privatif coûte entre 15 000 et 40 000 € selon le nombre d'étages et la technologie choisie. L'ascenseur hydraulique est le moins cher (15 000 à 25 000 €) mais nécessite un local technique. L'ascenseur électrique à gaines (20 000 à 35 000 €) est plus silencieux et économe en énergie. L'ascenseur pneumatique (25 000 à 40 000 €) ne nécessite ni fosse ni local technique, ce qui réduit considérablement les travaux de gros œuvre. Ajoutez 3 000 à 8 000 € pour les travaux de maçonnerie (trémie, fosse).",
      },
      {
        q: 'Un monte-escalier est-il éligible aux aides financières ?',
        a: "Oui, plusieurs dispositifs existent : MaPrimeRénov' Autonomie (jusqu'à 4 000 € selon les revenus), crédit d'impôt de 25 % plafonné à 5 000 € par personne (10 000 € pour un couple), TVA réduite à 5,5 % si le logement a plus de 2 ans, APA (allocation personnalisée d'autonomie) si perte d'autonomie GIR 1 à 4, aides des caisses de retraite (CARSAT, MSA) et de l'ANAH. Le cumul de ces aides peut réduire le reste à charge à moins de 1 000 € pour un ménage modeste.",
      },
      {
        q: "Quelle est la durée de vie d'un ascenseur ?",
        a: "Un ascenseur bien entretenu dure 25 à 40 ans avant de nécessiter un remplacement complet. Les pièces d'usure (câbles, poulies, contacts de porte) sont remplacées régulièrement dans le cadre du contrat de maintenance. La modernisation de la cabine (5 000 à 15 000 €) peut prolonger la durée de vie de 10 à 15 ans. Le contrat de maintenance est obligatoire pour les ascenseurs en ERP et en copropriété ; il est vivement recommandé pour les ascenseurs privatifs afin de garantir la sécurité et la longévité de l'installation.",
      },
    ],
    emergencyInfo:
    ...
    certifications: [
      'Conformité NF EN 81-20/50 (norme européenne de sécurité des ascenseurs)',
      'Habilitation électrique HBT (obligatoire)',
      'Certification constructeur agréé (Otis, Schindler, Kone, ThyssenKrupp)',
      'Contrôle technique quinquennal obligatoire (organisme agréé)',
      'Certification APAVE ou Bureau Veritas (contrôle technique réglementaire)',
      "Qualibat 5411 (installation et maintenance d'ascenseurs)",
      'Certification ascensoriste agréé (délivrée par les constructeurs)',
      'Assurance décennale obligatoire (couvre les vices de construction pendant 10 ans)',
    ],
  ...
  geometre: {
    ...
    faq: [
      {
        q: 'Quelle est la différence entre bornage et cadastre ?',
        a: "Le bornage fixe les limites réelles de propriété sur le terrain (bornes physiques + procès-verbal). Le cadastre est un document fiscal qui donne les limites indicatives. En cas de contradiction, le bornage prévaut. Le cadastre n'a pas de valeur juridique pour déterminer les limites de propriété.",
      },
      {
        q: 'Mon voisin peut-il refuser un bornage ?',
        a: "Non, le bornage est un droit imprescriptible prévu par l'article 646 du Code civil. Si votre voisin refuse de participer au bornage amiable, vous pouvez saisir le tribunal judiciaire pour demander un bornage judiciaire. Le juge désignera un géomètre-expert et les frais seront partagés entre les deux parties. La procédure dure 6 à 18 mois.",
      },
      {
        q: 'Combien coûte un bornage de terrain ?',
        a: 'Le bornage amiable coûte entre 800 et 2 000 € selon la taille du terrain, le nombre de bornes à poser et la complexité (terrain en pente, accès difficile, nombreux voisins). Le bornage judiciaire est plus cher (2 000 à 5 000 €) en raison des frais de procédure. Les honoraires sont libres mais doivent être annoncés par devis préalable.',
      },
      {
        q: "Qu'est-ce qu'une division parcellaire ?",
        a: 'La division parcellaire consiste à diviser un terrain en deux ou plusieurs lots constructibles. Le géomètre-expert réalise le plan de division, dépose le dossier en mairie et procède au bornage des nouveaux lots. Cette opération est obligatoire pour vendre une partie de son terrain. Le coût est de 1 000 à 3 000 € et le délai de 1 à 3 mois.',
      },
      {
        q: 'Le géomètre-expert est-il nécessaire pour un permis de construire ?',
        a: "Ce n'est pas une obligation légale, mais le plan topographique et le plan de masse (pièces PCMI 2 et PCMI 3) réalisés par un géomètre-expert sont beaucoup plus précis que ceux faits par un non-professionnel. Pour les projets complexes (terrain en pente, limite de propriété proche), le recours au géomètre est vivement recommandé pour éviter un refus de permis.",
      },
      {
        q: 'Quelle est la différence entre un géomètre-expert et un géomètre-topographe ?',
        a: "Le géomètre-expert est inscrit à l'Ordre (OGE), seul habilité à réaliser un bornage ayant valeur juridique. Le géomètre-topographe réalise des relevés techniques mais ne peut pas établir de documents fonciers opposables aux tiers.",
      },
      {
        q: 'Le bornage est-il obligatoire avant de vendre un terrain ?',
        a: "Non obligatoire pour une vente classique, mais fortement recommandé. Il est obligatoire pour la vente d'un lot de lotissement (loi SRU). Le bornage sécurise la transaction et évite les litiges futurs avec les voisins.",
      },
      {
        q: 'Combien coûte un bornage de terrain ?',
        a: "Entre 600 et 2 000 € selon la complexité : nombre de bornes, accessibilité, recherches cadastrales nécessaires. Un bornage contradictoire (avec accord des voisins) est moins cher qu'un bornage judiciaire.",
      },
    ],
    emergencyInfo:
    ...
    certifications: [
      "Inscription à l'Ordre des Géomètres-Experts (obligatoire)",
      'Diplôme DPLG ou ESGT',
      'Assurance RC professionnelle obligatoire',
      "Inscription à l'Ordre des Géomètres-Experts (OGE — obligatoire)",
      'Assurance responsabilité civile professionnelle décennale',
      'Certification DPE (diagnostic de performance foncière)',
      'Habilitation topographie par drone (photogrammétrie)',
      'Certification Qualibat géotechnique (études de sol)',
    ],
  ...
  deratisation: {
    ...
    faq: [
      {
        ...
        a: "Les indices sont : crottes (2 cm pour un rat, 5 mm pour une souris), traces de grignotage sur les câbles/emballages, bruits de grattement la nuit (dans les cloisons, faux-plafonds), odeur musquée caractéristique. Un professionnel peut confirmer l'espèce et évaluer l'ampleur de l'infestation.",
      },
      {
      ...
      {
        q: 'Combien de temps dure une dératisation complète ?',
    ...
    certifications: [
      ...
      'Assurance RC professionnelle (obligatoire)',
      "Déclaration d'activité biocides auprès de l'ANSES",
      'Formation Certibiocide (renouvellement tous les 5 ans)',
      'Conformité au règlement européen sur les produits biocides (RPB 528/2012)',
      "Certification Certibiocide (obligatoire depuis 2015 pour l'usage de produits biocides)",
      'Assurance RC professionnelle spécifique nuisibles',
    ],
    averageResponseTime: 'Intervention sous 24 à 48h',
  },
  ...
  demenageur: {
    ...
    faq: [
      {
        q: 'Quand réserver son déménageur ?',
        a: "Réservez 4 à 6 semaines à l'avance en période creuse (octobre-mars) et 8 à 12 semaines en période haute (juin-septembre). Les premiers et derniers jours du mois sont les plus demandés. Un déménagement en milieu de mois et en semaine est souvent 20 à 30 % moins cher.",
      },
      {
    ...
    certifications: [
      'Immatriculation DREAL (obligatoire)',
      'Label NF Service Déménagement',
      'Certification ISO 9001 (qualité)',
      "Charte Qualité Déménagement (FIDI pour l'international)",
      'Assurance responsabilité civile professionnelle',
      'Agrément IATA (déménagement avec transport aérien)',
      'Label Déménageur Éco-responsable',
