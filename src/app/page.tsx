      ...
      <section className="py-10 bg-white border-t border-sand-200">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <Link href="/problemes" className="inline-block px-4 py-2 text-sm font-medium text-charcoal-700 bg-sand-100 hover:bg-primary-50 hover:text-primary-600 rounded-full transition-colors">Probl&egrave;mes courants</Link>
          </div>
        </div>
      </section>
