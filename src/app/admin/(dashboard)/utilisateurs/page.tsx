    ...
    <div className="min-h-screen bg-sand-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-2xl font-bold text-charcoal-900">Gestion des Utilisateurs</h1>
            <p className="text-charcoal-500 mt-1">{total} utilisateurs au total</p>
          </div>
          <button
        ...
        <div className="bg-white rounded-xl shadow-sm border border-sand-100 overflow-hidden">
          {isLoading ? (
            ...
            <div className="p-8 text-center text-charcoal-500">
              <User className="w-12 h-12 mx-auto mb-4 text-charcoal-300" />
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center justify-end gap-2">
                            <button
                              ...
                              className="p-2 text-charcoal-400 hover:text-primary-600 hover:bg-sand-100 rounded-lg"
      ...
      {banModal.open && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex min-h-screen items-center justify-center p-4">
            ...
            >
              <h3 id="ban-modal-title" className="text-lg font-semibold text-charcoal-900 mb-2">
                Bannir utilisateur
              </h3>
              ...
              <div className="flex gap-3 justify-end">
                <button
                  ...
                  className="px-4 py-2 text-charcoal-700 bg-sand-100 rounded-lg hover:bg-sand-200 transition-colors"
                >
                  Annuler
                </button>
                <button
