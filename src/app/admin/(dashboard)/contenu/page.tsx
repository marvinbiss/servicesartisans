...
const typeBadge = (type: string) => {
  switch (type) {
    case 'static':
      return { label: 'Statique', classes: 'bg-sand-200 text-charcoal-800' }
    case 'blog':
      return { label: 'Blog', classes: 'bg-sand-200 text-charcoal-800' }
    case 'service':
    ...
    case 'faq':
      return { label: 'FAQ', classes: 'bg-sand-200 text-charcoal-800' }
    default:
      return { label: type, classes: 'bg-sand-100 text-charcoal-600' }
  }
}
    ...
    <div className="min-h-screen bg-sand-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-2xl font-bold text-charcoal-900">Gestion du contenu</h1>
            ...
            <button
              ...
              className={`px-4 py-2 text-sm font-medium rounded-lg transition-colors ${
                pageType === pt.value
                  ...
                  : 'bg-white text-charcoal-600 hover:bg-sand-100 border border-sand-200'
              }`}
            >
              {pt.label}
            </button>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <input
                ...
                maxLength={200}
                className="w-full pl-10 pr-4 py-2 border border-sand-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
              />
            </div>
            <select
              value={status}
              ...
              className="px-4 py-2 border border-sand-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 bg-white text-charcoal-700"
            >
        ...
        <div className="bg-white rounded-xl shadow-sm border border-sand-100 overflow-hidden">
          {isLoading ? (
            ...
            <div className="p-8 text-center text-charcoal-500">
              <FileEdit className="w-12 h-12 mx-auto mb-4 text-charcoal-300" />
                    ...
                    {pages.map((page) => {
                      ...
                      return (
                        <tr
                          ...
                          tabIndex={0}
                          role="link"
                          className="cursor-pointer hover:bg-sand-50 focus:bg-sand-100 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-inset transition-colors"
                        >
                          <td className="px-6 py-4">
                            <div>
                              ...
                              <p className="text-sm text-charcoal-500">/{page.slug}</p>
                            </div>
                          </td>
                          <td className="px-6 py-4">
                            <span
                ...
                <div className="flex items-center justify-between px-6 py-4 border-t border-sand-200">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="flex items-center gap-1 px-3 py-1.5 text-sm border border-sand-300 rounded-lg hover:bg-sand-50 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
