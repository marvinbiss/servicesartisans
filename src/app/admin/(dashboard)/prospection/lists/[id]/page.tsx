  ...
  return (
    <div>
      ...
      <ConfirmationModal
        ...
        onConfirm={() => {
          setRemoveMemberModal({ open: false, contactId: '', contactName: '' })
          handleRemoveMember(removeMemberModal.contactId)
        }}
