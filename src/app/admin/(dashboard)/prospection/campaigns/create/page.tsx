...
export default function CreateCampaignPage() {
  ...
  useEffect(() => {
    fetch('/api/admin/prospection/templates').then(r => r.json()).then(d => d.success && setTemplates(d.data))
    fetch('/api/admin/prospection/lists').then(r => r.json()).then(d => d.success && setLists(d.data))
  }, [])
