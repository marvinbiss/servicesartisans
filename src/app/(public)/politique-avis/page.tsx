...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Politique de gestion des avis',
    description:
      'Qui peut publier un avis, processus de modération, droit de réponse des artisans et calcul des notes.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'ServicesArtisans — Politique avis',
      },
    ],
  },
  twitter: {
...
const sections = [
  ...
  },
  {
    ...
    content: [
      ...
      <>
        Un artisan ou un utilisateur peut demander la suppression d&apos;un avis en nous contactant
    ...
    <div className="min-h-screen bg-sand-50">
            ...
            return (
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h2 className="text-2xl font-bold text-charcoal-900">{section.title}</h2>
                </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl font-bold text-charcoal-900 mb-4">Signaler un avis</h2>
          <p className="text-charcoal-600 mb-6 max-w-2xl mx-auto">
            Si vous estimez qu'un avis ne respecte pas nos conditions d'utilisation, vous pouvez le
            signaler par email à{' '}
            <a
              href={`mailto:${companyIdentity.email}`}
