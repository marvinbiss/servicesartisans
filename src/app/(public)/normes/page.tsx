...
const categories = [
  ...
  },
  {
    title: 'Toiture',
    icon: Building2,
    color: 'bg-sand-200 text-charcoal-700',
    normes: [
      {
            ...
            <div className="prose prose-lg max-w-none text-charcoal-700">
              ...
              <ul className="space-y-2 mt-4">
                <li className="flex items-start gap-3">
                  <FileCheck className="w-5 h-5 text-primary-500 mt-0.5 shrink-0" />
                  <span>
                    <strong>DTU (Documents Techniques Unifiés)</strong> — règles de l{"'"}art pour
                    chaque corps de métier. Ils définissent les matériaux, les mises en œuvre et les
                    contrôles. Contractuellement opposables (si cités dans le marché de travaux).
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <FileCheck className="w-5 h-5 text-primary-500 mt-0.5 shrink-0" />
                  <span>
                    <strong>Normes NF</strong> — normes françaises homologuées par l{"'"}AFNOR.
                    Elles définissent les caractéristiques des produits et des installations (NF C
                    15-100 pour l{"'"}électricité, NF P pour la construction).
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <FileCheck className="w-5 h-5 text-primary-500 mt-0.5 shrink-0" />
                  <span>
                    <strong>Réglementations</strong> — textes à valeur légale (lois, décrets,
                    arrêtés). La RE2020, les règles parasismiques et l{"'"}accessibilité PMR sont
                    des obligations réglementaires, pas de simples recommandations.
                  </span>
                </li>
              </ul>
            </div>
                  ...
                  >
                    <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                      <div className="flex-1">
                        <h3 className="text-lg font-bold text-charcoal-900 mb-1">{norme.name}</h3>
                        <p className="text-sm text-primary-500 font-medium mb-3">{norme.scope}</p>
                        <p className="text-charcoal-600 mb-4">{norme.requirements}</p>
                        <div className="flex flex-wrap gap-3">
                          {norme.link && (
                            <Link
                              href={norme.link}
                              className="inline-flex items-center gap-1 text-sm font-medium text-primary-500 hover:text-primary-800 transition-colors"
                            >
                              <BookOpen className="w-4 h-4" />
                              {norme.linkLabel}
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Guide détaillé de la norme électrique avec les obligations par pièce.'}
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Les travaux non conformes aux normes peuvent affecter la décennale.'}
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'DTU couverture et isolation appliqués à votre projet.'}
              </p>
            </Link>
          </div>
        </section>
