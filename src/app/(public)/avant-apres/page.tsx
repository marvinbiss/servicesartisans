...
const transformations = [
  {
    ...
    avant:
      'Salle de bain de 5 m² vieillissante avec baignoire en fonte, faïence jaunie des années 80, robinetterie qui fuit et joints de silicone noircis. Sol en carrelage fissuré.',
    apres:
      "Douche à l'italienne avec paroi vitrée, carrelage grand format gris clair, meuble vasque suspendu, sèche-serviettes chromé, éclairage LED encastré et VMC hygroréglable.",
    budget: '8 000 – 15 000 €',
    duree: '2 – 3 semaines',
  ...
  },
  {
    ...
    avant:
      'Cuisine fermée de 10 m² séparée du salon par un mur porteur. Espace sombre, meubles des années 90, plan de travail en stratifié abîmé, électroménager vétuste.',
    apres:
      'Cuisine ouverte avec îlot central en quartz, mur porteur remplacé par une poutre IPN, façades blanc mat sans poignée, électroménager encastré, crédence carreaux de ciment.',
  ...
  },
  {
    ...
    avant:
      'Façade crépi des années 70 fissurée, aucune isolation (murs en parpaing de 20 cm). DPE classé E, facture chauffage 2 400 €/an, sensation de paroi froide en hiver.',
    apres:
      'ITE en polystyrène expansé (14 cm, R = 3,7), enduit gratté ton pierre. DPE amélioré à B, facture chauffage réduite à 900 €/an, confort thermique été comme hiver.',
  ...
  },
  {
    ...
    avant:
      'Toiture en tuiles mécaniques de 40 ans, plusieurs tuiles cassées, mousse abondante, gouttières PVC percées. Fuites visibles dans les combles après chaque orage.',
    apres:
      'Couverture neuve en tuiles terre cuite, écran sous-toiture HPV, liteaux et contre-liteaux neufs, gouttières zinc, faîtage scellé. Charpente traitée et renforcée.',
    budget: '15 000 – 30 000 €',
    duree: '2 – 4 semaines',
  ...
  },
  {
    ...
    avant:
      'Salon de 25 m² avec papier peint fleuri des années 80, peinture écaillée au plafond, murs tachés et jaunis par la nicotine. Plinthes en bois verni abîmées.',
    apres:
      "Murs en peinture mate blanc cassé, mur d'accent en vert sauge, plafond blanc satiné, plinthes poncées et repeintes en blanc, finition soignée.",
    budget: '2 000 – 4 000 €',
    duree: '3 – 5 jours',
    artisans: ['Peintre'],
  ...
  },
  {
    ...
    avant:
      "Moquette grise élimée dans tout l'étage (50 m²), tachée et allergène. En dessous, un plancher en chêne massif d'origine en bon état mais gris et abîmé en surface.",
    apres:
      "Parquet chêne massif mis à nu, poncé en 3 passes (36, 60, 100), teinté chêne naturel et vitrifié mat. Plinthes assorties. Sol chaleureux et facile d'entretien.",
    budget: '3 000 – 6 000 €',
    duree: '4 – 7 jours',
  ...
  },
  {
    ...
    avant:
      "Maison de 80 m² devenue trop petite pour la famille. Terrain de 400 m² avec possibilité d'extension latérale. Besoin d'un bureau et d'une chambre supplémentaire.",
    apres:
      'Extension ossature bois de 15 m² avec bardage douglas, baie vitrée coulissante, isolation biosourcée (fibre de bois), plancher chauffant et raccordement au réseau existant.',
  ...
  },
  {
    ...
    avant:
      'Tableau électrique des années 1970 avec fusibles à broche, pas de différentiel 30 mA, fils en tissu, prises sans terre, aucune protection des circuits. Installation dangereuse.',
    apres:
      'Tableau neuf NF C 15-100 avec disjoncteurs divisionnaires et interrupteurs différentiels 30 mA type A et AC, câblage en gaine ICTA, prises avec terre, circuits spécialisés cuisine et salle de bain.',
    budget: '5 000 – 10 000 €',
    duree: '1 – 2 semaines',
  ...
  },
  {
    ...
    avant:
      "Terrain vague de 200 m² en friche : herbes hautes, terre nue par endroits, clôture grillagée rouillée, aucun aménagement extérieur. Inutilisable en l'état.",
    apres:
  ...
  },
  {
    ...
    avant:
      "Salle de bain standard avec baignoire haute (60 cm de rebord), porte de 63 cm, absence de barres d'appui. Inaccessible pour une personne à mobilité réduite.",
    apres:
      'Douche de plain-pied avec siège rabattable et barre de maintien, porte élargie à 90 cm, lavabo à hauteur réglable, sol antidérapant, WC rehaussé. Conforme PMR.',
  ...
  },
  {
    ...
    avant:
      "10 fenêtres en bois simple vitrage des années 60, peinture écaillée, bois pourri par endroits, courants d'air permanents. Uw > 5 W/m².K, facture chauffage excessive.",
    apres:
      '10 fenêtres PVC double vitrage 4/16/4 argon (Uw = 1,3), oscillo-battantes, volets roulants motorisés. Réduction du bruit de 50 % et de la facture chauffage de 25 %.',
    budget: '8 000 – 15 000 €',
    duree: '2 – 3 jours',
  ...
  },
  {
    ...
    avant:
      'Grenier de 35 m² sous charpente fermette, non isolé, servant de débarras. Hauteur sous faîtage de 3,50 m. Accès par une trappe avec échelle escamotable.',
    apres:
      'Chambre parentale (18 m²) + salle de bain (8 m²) sous rampants. Charpente modifiée (fermette en W remplacée par charpente traditionnelle), 2 velux, parquet, isolation fibre de bois 24 cm.',
              ...
              >
                <div className="p-6 md:p-8">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-xl md:text-2xl font-bold text-charcoal-900 font-heading">
                      {t.title}
                    </h2>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div className="bg-red-50 rounded-xl p-5 border border-red-100">
                      <div className="flex items-center gap-2 mb-3">
                        <span className="bg-red-200 text-red-800 text-xs font-bold px-2.5 py-1 rounded-full uppercase tracking-wide">
                          Avant
                        </span>
                      </div>
                      <p className="text-charcoal-700">{t.avant}</p>
                    </div>

                    {/* Après */}
                    <div className="bg-green-50 rounded-xl p-5 border border-green-100">
                      <div className="flex items-center gap-2 mb-3">
                        <span className="bg-green-200 text-green-800 text-xs font-bold px-2.5 py-1 rounded-full uppercase tracking-wide">
                          Après
                        </span>
                      </div>
                      <p className="text-charcoal-700">{t.apres}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {t.artisans.map((artisan, i) => (
                      <Link
                        ...
                        className="inline-flex items-center gap-1 text-sm font-medium text-primary-500 hover:text-primary-800 bg-primary-50 px-3 py-1.5 rounded-lg hover:bg-primary-100 transition-colors"
                      >
                        {artisan}
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Comment demander, comparer et négocier vos devis.'}
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Toutes les aides pour financer vos rénovations.'}
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">{'Protégez vos travaux pendant 10 ans.'}</p>
            </Link>
          </div>
        </section>
