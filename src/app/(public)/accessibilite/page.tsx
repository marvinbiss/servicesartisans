    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'ServicesArtisans — Accessibilité',
      },
    ],
  },
  twitter: {
    ...
    <div className="min-h-screen bg-sand-50">
      ...
      <section className="relative bg-charcoal-950 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-28 md:pt-14 md:pb-36">
          ...
          <p className="text-xl text-charcoal-400 max-w-3xl">
            ServicesArtisans s'engage à rendre son site web accessible à tous, conformément au
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-xl shadow-sm p-8 space-y-8">
          ...
          {/* Nos engagements */}
          <section>
            <h2 className="text-2xl font-bold text-charcoal-900 mb-4">Nos engagements</h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-charcoal-900 mb-1">Déficiences visuelles</h3>
                  <p className="text-charcoal-600 text-sm">
                    Compatibilité avec les lecteurs d'écran, contrastes suffisants, textes
                    alternatifs pour les images.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-primary-100 rounded-full flex items-center justify-center flex-shrink-0">
                  <Ear className="w-6 h-6 text-primary-500" />
                </div>
                <div>
                  <h3 className="font-semibold text-charcoal-900 mb-1">Déficiences auditives</h3>
                  <p className="text-charcoal-600 text-sm">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-charcoal-900 mb-1">Déficiences motrices</h3>
                  <p className="text-charcoal-600 text-sm">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-charcoal-900 mb-1">Déficiences cognitives</h3>
                  <p className="text-charcoal-600 text-sm">
          ...
          <section>
            <h2 className="text-2xl font-bold text-charcoal-900 mb-4">Contenus non accessibles</h2>
            <p className="text-charcoal-600 mb-4">
            ...
            <ul className="list-disc list-inside text-charcoal-600 space-y-2">
              ...
              <li>
                Quelques formulaires complexes nécessitent des améliorations pour les lecteurs
                d'écran
              </li>
          ...
          <section>
            <h2 className="text-2xl font-bold text-charcoal-900 mb-4">Technologies utilisées</h2>
            <p className="text-charcoal-600 mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold text-charcoal-900 mb-4">Environnement de test</h2>
            <p className="text-charcoal-600 mb-4">
          ...
          <section>
            ...
            <p className="text-charcoal-600 mb-4">
              ...
              une fonctionnalité du site, vous pouvez nous contacter :
            </p>
          ...
          {/* Voies de recours */}
          <section>
            <h2 className="text-2xl font-bold text-charcoal-900 mb-4">Voies de recours</h2>
            <p className="text-charcoal-600 mb-4">
              Si vous constatez un défaut d'accessibilité qui vous empêche d'accéder à un contenu ou
              une fonctionnalité et que vous nous l'avez signalé sans obtenir de réponse
              satisfaisante, vous êtes en droit de :
            </p>
            <ul className="list-disc list-inside text-charcoal-600 space-y-2">
              <li>Écrire au Défenseur des droits</li>
              <li>Contacter le délégué du Défenseur des droits dans votre région</li>
              <li>
                Envoyer un courrier par voie postale (gratuit, ne pas mettre de timbre) : Défenseur
