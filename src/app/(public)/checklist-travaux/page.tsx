...
const sections: ChecklistSection[] = [
  {
    ...
    description: 'Budget, planning et autorisations : les fondations de votre projet.',
    icon: Wallet,
  ...
  },
  {
    ...
    description: 'Protection, accès et voisinage : anticiper pour éviter les mauvaises surprises.',
    icon: Sofa,
  ...
  },
  {
    ...
    description: 'Suivi, points de contrôle et communication : rester maître de votre chantier.',
    icon: Eye,
  ...
  },
  {
    ...
    description: 'Procès-verbal, réserves et garanties : le moment le plus important du chantier.',
    icon: CheckCircle2,
      ...
      <div className="min-h-screen bg-sand-50">
        ...
        <div className="bg-white border-b">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <Breadcrumb items={[{ label: 'Checklist travaux' }]} />
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <section key={section.id} id={section.id} className="scroll-mt-20">
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-charcoal-600 mt-1">{section.description}</p>
                    </div>
                  </div>

                  <div className="bg-white rounded-xl border border-sand-300 divide-y divide-sand-200">
                    {section.items.map((item, index) => (
                      <div key={index} className="px-5 py-4 hover:bg-sand-50 transition-colors">
                        <div className="flex items-start gap-3">
                          <div className="mt-0.5 shrink-0">
                            <div className="w-5 h-5 rounded border-2 border-sand-400 flex items-center justify-center">
                              <span className="sr-only">Point de contrôle</span>
                            </div>
                          </div>
                          <div>
                            <p className="font-medium text-charcoal-900">{item.text}</p>
                            {item.detail && (
                              <p className="text-sm text-charcoal-500 mt-1">{item.detail}</p>
                            )}
                          </div>
                        </div>
                      </div>
          ...
          <div className="mt-16 bg-amber-50 border border-amber-200 rounded-2xl p-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-xl font-bold text-charcoal-900 mb-4 font-heading">
                ...
                <ul className="space-y-3 text-charcoal-700">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>Ne pas prévoir de marge budgétaire</strong> : 80 % des chantiers
                      dépassent le budget initial. Prévoyez 10 à 15 % de marge.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-amber-600 font-bold shrink-0">2.</span>
                    <span>
                      <strong>Choisir le devis le moins cher</strong> : le prix le plus bas cache
                      souvent des matériaux de moindre qualité ou des prestations non incluses.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-amber-600 font-bold shrink-0">3.</span>
                    <span>
                      <strong>Ne pas vérifier l'assurance décennale</strong> : sans attestation
                      valide, vous n'avez aucun recours en cas de malfaçon structurelle.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-amber-600 font-bold shrink-0">4.</span>
                    <span>
                      <strong>Payer avant la réception</strong> : ne réglez jamais le solde avant
                      d'avoir effectué une réception formelle avec PV signé.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-amber-600 font-bold shrink-0">5.</span>
                    <span>
                      <strong>Valider des modifications à l'oral</strong> : toute modification doit
                      faire l'objet d'un avenant écrit et signé. Les accords verbaux n'ont aucune
                      valeur juridique.
                    </span>
                  </li>
                </ul>
          ...
          <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              <p className="text-sm text-charcoal-600">
                30 comparatifs détaillés pour choisir les bons matériaux et équipements.
              </p>
            </Link>
            <Link
              href="/devis"
            ...
            >
              ...
              <p className="text-sm text-charcoal-600">
                Parcourez nos 47 catégories de services pour trouver l'artisan qu'il vous faut.
              </p>
            </Link>
          </div>
