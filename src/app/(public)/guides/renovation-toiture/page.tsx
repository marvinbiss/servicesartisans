...
const signesUsure = [
  {
    ...
    icon: AlertTriangle,
    description:
      'Des tuiles fissurées, décalées ou manquantes exposent la charpente aux infiltrations. Même quelques tuiles endommagées peuvent causer des dégâts importants si elles ne sont pas remplacées rapidement.',
  },
  {
    name: "Infiltrations et taches d'humidité",
    icon: Droplets,
    description:
      "Des taches brunes au plafond des combles ou des murs périphériques signalent une fuite de toiture. L'humidité prolongée dégrade l'isolant et la charpente (risque de mérule et d'insectes xylophages).",
  },
  {
    name: 'Mousse et lichens abondants',
    icon: Home,
    description:
      "Une couche épaisse de mousse retient l'eau et accélère la dégradation des tuiles. Un démoussage suivi d'un traitement hydrofuge peut prolonger la durée de vie de la couverture de 5 à 10 ans.",
  },
  {
    name: 'Charpente qui fléchit',
    icon: Building2,
    description:
      'Une ligne de faîtage qui ondule ou des pannes qui ploient indiquent un problème structurel. Faites intervenir un charpentier pour évaluer si un renfort ou un remplacement partiel est nécessaire.',
  },
]
...
const typesCouverture = [
  {
    ...
    dureeVie: '50 – 100 ans',
    avantages:
      'Esthétique traditionnelle, très bonne durabilité, large choix de formes et couleurs',
  ...
  },
  {
    ...
    dureeVie: '30 – 50 ans',
    avantages:
      'Économique, léger, pose rapide, idéal pour grandes surfaces et toitures faible pente',
...
const breadcrumbItems = [{ label: 'Guides', href: '/guides' }, { label: 'Rénovation de toiture' }]
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-primary-50/60 to-white">
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="text-lg font-bold text-charcoal-900">{s.name}</h3>
                  </div>
                  <p className="text-charcoal-600">{s.description}</p>
                </div>
              )
            })}
          </div>
              ...
              <ol className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1">
                      {
                        "Un couvreur inspecte la toiture : état de la couverture, de la charpente, de l'isolation et des éléments d'étanchéité (faîtage, noues, solins). Il établit un devis détaillé. Demandez au moins 3 devis."
                      }
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1">
                      {
                        "Remplacement à l'identique : aucune formalité. Changement de matériau ou de couleur : déclaration préalable de travaux en mairie. En secteur classé : accord de l'ABF."
                      }
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1">
                      {
                        "Mise en place de l'échafaudage périmétrique et des protections (bâches, filets). Si l'échafaudage empiète sur la voie publique, une autorisation d'occupation est nécessaire en mairie."
                      }
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1">
                      {
                        "Dépose de l'ancienne couverture, inspection de la charpente, remplacement des pièces abîmées (pannes, chevrons, liteaux). Traitement fongicide et insecticide de l'ensemble."
                      }
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1">
                      {
                        "Pose de l'écran sous-toiture (HPV recommandé), installation de l'isolation (sarking ou sous rampants) si prévue au devis. L'écran sous-toiture protège la charpente en cas d'entrée d'eau sous les tuiles."
                      }
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1">
                      {
                        'Pose des liteaux, puis de la couverture (tuiles, ardoises, zinc). Réalisation des points singuliers : faîtage, arêtiers, noues, solins de cheminée. Installation ou remplacement des gouttières.'
                      }
                    </p>
                  </div>
                </li>
        ...
        <section className="max-w-5xl mx-auto px-4 py-10">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl shadow-sm border border-sand-200 p-6">
              <h3 className="text-lg font-bold text-charcoal-900 mb-2">Charpente traditionnelle</h3>
              <p className="text-sm font-medium text-primary-500 mb-3">70 – 130 €/m²</p>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-sand-200 p-6">
              <h3 className="text-lg font-bold text-charcoal-900 mb-2">Charpente fermette</h3>
              <p className="text-sm font-medium text-primary-500 mb-3">50 – 80 €/m²</p>
              <p className="text-charcoal-600 mb-3">
                {
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white/10 rounded-xl p-5">
                ...
                <p className="text-green-50 text-sm">
                  {
                    "Jusqu'à 75 €/m² pour l'isolation des rampants de toiture, selon vos revenus. Cumulable avec les CEE."
                  }
                </p>
              </div>
              <div className="bg-white/10 rounded-xl p-5">
                ...
                <p className="text-green-50 text-sm">
                  {
                    "Prime énergie versée par les fournisseurs d'énergie. Montant variable selon la surface et la zone climatique (10 à 20 €/m²)."
                  }
                </p>
              </div>
              <div className="bg-white/10 rounded-xl p-5">
                ...
                <p className="text-green-50 text-sm">
                  {
                    "Prêt à taux zéro jusqu'à 50 000 € pour un bouquet de travaux de rénovation énergétique, remboursable sur 20 ans."
                  }
                </p>
              </div>
              <div className="bg-white/10 rounded-xl p-5">
                ...
                <p className="text-green-50 text-sm">
                  {
                    "TVA réduite à 5,5 % sur les travaux d'isolation (au lieu de 10 % pour les autres travaux de rénovation)."
                  }
                </p>
              </div>
            </div>
            ...
            <div className="prose prose-lg max-w-none text-charcoal-700">
              ...
              <ul className="space-y-2 mt-4">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong>Gouttière PVC</strong> — 10 à 25 €/ml, durée de vie 15-25 ans, facile à
                    poser, coloris limités
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-primary-500 mt-0.5 shrink-0" />
                  <span>
                    <strong>Gouttière zinc</strong> — 25 à 50 €/ml, durée de vie 30-50 ans,
                    esthétique, soudure nécessaire
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-primary-500 mt-0.5 shrink-0" />
                  <span>
                    <strong>Gouttière aluminium</strong> — 20 à 40 €/ml, durée de vie 25-40 ans,
                    légère, sans entretien
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-primary-500 mt-0.5 shrink-0" />
                  <span>
                    <strong>Gouttière cuivre</strong> — 50 à 100 €/ml, durée de vie 50+ ans, haut de
                    gamme, patine naturelle
                  </span>
                </li>
              </ul>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Toutes les aides pour financer votre isolation de toiture.'}
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Vérifiez la décennale de votre couvreur avant travaux.'}
              </p>
            </Link>
            <Link
        ...
        <RgeGuideBlock
          ...
          title="Couvreurs RGE près de chez vous"
        />
