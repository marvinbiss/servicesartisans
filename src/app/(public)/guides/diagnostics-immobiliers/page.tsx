...
const breadcrumbItems = [{ label: 'Guides', href: '/guides' }, { label: 'Diagnostics immobiliers' }]
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left">
                <thead className="bg-sand-50 border-b border-sand-200">
                  <tr>
                    <th className="px-4 py-3 text-sm font-semibold text-charcoal-900">
                      Diagnostic
                    </th>
                    <th className="px-4 py-3 text-sm font-semibold text-charcoal-900">
                      Obligatoire
                    </th>
                    <th className="px-4 py-3 text-sm font-semibold text-charcoal-900">Validité</th>
                    <th className="px-4 py-3 text-sm font-semibold text-charcoal-900">
                      Prix moyen
                    </th>
                  </tr>
                ...
                <tbody className="divide-y divide-sand-200">
                  {diagnostics.map((d) => (
                    <tr key={d.name}>
                      <td className="px-4 py-3 font-medium text-charcoal-900 text-sm">{d.name}</td>
                      <td className="px-4 py-3 text-charcoal-600 text-sm">{d.obligatoire}</td>
                      <td className="px-4 py-3 text-charcoal-600 text-sm">{d.validite}</td>
                      <td className="px-4 py-3 text-charcoal-600 text-sm">{d.prix}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-lg font-bold text-charcoal-900 mb-1">{d.name}</h3>
                      ...
                      <p className="text-charcoal-600">{d.description}</p>
                    </div>
                  </div>
                </div>
              )
              ...
              <div>
                ...
                <ul className="space-y-3 text-primary-50">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      {"Avant la publication de l'annonce (le DPE doit figurer sur l'annonce)"}
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 mt-0.5 shrink-0" />
              ...
              <div>
                ...
                <ul className="space-y-3 text-primary-50">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      {'Diagnostic amiante avant travaux (DAT) obligatoire si permis avant 07/1997'}
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <AlertTriangle className="w-5 h-5 mt-0.5 shrink-0" />
            ...
            <div className="prose prose-lg max-w-none text-charcoal-700">
              ...
              <ul className="space-y-2 mt-4">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong>Certification COFRAC</strong> — chaque diagnostic requiert une
                    certification spécifique, renouvelée tous les 7 ans
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-primary-500 mt-0.5 shrink-0" />
                  <span>
                    <strong>Assurance RC professionnelle</strong> — le diagnostiqueur doit être
                    assuré pour sa responsabilité civile
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-primary-500 mt-0.5 shrink-0" />
                  <span>
                    <strong>Indépendance</strong> — le diagnostiqueur ne doit avoir aucun lien avec
                    le vendeur, l{"'"}agent immobilier ou l{"'"}artisan qui réalisera les travaux
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-primary-500 mt-0.5 shrink-0" />
                  <span>
                    <strong>Vérification</strong> — consultez l{"'"}annuaire officiel des
                    diagnostiqueurs certifiés sur le site du ministère de la Transition écologique
                  </span>
                </li>
              </ul>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Toutes les aides pour financer vos travaux de mise aux normes.'}
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Guide complet de la norme électrique pour la mise aux normes.'}
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Comment comparer les devis des diagnostiqueurs.'}
              </p>
            </Link>
          </div>
        </section>
