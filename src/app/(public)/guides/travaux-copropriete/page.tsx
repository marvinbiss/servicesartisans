...
const majorites = [
  {
    ...
    exemples:
      "Ravalement simple, réfection de la peinture des couloirs, remplacement de la porte d'entrée à l'identique",
  },
  {
    ...
    exemples:
      "Installation d'un ascenseur, digicode, vidéosurveillance, ravalement avec changement de couleur",
  },
  {
    ...
    exemples:
      "Changement de destination d'un local, suppression d'un service collectif, modification du règlement",
  },
]
...
const breadcrumbItems = [{ label: 'Guides', href: '/guides' }, { label: 'Travaux en copropriété' }]
            ...
            {majorites.map((m) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-charcoal-600 mb-3">{m.description}</p>
                  <div className="text-sm text-charcoal-500">
                    <span className="font-medium text-charcoal-700">Exemples :</span> {m.exemples}
                  </div>
                </div>
              )
            })}
        ...
        <section className="max-w-5xl mx-auto px-4 py-10">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl shadow-sm border border-sand-200 p-6">
              ...
              <h3 className="text-lg font-bold text-charcoal-900 mb-2">DPE collectif et PPT</h3>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-sand-200 p-6">
              ...
              <h3 className="text-lg font-bold text-charcoal-900 mb-2">Ravalement de façade</h3>
              <p className="text-charcoal-600">
                {
            ...
            {services.map((s) => {
              ...
              return (
                <Link
                  key={s.href}
                  href={s.href}
                  className="flex items-center gap-3 bg-white rounded-xl shadow-sm border border-sand-200 p-5 hover:border-purple-300 hover:shadow-md transition-all group"
                >
                  <div className="w-10 h-10 bg-purple-50 rounded-lg flex items-center justify-center group-hover:bg-purple-100 transition-colors">
                    <Icon className="w-5 h-5 text-purple-600" />
                  </div>
                  <span className="font-semibold text-charcoal-900 group-hover:text-purple-700 transition-colors">
                    {s.label}
                  </span>
                  <ArrowRight className="w-4 h-4 text-charcoal-400 ml-auto group-hover:text-purple-600 transition-colors" />
                </Link>
              )
            })}
          </div>
        ...
        <section className="max-w-5xl mx-auto px-4 py-10">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <Link
              ...
              className="group bg-white rounded-xl border border-sand-200 p-5 hover:shadow-md hover:border-purple-200 transition-all"
            >
              <h3 className="font-semibold text-charcoal-900 group-hover:text-purple-600 transition-colors mb-1">
                {'Devis travaux'}
              </h3>
              <p className="text-sm text-charcoal-500">
                {'Comparez les devis pour les travaux de copropriété.'}
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Protection essentielle pour les gros travaux.'}
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Quand un permis est nécessaire en copropriété.'}
              </p>
            </Link>
          </div>
        </section>
        ...
        <section className="max-w-5xl mx-auto px-4 py-10">
          ...
          <div className="space-y-4">
            {faqItems.map((item, index) => (
              ...
              >
                <summary className="flex items-center justify-between p-6 cursor-pointer list-none font-semibold text-charcoal-900 hover:text-purple-700 transition-colors">
                  {item.question}
