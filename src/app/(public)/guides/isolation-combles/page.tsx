...
const comparaisonCombles = [
  ...
  },
  {
    ...
    avantages:
      'Conserve l’espace habitable, plusieurs techniques possibles, confort été comme hiver',
    inconvenients:
      'Plus coûteux, travaux plus longs, légère perte de volume (isolation intérieure)',
  },
]
...
const techniques = [
  {
    ...
    avantages:
      'Le plus économique, couvre parfaitement les recoins, supprime les ponts thermiques, éligible à toutes les aides',
  ...
  },
  {
    ...
    avantages:
      'Accès aux combles conservé (avec rehausse), pose en double couche croisée pour supprimer les ponts thermiques',
  ...
  },
  {
    ...
    avantages:
      'Conserve la couverture en place, bonne performance, coût modéré pour des combles aménagés',
  ...
  },
  {
    ...
    avantages:
      'Supprime tous les ponts thermiques, aucune perte de volume intérieur, idéal lors d’une réfection de toiture',
...
const materiaux = [
  {
    ...
    avantages:
      'Très économique, légère, incombustible (classe A1), excellent rapport performance/prix',
    inconvenients:
      'Irritante à la pose, tassement possible à long terme (5-10 %), sensible à l’humidité',
  },
  {
    ...
    avantages:
      'Écologique (papier recyclé), excellent déphasage thermique (été), bon isolant acoustique, légèrement meilleur lambda',
    inconvenients:
      'Traitement au sel de bore nécessaire (ignifuge), tassement possible (jusqu’à 20 % si mal posée)',
  },
  {
    name: 'Laine de roche',
    icon: Shield,
    ...
    avantages:
      'Excellente résistance au feu (classe A1), très bon isolant acoustique, imputrescible, ne craint pas l’humidité',
    inconvenients:
      'Plus lourde que la laine de verre, irritante à la pose, bilan carbone plus élevé',
  },
  {
    name: 'Fibre de bois',
    icon: Leaf,
    ...
    avantages:
      'Écologique (bois résineux), meilleur déphasage thermique du marché (confort d’été supérieur), régulation hygrothermique naturelle',
    inconvenients:
      'Prix élevé, plus lourde (nécessite structure adaptée), sensible aux insectes si non traitée',
  },
]
...
const breadcrumbItems = [{ label: 'Guides', href: '/guides' }, { label: 'Isolation des combles' }]
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-primary-50/60 to-white">
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="text-lg font-bold text-charcoal-900">{c.type}</h3>
                  </div>
                  <p className="text-charcoal-600 mb-3">{c.description}</p>
                  <div className="bg-primary-50 rounded-lg p-3 mb-3">
                    <p className="text-sm font-semibold text-primary-800 mb-1">Quand choisir ?</p>
                    <p className="text-sm text-primary-600">{c.quandChoisir}</p>
                  </div>
                  ...
                  <div className="space-y-2">
                    <div>
                      ...
                      <p className="text-sm text-charcoal-600">{c.avantages}</p>
                    </div>
                    <div>
                      <p className="text-sm font-semibold text-amber-700 mb-1">Inconvénients</p>
                      <p className="text-sm text-charcoal-600">{c.inconvenients}</p>
                    </div>
                  </div>
                </div>
              )
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {techniques.map((t) => (
              ...
              >
                ...
                <p className="text-sm text-charcoal-600 mb-2">{t.avantages}</p>
                <p className="text-sm font-medium text-primary-500">Idéal pour : {t.ideal}</p>
              </div>
            ))}
          </div>
        </section>
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-charcoal-500">λ = {m.lambda}</p>
                    </div>
                  </div>
                  <div className="flex flex-wrap gap-3 text-sm mb-3">
                    <span className="inline-flex items-center gap-1 text-primary-600 bg-primary-50 px-2 py-0.5 rounded">
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-sand-50 border-b border-sand-300">
                    ...
                    <th className="text-center p-4 font-semibold text-charcoal-900">50 m²</th>
                    <th className="text-center p-4 font-semibold text-charcoal-900">100 m²</th>
                    <th className="text-center p-4 font-semibold text-charcoal-900">150 m²</th>
                    <th className="text-center p-4 font-semibold text-charcoal-900">Prix/m²</th>
                  </tr>
                </thead>
                <tbody>
                  {prixDetailles.map((p, index) => (
                    <tr
                      key={p.technique}
                      className={index % 2 === 0 ? 'bg-white' : 'bg-sand-50/50'}
                    >
                      <td className="p-4 font-medium text-charcoal-900">{p.technique}</td>
                      <td className="p-4 text-center text-charcoal-600">{p.surface50}</td>
                      <td className="p-4 text-center text-charcoal-600">{p.surface100}</td>
                      <td className="p-4 text-center text-charcoal-600">{p.surface150}</td>
                      <td className="p-4 text-center font-semibold text-primary-600">{p.prixM2}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-sand-200 p-8 md:p-10">
            ...
            <div className="mt-8 grid sm:grid-cols-3 gap-4">
              <div className="bg-primary-50 rounded-xl p-4 text-center">
                ...
                <p className="text-2xl font-bold text-primary-800">1 jour</p>
                <p className="text-xs text-primary-500">pour 100 m²</p>
              </div>
              <div className="bg-primary-50 rounded-xl p-4 text-center">
                <p className="text-sm text-primary-500 font-medium mb-1">
                  Sous rampants (intérieur)
                </p>
                <p className="text-2xl font-bold text-primary-800">3 à 5 jours</p>
                <p className="text-xs text-primary-500">pour 100 m²</p>
              </div>
              <div className="bg-primary-50 rounded-xl p-4 text-center">
                <p className="text-sm text-primary-500 font-medium mb-1">Sarking (extérieur)</p>
                <p className="text-2xl font-bold text-primary-800">5 à 10 jours</p>
                <p className="text-xs text-primary-500">pour 100 m²</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Profitez d’une réfection de toiture pour isoler par sarking.'}
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Toutes les aides pour financer votre isolation.'}
              </p>
            </Link>
            <Link
        ...
        <RgeGuideBlock
          ...
          title="Artisans RGE isolation près de chez vous"
        />
