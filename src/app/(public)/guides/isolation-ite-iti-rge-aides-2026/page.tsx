...
const comparatif = [
  { critere: "Principe", ite: "Isolation posée sur la façade extérieure, recouverte d'un enduit ou d'un bardage", iti: "Isolation posée côté intérieur contre les murs existants, recouverte d'un parement (placo, lambris)" },
  { critere: "Perte de surface habitable", ite: "Aucune perte — gain de confort sans sacrifier d'espace", iti: "Perte de 5 à 15 cm par mur traité, soit 3 à 5 m² pour une maison type" },
  { critere: "Performance thermique", ite: "Excellente — supprime les ponts thermiques de dalle et de refends", iti: "Bonne — mais ponts thermiques résiduels aux jonctions murs-planchers" },
  { critere: "Coût au m² de paroi", ite: "Entre 100 et 250 €/m² selon matériau et finition", iti: "Entre 50 et 120 €/m² selon matériau et épaisseur" },
  { critere: "Aspect extérieur", ite: "Modifie la façade (enduit neuf ou bardage bois/composite)", iti: "Invisible depuis l'extérieur — idéal en zone protégée ABF" },
  { critere: "Durée de chantier", ite: "3 à 6 semaines pour une maison individuelle", iti: "1 à 3 semaines selon la surface traitée" },
  { critere: "Occupation du logement", ite: "Possible pendant les travaux", iti: "Chantier pièce par pièce, parfois contraignant" },
]

const materiaux = [
  { nom: "Laine de verre", r: "R typique 3,5 à 7 m²·K/W", usage: "ITI principalement", prix: "Le plus économique au m²" },
  { nom: "Laine de roche", r: "R typique 3,5 à 7 m²·K/W", usage: "ITE et ITI — bon comportement au feu", prix: "Coût intermédiaire" },
  { nom: "Polystyrène expansé (PSE)", r: "R typique 3 à 6 m²·K/W", usage: "ITE dominante", prix: "Coût maîtrisé" },
  { nom: "Polystyrène extrudé (XPS)", r: "R typique 3 à 5 m²·K/W", usage: "Soubassement, points sensibles", prix: "Légèrement supérieur au PSE" },
  { nom: "Polyuréthane (PUR)", r: "R typique 4 à 8 m²·K/W", usage: "ITE et ITI — R élevé, faible épaisseur", prix: "Coût supérieur, haute performance" },
  { nom: "Laine de bois", r: "R typique 3,5 à 6 m²·K/W", usage: "ITE et ITI — biosourcé, déphasage estival", prix: "Matériau premium, prime bonifiée CEE" },
  { nom: "Ouate de cellulose", r: "R typique 4 à 7 m²·K/W", usage: "ITI, insufflation murs creux", prix: "Biosourcé, bonne inertie" },
]
      ...
      <div className="min-h-screen bg-gradient-to-b from-green-50/60 to-white">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-bold text-gray-900">ITE — Isolation Thermique par l&apos;Extérieur</h2>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-bold text-gray-900">ITI — Isolation Thermique par l&apos;Intérieur</h2>
              </div>
              <p className="text-gray-700 leading-relaxed">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-x-auto">
            <table className="w-full text-sm min-w-[700px]">
              <thead className="bg-gray-50">
                <tr>
                  <th className="text-left font-semibold text-gray-700 p-4">Critère</th>
                  <th className="text-left font-semibold text-gray-700 p-4">ITE</th>
                  <th className="text-left font-semibold text-gray-700 p-4">ITI</th>
                </tr>
              </thead>
              <tbody>
                {comparatif.map((c) => (
                  <tr key={c.critere} className="border-t border-gray-100">
                    <td className="p-4 font-semibold text-gray-900">{c.critere}</td>
                    <td className="p-4 text-gray-600">{c.ite}</td>
                    <td className="p-4 text-gray-600">{c.iti}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <section className="max-w-5xl mx-auto px-4 py-10">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {materiaux.map((m) => (
              <div key={m.nom} className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
                ...
                <div className="text-xs text-gray-600 space-y-1">
                  ...
                  <div><strong>Prix :</strong> {m.prix}</div>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-700"><strong>7131 / 7132</strong> — Isolation thermique par l&apos;extérieur (ITE) avec enduit ou bardage</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-green-600 mt-0.5 shrink-0" />
                <span className="text-gray-700"><strong>7133 / 7134</strong> — Isolation thermique par l&apos;intérieur (ITI) avec ou sans finition</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-green-600 mt-0.5 shrink-0" />
                <span className="text-gray-700"><strong>7141</strong> — Isolation des combles perdus par soufflage</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-green-600 mt-0.5 shrink-0" />
                <span className="text-gray-700"><strong>7142</strong> — Isolation des rampants de toiture (sarking, panneaux)</span>
              </li>
            </ul>
