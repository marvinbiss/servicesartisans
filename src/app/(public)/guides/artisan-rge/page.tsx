...
const breadcrumbItems = [{ label: 'Guides', href: '/guides' }, { label: 'Artisan RGE' }]
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-green-50/60 to-white">
            ...
            <div className="prose prose-lg max-w-none text-charcoal-700">
              ...
              <ul className="space-y-2 mt-4">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong>Qualibat</strong> — pour les entreprises du bâtiment (isolation,
                    menuiseries, toiture)
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-green-600 mt-0.5 shrink-0" />
                  <span>
                    <strong>QualiENR / Qualit{"'"}ENR</strong> — pour les installateurs d{"'"}
                    énergies renouvelables (solaire, bois, PAC)
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-green-600 mt-0.5 shrink-0" />
                  <span>
                    <strong>Qualifelec</strong> — pour les entreprises d{"'"}installations
                    électriques
                  </span>
                </li>
              </ul>
        ...
        <section className="max-w-5xl mx-auto px-4 py-10">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-sand-200 p-6">
              ...
              <h3 className="text-lg font-bold text-charcoal-900 mb-2">Garantie de compétence</h3>
              <p className="text-charcoal-600">
                {
            ...
            <div className="bg-white rounded-xl shadow-sm border border-sand-200 p-6">
              ...
              <h3 className="text-lg font-bold text-charcoal-900 mb-2">Performance garantie</h3>
              <p className="text-charcoal-600">
                {
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="text-lg font-bold text-charcoal-900">{q.name}</h3>
                  </div>
                  <p className="text-charcoal-600 mb-3">{q.description}</p>
                  <div className="text-sm text-charcoal-500">
                    <span className="font-medium text-charcoal-700">Travaux couverts :</span>{' '}
                    {q.travaux}
                  </div>
                </div>
              )
        ...
        <RgeGuideBlock
          variant="generic"
          hideGuideCta
          title="Artisans RGE certifiés partout en France"
        />
