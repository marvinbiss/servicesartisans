...
const typesIsolation = [
  {
    ...
    avantages:
      'Supprime les ponts thermiques, pas de perte de surface habitable, ravalement simultané',
    inconvenients:
      "Coût élevé, échafaudage nécessaire, modifie l'aspect extérieur (déclaration préalable)",
  },
  {
    ...
    resistance: 'R ≥ 3,7 m².K/W',
    avantages:
      'Large choix esthétique (bois, composite, métal), ventilation naturelle, très durable',
  ...
  },
  {
    ...
    inconvenients:
      'Perte de surface habitable (5-7 cm par mur), ponts thermiques résiduels, déménagement du mobilier',
  },
  {
    name: 'Combles perdus',
    prix: '20 – 45 €/m²',
    ...
    avantages:
      'Meilleur rapport coût/efficacité, soufflage rapide (1 journée), gains immédiats sur la facture',
  ...
  },
  {
    ...
    inconvenients:
      'Plus complexe à poser, légère perte de hauteur sous plafond, pare-vapeur indispensable',
  },
  {
    name: 'Plancher bas',
    prix: '25 – 55 €/m²',
    ...
    avantages:
      'Élimine la sensation de sol froid, gains de confort immédiats, pose par le dessous (cave/vide sanitaire)',
...
const materiauxIsolants = [
  {
    ...
    prix: '5 – 15 €/m²',
    avantages:
      'Très économique, excellent rapport performance/prix, incombustible (A1), bon isolant acoustique',
  ...
  },
  {
    ...
    prix: '8 – 20 €/m²',
    avantages:
      'Résistance au feu excellente (A1), bonne tenue mécanique, isolant phonique performant',
    inconvenients:
      'Irritante à la pose, légèrement plus chère que la laine de verre, énergie grise élevée',
  },
  {
    ...
    prix: '10 – 25 €/m²',
    avantages:
      "Biosourcée (papier recyclé), très bon déphasage thermique (confort d'été), bon isolant phonique",
    inconvenients:
      "Traitement au sel de bore, tassement possible en vrac, sensible à l'humidité prolongée",
  },
  {
    name: 'Fibre de bois',
    lambda: '0,036 – 0,046',
    prix: '15 – 40 €/m²',
    avantages:
      'Excellent déphasage thermique, biosourcée, bilan carbone favorable, confort été comme hiver',
    inconvenients:
      "Prix élevé, épaisseur nécessaire supérieure, sensible à l'humidité sans protection",
  },
  {
    ...
    inconvenients:
      'Isolant acoustique médiocre, inflammable (classement E), non biosourcé, dégage des fumées toxiques',
  },
  {
    ...
    prix: '15 – 35 €/m²',
    avantages:
      "Meilleur lambda du marché (faible épaisseur nécessaire), insensible à l'humidité, rigide",
    inconvenients:
      'Prix élevé, inflammable, non recyclable, issu de la pétrochimie, mauvais déphasage thermique',
  },
]
...
const breadcrumbItems = [{ label: 'Guides', href: '/guides' }, { label: 'Isolation thermique' }]
        ...
        <section className="max-w-5xl mx-auto px-4 py-10">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {typesIsolation.map((t) => (
              ...
              >
                <h3 className="text-lg font-bold text-charcoal-900 mb-1">{t.name}</h3>
                <div className="flex flex-wrap gap-3 text-sm mb-3">
                  <span className="inline-flex items-center gap-1 text-primary-600 bg-primary-50 px-2 py-0.5 rounded">
                ...
                <div className="space-y-2">
                  <div>
                    ...
                    <p className="text-sm text-charcoal-600">{t.avantages}</p>
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-amber-700 mb-1">Inconvénients</p>
                    <p className="text-sm text-charcoal-600">{t.inconvenients}</p>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {materiauxIsolants.map((m) => (
              <div
                ...
                className="bg-white rounded-xl shadow-sm border border-sand-200 p-6"
              >
                <h3 className="text-lg font-bold text-charcoal-900 mb-1">{m.name}</h3>
                <div className="flex flex-wrap gap-3 text-sm mb-3">
                  <span className="inline-flex items-center gap-1 text-primary-600 bg-primary-50 px-2 py-0.5 rounded">
                ...
                <div className="space-y-2">
                  <div>
                    <p className="text-sm font-semibold text-green-700 mb-1">Avantages</p>
                    <p className="text-sm text-charcoal-600">{m.avantages}</p>
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-amber-700 mb-1">Inconvénients</p>
                    <p className="text-sm text-charcoal-600">{m.inconvenients}</p>
                  </div>
                </div>
              </div>
            ))}
            ...
            {prixParTravaux.map((cat) => (
              ...
              >
                <div className="bg-sand-50 px-6 py-4 border-b border-sand-200">
                  <h3 className="text-lg font-bold text-charcoal-900">{cat.categorie}</h3>
                </div>
                <div className="divide-y divide-sand-100">
                  {cat.lignes.map((l) => (
                    <div key={l.travaux} className="flex items-center justify-between px-6 py-4">
                      <span className="text-charcoal-700">{l.travaux}</span>
                      <span className="text-primary-600 font-semibold whitespace-nowrap ml-4">
                        {l.prix}
                      </span>
                    </div>
                  ))}
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white/10 rounded-xl p-5">
                ...
                <p className="text-green-50 text-sm">
                  {
                    "Finance jusqu'à 80 % du coût des travaux pour les ménages très modestes (plafond 70 000 € HT). Obligation d'un gain énergétique de 2 classes DPE minimum. Accompagnement par un Accompagnateur Rénov' obligatoire pour les projets > 5 000 €."
                  }
                </p>
              </div>
              <div className="bg-white/10 rounded-xl p-5">
                ...
                <p className="text-green-50 text-sm">
                  {
                    "Les Certificats d'Économies d'Énergie représentent une enveloppe de 8 milliards d'euros. Primes versées par les fournisseurs d'énergie (EDF, Engie, TotalEnergies). Cumulables avec MaPrimeRénov'. Montant : 10 à 25 €/m² selon le type d'isolation et la zone climatique."
                  }
                </p>
              </div>
              <div className="bg-white/10 rounded-xl p-5">
                ...
                <p className="text-green-50 text-sm">
                  {
                    "Prêt à taux zéro jusqu'à 50 000 € pour un bouquet de travaux de rénovation énergétique, remboursable sur 20 ans. Accessible sans condition de revenus. Cumulable avec toutes les autres aides."
                  }
                </p>
              </div>
              <div className="bg-white/10 rounded-xl p-5">
                ...
                <p className="text-green-50 text-sm">
                  {
                    "TVA réduite à 5,5 % (au lieu de 20 %) sur les travaux d'isolation thermique et la fourniture des matériaux. Applicable automatiquement par l'artisan pour les logements de plus de 2 ans."
                  }
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white/10 rounded-xl p-5 text-center">
                ...
                <p className="text-red-50 text-sm">
                  {
                    'Interdiction de location des logements classés G au DPE depuis le 1er janvier 2025. Environ 600 000 logements concernés.'
                  }
                </p>
              </div>
              <div className="bg-white/10 rounded-xl p-5 text-center">
                ...
                <p className="text-red-50 text-sm">
                  {
                    'Les logements classés F seront également interdits à la location à partir du 1er janvier 2028. Environ 1,2 million de logements supplémentaires.'
                  }
                </p>
              </div>
              <div className="bg-white/10 rounded-xl p-5 text-center">
                ...
                <p className="text-red-50 text-sm">
                  {
                    'Les logements classés E seront interdits à la location au 1er janvier 2034. Environ 2,6 millions de logements concernés en plus.'
                  }
                </p>
              </div>
            </div>
            ...
            <div className="prose prose-lg max-w-none text-charcoal-700">
              <ol className="space-y-4">
                <li className="flex items-start gap-3">
                  <span className="bg-primary-100 text-primary-600 rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold shrink-0">
                    1
                  </span>
                  <div>
                    ...
                    <p className="mt-1">
                      {
                        "Faites réaliser un Diagnostic de Performance Énergétique (DPE) par un diagnostiqueur certifié. Il identifiera les déperditions thermiques de votre logement : toiture (25-30 %), murs (20-25 %), fenêtres (10-15 %), plancher bas (7-10 %), ventilation (20-25 %). Ce diagnostic est la base de tout projet d'isolation."
                      }
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1">
                      {
                        "Commencez par la toiture et les combles (plus grande source de déperdition), puis les murs, et enfin le plancher bas. Pour un maximum d'efficacité, traitez aussi la ventilation (VMC double flux) après avoir isolé. Un parcours de rénovation globale est plus efficace que des gestes isolés."
                      }
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1">
                      {
                        "Budget serré (2 000-5 000 €) : isolez les combles perdus par soufflage, retour sur investissement en 3-5 ans. Budget moyen (8 000-15 000 €) : ajoutez l'ITI des murs ou le plancher bas. Budget confortable (20 000-50 000 €) : optez pour une ITE complète + combles + plancher pour une rénovation globale performante."
                      }
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1">
                      {
                        "Laine de verre ou laine de roche pour le meilleur rapport qualité/prix. Fibre de bois ou ouate de cellulose pour un confort d'été optimal (déphasage thermique). Polyuréthane pour les espaces contraints nécessitant une faible épaisseur. Pensez à la résistance thermique visée (R) plutôt qu'au seul prix."
                      }
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1">
                      {
                        "Demandez au minimum 3 devis à des artisans certifiés RGE. Vérifiez que le devis précise : le matériau, l'épaisseur, la résistance thermique (R), la technique de pose et le traitement des ponts thermiques. Un artisan RGE est obligatoire pour bénéficier des aides MaPrimeRénov' et CEE."
                      }
                    </p>
                  </div>
                </li>
            ...
            {services.map((s) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="font-semibold text-charcoal-900 group-hover:text-primary-600 transition-colors">
                    {s.label}
                  </span>
        ...
        <section className="max-w-5xl mx-auto px-4 py-10">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <Link
              ...
              className="group bg-white rounded-xl border border-sand-200 p-5 hover:shadow-md hover:border-primary-200 transition-all"
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Toutes les aides pour financer votre isolation thermique.'}
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Profitez de la rénovation de toiture pour isoler vos combles.'}
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {"Obligatoire pour bénéficier des aides à l'isolation."}
              </p>
            </Link>
          </div>
        </section>
