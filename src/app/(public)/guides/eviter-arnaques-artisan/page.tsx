...
const temoignages = [
  {
    ...
    lecon:
      'Ne jamais accepter un démarchage à domicile sans vérification préalable. Toujours demander un devis écrit et vérifier le SIRET.',
  },
  {
    ...
    lecon:
      'Toujours vérifier la validité de la certification RGE sur france-renov.gouv.fr au moment de la signature du devis.',
  },
  {
    ...
    lecon:
      "Tout travail supplémentaire doit faire l'objet d'un avenant écrit et signé avant exécution. Sans avenant, refusez de payer les surcoûts.",
  },
]
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-charcoal-600 mb-3">{arnaque.description}</p>
              ...
              <div>
                ...
                <ol className="space-y-3 text-primary-50">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      {
                        "SIRET : vérifiez sur sirene.fr ou annuaire-entreprises.data.gouv.fr que l'entreprise est active"
                      }
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      {
                        "Décennale : demandez l'attestation en cours de validité et contactez l'assureur si nécessaire"
                      }
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      {
                        'RGE : vérifiez sur france-renov.gouv.fr si la certification est valide et couvre les travaux prévus'
                      }
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      {
                        'Ancienneté : consultez la date de création sur societe.com ou infogreffe.fr'
                      }
                    </span>
                  </li>
                </ol>
            ...
            {recours.map((item, index) => (
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-charcoal-900 mb-2">{item.titre}</h3>
                    <p className="text-charcoal-600 mb-2">{item.description}</p>
                    <p className="text-sm text-primary-500 font-medium">{item.action}</p>
                  </div>
                </div>
              </div>
            ))}
        ...
        <section className="max-w-5xl mx-auto px-4 py-10">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {organismes.map((org) => (
              ...
              >
                <h3 className="text-lg font-bold text-charcoal-900 mb-2">{org.nom}</h3>
                <p className="text-charcoal-600 mb-2">{org.role}</p>
                <p className="text-sm text-primary-500 font-medium">{org.site}</p>
              </div>
            ))}
          </div>
        </section>
          ...
          <div className="space-y-6">
            {temoignages.map((temoignage, index) => (
              <div
                ...
                className="bg-white rounded-2xl shadow-sm border border-sand-200 p-6 md:p-8"
              >
                <h3 className="text-lg font-bold text-charcoal-900 mb-3">{temoignage.titre}</h3>
                <blockquote className="text-charcoal-600 italic mb-4 border-l-4 border-sand-300 pl-4">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Toutes les vérifications à faire avant de signer.'}
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Les mentions obligatoires pour un devis conforme.'}
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Votre protection pendant 10 ans après les travaux.'}
              </p>
            </Link>
          </div>
        </section>
