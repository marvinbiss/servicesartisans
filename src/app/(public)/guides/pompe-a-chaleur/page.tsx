...
const aidesFinancieres = [
  {
    ...
    details: [
      {
        profil: 'Ménages très modestes (Bleu)',
        montant: '11 000 € (PAC géothermique) / 5 000 € (PAC air-eau)',
      },
      { profil: 'Ménages modestes (Jaune)', montant: '9 000 € (géothermique) / 4 000 € (air-eau)' },
      {
        profil: 'Ménages intermédiaires (Violet)',
        montant: '6 000 € (géothermique) / 3 000 € (air-eau)',
      },
  ...
  },
  {
    ...
    icon: Zap,
    details: [{ profil: 'Tous les ménages', montant: '2 500 – 5 000 € selon zone et revenus' }],
  },
  {
    ...
    details: [
      {
        profil: 'Tous les propriétaires',
        montant: 'Jusqu’à 50 000 € sur 20 ans, sans condition de revenus',
      },
    ],
  },
  {
    ...
    details: [
      {
        profil: 'Logements de plus de 2 ans',
        montant: 'TVA réduite au lieu de 20 % sur fourniture et pose',
      },
    ],
  },
]
...
const breadcrumbItems = [{ label: 'Guides', href: '/guides' }, { label: 'Pompe à chaleur' }]
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {typesPAC.map((t) => (
              ...
              >
                ...
                <p className="text-sm text-charcoal-500 mb-3">{t.usage}</p>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-sand-50 border-b border-sand-300">
                    <th className="text-left p-4 font-semibold text-charcoal-900">Type de PAC</th>
                    <th className="text-left p-4 font-semibold text-charcoal-900">Fourniture</th>
                    <th className="text-left p-4 font-semibold text-charcoal-900">Pose</th>
                    <th className="text-left p-4 font-semibold text-charcoal-900">Total TTC</th>
                  </tr>
                </thead>
                <tbody>
                  {prixInstallation.map((p, index) => (
                    <tr key={index} className="border-b border-sand-200 last:border-0">
                      <td className="p-4">
                        <span className="font-medium text-charcoal-900">{p.type}</span>
                        <br />
                        <span className="text-xs text-charcoal-500">{p.details}</span>
                      </td>
                      <td className="p-4 text-charcoal-700">{p.prixFourniture}</td>
                      <td className="p-4 text-charcoal-700">{p.prixPose}</td>
                      <td className="p-4 font-semibold text-primary-600">{p.prixTotal}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl shadow-sm border border-sand-200 p-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-lg font-bold text-charcoal-900">Surface et isolation</h3>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-sand-200 p-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-lg font-bold text-charcoal-900">Zone climatique</h3>
              </div>
              <p className="text-charcoal-600">
                {
            ...
            <div className="bg-white rounded-xl shadow-sm border border-sand-200 p-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-lg font-bold text-charcoal-900">Émetteurs existants</h3>
              </div>
              <p className="text-charcoal-600">
                {
            ...
            <div className="bg-white rounded-xl shadow-sm border border-sand-200 p-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-lg font-bold text-charcoal-900">Budget et rentabilité</h3>
              </div>
              <p className="text-charcoal-600">
                {
        ...
        <section className="max-w-5xl mx-auto px-4 py-10">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-sand-200 p-8 md:p-10">
            <div className="prose prose-lg max-w-none text-charcoal-700">
              ...
              <div className="mt-6 bg-primary-50 rounded-xl p-4 text-sm text-primary-800">
                <strong>Délai total :</strong> comptez 2 à 4 semaines entre la visite technique et
                la mise en service pour une PAC air-eau, et 4 à 8 semaines pour une PAC géothermique
                (forage inclus).
              </div>
            </div>
          </div>
              ...
              <div>
                ...
                <ul className="space-y-3 text-primary-50">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      {
                        'Révision tous les 2 ans par un professionnel certifié (obligatoire depuis 2020)'
                      }
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 mt-0.5 shrink-0" />
                    <span>
                      {'Coût : 150 à 300 € par intervention, ou 200 à 400 €/an en contrat'}
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Toutes les aides pour financer votre pompe à chaleur.'}
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Obligatoire pour bénéficier des aides à l’installation.'}
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Vérifiez la décennale de votre installateur avant travaux.'}
              </p>
            </Link>
          </div>
        </section>
