...
const breadcrumbItems = [{ label: 'Guides', href: '/guides' }, { label: 'Extension de maison' }]
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-charcoal-900">{t.name}</h3>
                      <span className="text-sm font-medium text-primary-500">{t.prix}</span>
                    </div>
                  </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left">
                <thead className="bg-sand-50 border-b border-sand-200">
                  <tr>
                    <th className="px-6 py-4 text-sm font-semibold text-charcoal-900">Type</th>
                    <th className="px-6 py-4 text-sm font-semibold text-charcoal-900">Prix / m²</th>
                    <th className="px-6 py-4 text-sm font-semibold text-charcoal-900">
                      Pour 20 m²
                    </th>
                    <th className="px-6 py-4 text-sm font-semibold text-charcoal-900">
                      Délai moyen
                ...
                <tbody className="divide-y divide-sand-200">
                  <tr>
                    <td className="px-6 py-4 font-medium text-charcoal-900">Véranda aluminium</td>
                    <td className="px-6 py-4 text-charcoal-600">800 – 2 000 €</td>
                    <td className="px-6 py-4 text-charcoal-600">16 000 – 40 000 €</td>
                    <td className="px-6 py-4 text-charcoal-600">2 – 4 semaines</td>
                  </tr>
                  <tr>
                    <td className="px-6 py-4 font-medium text-charcoal-900">Extension parpaing</td>
                    <td className="px-6 py-4 text-charcoal-600">1 200 – 1 800 €</td>
                    <td className="px-6 py-4 text-charcoal-600">24 000 – 36 000 €</td>
                    <td className="px-6 py-4 text-charcoal-600">3 – 5 mois</td>
                  </tr>
                  <tr>
                    <td className="px-6 py-4 font-medium text-charcoal-900">
                      Extension ossature bois
                    </td>
                    <td className="px-6 py-4 text-charcoal-600">1 200 – 2 200 €</td>
                    <td className="px-6 py-4 text-charcoal-600">24 000 – 44 000 €</td>
                    <td className="px-6 py-4 text-charcoal-600">2 – 4 mois</td>
                  </tr>
                  <tr>
                    <td className="px-6 py-4 font-medium text-charcoal-900">Surélévation</td>
                    <td className="px-6 py-4 text-charcoal-600">1 500 – 2 500 €</td>
                    <td className="px-6 py-4 text-charcoal-600">30 000 – 50 000 €</td>
                    <td className="px-6 py-4 text-charcoal-600">4 – 8 mois</td>
                  </tr>
                  <tr>
                    <td className="px-6 py-4 font-medium text-charcoal-900">Sous-sol aménagé</td>
                    <td className="px-6 py-4 text-charcoal-600">800 – 1 500 €</td>
                    <td className="px-6 py-4 text-charcoal-600">16 000 – 30 000 €</td>
                    <td className="px-6 py-4 text-charcoal-600">2 – 4 mois</td>
                  </tr>
                </tbody>
              </table>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {materiaux.map((m) => (
              <div
                ...
                className="bg-white rounded-xl shadow-sm border border-sand-200 p-6"
              >
                <h3 className="text-lg font-bold text-charcoal-900 mb-2">{m.name}</h3>
                <p className="text-sm font-medium text-primary-500 mb-4">{m.prix}</p>
              ...
              <ol className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1">
                      {
                        "Consultez le PLU de votre commune pour connaître les règles d'urbanisme (COS, emprise au sol, hauteur maximale, recul par rapport aux limites séparatives). Faites réaliser une étude de sol si nécessaire."
                      }
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1">
                      {
                        "Faites réaliser au minimum 3 devis détaillés par des professionnels différents. L'architecte est obligatoire si la surface totale après extension dépasse 150 m²."
                      }
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1">
                      {
                        "Déposez votre déclaration préalable ou permis de construire en mairie. Attendez l'autorisation avant de démarrer les travaux (1 à 3 mois)."
                      }
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1">
                      {
                        'Gros œuvre (fondations, murs, toiture), puis second œuvre (isolation, électricité, plomberie) et finitions (revêtements, peinture). Durée typique : 3 à 6 mois.'
                      }
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1">
                      {
                        "Réceptionnez les travaux avec un procès-verbal. Déposez une déclaration d'achèvement des travaux (DAACT) en mairie dans les 90 jours. Pensez à mettre à jour votre assurance habitation et déclarer la nouvelle surface aux impôts."
                      }
                    </p>
                  </div>
                </li>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {"Quand le permis est obligatoire et comment l'obtenir."}
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {"Formulaire, délai et cas d'application."}
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {"Vérifiez l'assurance décennale de vos artisans."}
              </p>
            </Link>
          </div>
        </section>
