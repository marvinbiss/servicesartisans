...
const materiaux = [
  {
    ...
    avantages:
      'Excellent rapport qualité/prix, aucun entretien, bonne isolation thermique, large choix de coloris',
  ...
  },
  {
    ...
    avantages:
      'Design fin et contemporain, grandes surfaces vitrées, aucun entretien, recyclable à 100 %',
  ...
  },
  {
    ...
    avantages:
      'Bois côté intérieur (chaleur), aluminium côté extérieur (résistance), excellente isolation',
...
const typesOuverture = [
  {
    ...
    description:
      "Ouverture vers l'intérieur sur un axe vertical. Le classique en France. Permet une ventilation maximale et un entretien facile du vitrage extérieur.",
  },
  {
    name: 'Oscillo-battante',
    description:
      "Double mode : ouverture classique à la française + entrebâillement par le haut (oscillo). Idéale pour ventiler en toute sécurité, recommandée pour les chambres d'enfants et les étages.",
  },
  {
    name: 'Coulissante',
    description:
      "Le vantail glisse horizontalement sur un rail. N'empiète pas sur l'espace intérieur. Idéale pour les baies vitrées et les accès terrasse. Version à galandage (le vantail disparaît dans le mur) pour un maximum de dégagement.",
  },
  {
    name: 'À soufflet',
    description:
      "Ouverture par le haut uniquement, vers l'intérieur. Parfaite pour les petites fenêtres de salle de bain ou de cuisine au-dessus de l'évier, où l'espace est limité.",
  },
]
...
const breadcrumbItems = [{ label: 'Guides', href: '/guides' }, { label: 'Changer ses fenêtres' }]
      ...
      <div className="min-h-screen bg-gradient-to-b from-primary-50/60 to-white">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {typesOuverture.map((t) => (
              <div
                ...
                className="bg-white rounded-xl shadow-sm border border-sand-200 p-6"
              >
                <h3 className="text-lg font-bold text-charcoal-900 mb-2">{t.name}</h3>
        ...
        <section className="max-w-5xl mx-auto px-4 py-10">
          <div className="bg-gradient-to-br from-primary-500 to-primary-600 rounded-2xl p-8 md:p-10 text-white">
            <h2 className="text-2xl md:text-3xl font-bold mb-6 font-heading">Guide du vitrage</h2>
        ...
        <section className="max-w-5xl mx-auto px-4 py-10">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl shadow-sm border border-sand-200 p-6">
              <h3 className="text-lg font-bold text-charcoal-900 mb-2">Pose en rénovation</h3>
              <p className="text-sm font-medium text-primary-500 mb-3">150 – 250 € / fenêtre</p>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-sand-200 p-6">
              <h3 className="text-lg font-bold text-charcoal-900 mb-2">Dépose totale</h3>
              <p className="text-sm font-medium text-primary-500 mb-3">250 – 400 € / fenêtre</p>
              <p className="text-charcoal-600 mb-3">
                {
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white/10 rounded-xl p-5">
                ...
                <p className="text-green-50 text-sm">
                  {
                    '40 à 100 € par fenêtre selon vos revenus. Réservée au remplacement de simple vitrage. Non cumulable avec le parcours accompagné pour les fenêtres seules.'
                  }
                </p>
              </div>
              <div className="bg-white/10 rounded-xl p-5">
                ...
                <p className="text-green-50 text-sm">
                  {
                    "Prime versée par les fournisseurs d'énergie : 30 à 80 € par fenêtre. Cumulable avec MaPrimeRénov. Demande à faire avant la signature du devis."
                  }
                </p>
              </div>
              <div className="bg-white/10 rounded-xl p-5">
                ...
                <p className="text-green-50 text-sm">
                  {
                    "TVA réduite à 5,5 % sur les fenêtres et la pose (au lieu de 20 % en neuf ou 10 % en rénovation classique). Appliquée directement par l'artisan sur la facture."
                  }
                </p>
              </div>
              <div className="bg-white/10 rounded-xl p-5">
                ...
                <p className="text-green-50 text-sm">
                  {
                    "Prêt à taux zéro jusqu'à 50 000 € pour un bouquet de travaux. Le changement de fenêtres peut être combiné avec l'isolation des murs ou de la toiture."
                  }
                </p>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Toutes les aides pour financer vos fenêtres.'}
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Obligatoire pour bénéficier des aides financières.'}
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Le DPE classe votre logement selon ses performances.'}
              </p>
            </Link>
          </div>
        </section>
        ...
        <RgeGuideBlock
          ...
          title="Menuisiers RGE pour remplacer vos fenêtres"
        />
