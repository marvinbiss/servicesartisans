  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-sand-50">
        ...
        {/* Hero */}
        <div className="bg-gradient-to-b from-amber-50 to-sand-50">
          ...
          <nav className="bg-white rounded-xl border border-sand-300 p-6 mb-10">
            ...
            <ol className="space-y-2 text-sm">
              {[
                ...
                <li
                  key={i}
                  className="flex items-center gap-2 text-charcoal-600 hover:text-amber-600"
                >
            ...
            <div className="bg-white rounded-xl border border-sand-300 overflow-hidden">
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-sand-200">
                    {exigencesParPiece.map((row) => (
                      <tr key={row.piece} className="hover:bg-sand-50">
                        <td className="py-3 px-4 font-medium text-charcoal-900">{row.piece}</td>
                        <td className="py-3 px-4 text-charcoal-700">{row.prises}</td>
                        <td className="py-3 px-4 text-charcoal-700">{row.eclairage}</td>
                        <td className="py-3 px-4 text-charcoal-700">{row.comm}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
              ...
              <div className="p-4 bg-amber-50 border-t border-amber-200">
                <p className="text-sm text-amber-800">
                  <strong>{'Note :'}</strong>
                  {
                    ' ces chiffres sont des minimums réglementaires. Pour un confort optimal, prévoyez davantage de prises, surtout dans la cuisine et le séjour. Les prises USB intégrées ne comptent pas comme prises de courant 16A.'
                  }
                </p>
              </div>
            </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-2">
                    {[
                      { circuit: 'Éclairage', protection: 'Disjoncteur 10A ou 16A, câble 1,5 mm²' },
                      {
                        ...
                        protection: 'Disjoncteur 16A ou 20A, câble 2,5 mm²',
                      },
                      ...
                      { circuit: 'Four, lave-linge', protection: 'Disjoncteur 20A, câble 2,5 mm²' },
                      {
                        ...
                        protection: 'Disjoncteur 10A à 20A selon puissance',
                      },
                      {
                        circuit: 'Chauffe-eau',
                        protection: 'Disjoncteur 20A, contacteur heures creuses',
                      },
                    ].map((item) => (
                ...
                {zonesVolumesBain.map((zone) => (
                  <div key={zone.volume} className={`p-4 ${zone.color} rounded-lg border`}>
                    <div className="flex items-center gap-2 mb-2">
                      <h3 className="font-semibold text-charcoal-900">{zone.volume}</h3>
                      <span className="text-xs bg-white/60 px-2 py-0.5 rounded-full font-medium text-charcoal-700">
                        {zone.protection}
                      </span>
                    </div>
                    ...
                    <p className="text-sm text-charcoal-600">
                      <strong>{'Appareils :'}</strong> {zone.appareils}
                    </p>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-white rounded-xl border border-sand-300 p-6">
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-sand-300">
                      ...
                      <th className="text-right py-3 px-4 font-semibold text-charcoal-900">
                        {'Coût moyen'}
                      </th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-sand-200">
                    {[
                      ...
                      {
                        travaux: 'Mise aux normes partielle (tableau + différentiels)',
                        cout: '2 000 € à 4 000 €',
                      },
                      {
                        travaux: 'Rénovation complète appartement 60 m²',
                        cout: '4 800 € à 7 200 €',
                      },
                      ...
                      <tr key={row.travaux}>
                        <td className="py-3 px-4 text-charcoal-700">{row.travaux}</td>
                        <td className="py-3 px-4 text-right font-medium text-charcoal-900">
                          {row.cout}
                        </td>
                      </tr>
                    ))}
              ...
              <div className="mt-4 p-3 bg-green-50 rounded-lg">
                <p className="text-sm text-green-800">
                  ...
                  {
                    ' la TVA est réduite à 10 % (au lieu de 20 %) pour les travaux de rénovation électrique dans les logements de plus de 2 ans, si les travaux sont réalisés par un professionnel.'
                  }
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl border border-sand-300 p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-4">
                <div className="p-4 bg-purple-50 rounded-lg">
                  <h3 className="font-semibold text-charcoal-900 mb-2">{'En cas de vente'}</h3>
                ...
                <div className="p-4 bg-purple-50 rounded-lg">
                  <h3 className="font-semibold text-charcoal-900 mb-2">{'En cas de location'}</h3>
                  <ul className="space-y-1 text-sm text-charcoal-600">
                    <li>{'• Obligatoire si installation > 15 ans'}</li>
