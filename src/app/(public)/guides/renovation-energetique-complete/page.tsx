...
const quatrePiliers = [
  {
    ...
    description:
      "Premier poste de déperdition. L'isolation est TOUJOURS le premier chantier à réaliser, peu importe l'état du chauffage.",
    icon: Home,
  ...
  },
  {
    ...
    description:
      'Une fois la maison isolée, le besoin de chauffage baisse drastiquement. Un système performant (PAC, granulés) sur une maison isolée divise la facture par 3 à 4.',
    icon: Thermometer,
  ...
  },
  {
    ...
    description:
      "Une maison bien isolée sans ventilation efficace = problèmes d'humidité et de qualité de l'air. La VMC double flux récupère 90 % de la chaleur de l'air sortant.",
    icon: Wind,
  ...
  },
  {
    ...
    description:
      'Les fenêtres sont souvent le dernier poste à traiter (sauf si simple vitrage). Le double vitrage moderne suffit dans la majorité des cas.',
    icon: Home,
...
const chauffageComparatif = [
  ...
  },
  {
    ...
    inconvenients:
      'Silo de stockage nécessaire, approvisionnement, entretien fréquent (ramonage 2x/an)',
  },
  {
...
const ventilationComparatif = [
  {
    ...
    prix: '500 – 1 500 €',
    description:
      "Bouches hygroréglables qui ajustent le débit selon l'humidité. Le standard actuel pour la rénovation. Extraction dans cuisine, SDB et WC.",
    economie: 'Référence',
  ...
  },
  {
    ...
    prix: '4 000 – 8 000 €',
    description:
      "Échangeur thermique qui récupère 85-92 % de la chaleur de l'air sortant pour préchauffer l'air entrant. Filtration de l'air (pollens, poussières).",
...
const ordreOptimal = [
  {
    ...
    explication:
      "Traitez d'abord le toit (30 % des pertes), puis les murs (25 %), puis le plancher. Réduisez le besoin de chauffage AVANT de changer le système.",
  },
  {
    num: 2,
    titre: 'Ventilation',
    explication:
      "Une maison isolée doit respirer. Installez la VMC après l'isolation pour garantir la qualité de l'air et éviter la condensation.",
  },
  {
    num: 3,
    titre: 'Fenêtres',
    explication:
      "Remplacez les fenêtres après l'isolation des murs (l'ITE modifie les tableaux). Le double vitrage argon suffit dans la plupart des cas.",
  },
  {
    num: 4,
    titre: 'Chauffage',
    explication:
      'En dernier : une fois la maison isolée, le besoin de chauffage a baissé de 40-60 %. Vous pouvez dimensionner un système plus petit et moins cher.',
  },
]
...
const aides2026 = [
  {
    ...
    conditions:
      "Gain de 2 classes DPE minimum, accompagnement par un MAR (Mon Accompagnateur Rénov'), logement de + de 15 ans",
    detail:
      'Le parcours le plus avantageux : 80 % de prise en charge pour les très modestes, 60 % pour les modestes, 40 % pour les intermédiaires, 10-15 % bonus sortie de passoire (F/G).',
  },
  {
  ...
  },
  {
    ...
    detail:
      "Financés par les énergéticiens (EDF, Total, Engie). Cumulables avec MaPrimeRénov'. Pensez à vous inscrire AVANT de signer le devis.",
  },
  {
    ...
    detail:
      'Sans conditions de revenus. 15 000 € pour un geste, 25 000 € pour deux gestes, 30 000 € pour trois gestes, 50 000 € pour une rénovation globale (performance énergétique).',
  },
  {
    aide: 'TVA à 5,5 %',
    ...
    detail:
      "Appliquée automatiquement sur la facture par l'artisan pour les travaux d'isolation, de chauffage performant et de régulation. La main-d'œuvre et les matériaux en bénéficient.",
  },
]

const roiParPoste = [
  {
    poste: 'Isolation combles perdus',
    investissement: '1 500 – 3 000 €',
    economieAn: '400 – 800 €/an',
    roi: '3-5 ans',
  },
  {
    poste: 'Isolation murs (ITE)',
    investissement: '8 000 – 20 000 €',
    economieAn: '600 – 1 200 €/an',
    roi: '10-15 ans',
  },
  {
    poste: 'PAC air/eau',
    investissement: '10 000 – 18 000 €',
    economieAn: '1 000 – 2 000 €/an',
    roi: '7-12 ans',
  },
  {
    poste: 'VMC double flux',
    investissement: '4 000 – 8 000 €',
    economieAn: '200 – 500 €/an',
    roi: '12-20 ans',
  },
  {
    poste: 'Fenêtres double vitrage (10 unités)',
    investissement: '5 000 – 10 000 €',
    economieAn: '200 – 500 €/an',
    roi: '12-20 ans',
  },
  {
    poste: 'Rénovation globale (passoire → C)',
    investissement: '30 000 – 60 000 €',
    economieAn: '2 000 – 4 000 €/an',
    roi: '10-15 ans',
  },
]
...
const breadcrumbItems = [{ label: 'Guides', href: '/guides' }, { label: 'Rénovation énergétique' }]
      ...
      <div className="min-h-screen bg-gradient-to-b from-green-50/60 to-white">
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    <div
                      className={`w-10 h-10 rounded-lg flex items-center justify-center ${p.color.split(' ')[0]}`}
                    >
                      <Icon className={`w-5 h-5 ${p.color.split(' ')[1]}`} />
                    </div>
                    <div>
                      <h3 className="text-lg font-bold text-charcoal-900">{p.pilier}</h3>
                      <span className="text-sm text-charcoal-500">{p.perte}</span>
                    </div>
                  </div>
                  <p className="text-charcoal-600 text-sm">{p.description}</p>
                </div>
              )
            })}
          </div>
        ...
        <section className="max-w-5xl mx-auto px-4 py-10">
          ...
          <div className="overflow-x-auto">
            <table className="w-full bg-white rounded-xl shadow-sm border border-sand-200 overflow-hidden">
              <thead>
                <tr className="bg-sand-50 border-b border-sand-300">
                  <th className="text-left p-4 font-semibold text-charcoal-900">Zone</th>
                  <th className="text-left p-4 font-semibold text-charcoal-900">Technique</th>
                  <th className="text-left p-4 font-semibold text-charcoal-900">Prix / m²</th>
                  <th className="text-left p-4 font-semibold text-charcoal-900">ROI</th>
                </tr>
              </thead>
              <tbody>
                {isolationDetails.map((item, i) => (
                  <tr key={item.zone} className={i % 2 === 0 ? 'bg-white' : 'bg-sand-50/50'}>
                    <td className="p-4">
                      <span className="font-semibold text-charcoal-900">{item.zone}</span>
                      <p className="text-xs text-charcoal-500 mt-1">{item.note}</p>
                    </td>
                    <td className="p-4 text-sm text-charcoal-600">
                      {item.techniques}
                      <br />
                      <span className="text-xs text-charcoal-400">
                        Épaisseur : {item.epaisseur}
                      </span>
                    </td>
                    <td className="p-4 text-green-700 font-semibold text-sm">{item.prix}</td>
                    <td className="p-4 text-sm text-charcoal-600">{item.roi}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {chauffageComparatif.map((c) => (
              <div
                ...
                className="bg-white rounded-xl shadow-sm border border-sand-200 p-6"
              >
                <h3 className="text-lg font-bold text-charcoal-900 mb-1">{c.systeme}</h3>
                ...
                <div className="space-y-2 text-sm">
                  <p className="text-charcoal-600">
                    <span className="font-semibold text-green-700">+</span> {c.avantages}
                  </p>
                  <p className="text-charcoal-600">
                    <span className="font-semibold text-red-600">−</span> {c.inconvenients}
                  </p>
                </div>
              </div>
            ))}
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {ventilationComparatif.map((v) => (
              <div
                ...
                className="bg-white rounded-xl shadow-sm border border-sand-200 p-6"
              >
                <h3 className="text-lg font-bold text-charcoal-900 mb-1">{v.type}</h3>
                <span className="inline-block bg-primary-50 text-primary-600 text-xs font-medium px-3 py-1 rounded-full mb-3">
                  {v.prix}
                </span>
                <p className="text-charcoal-600 text-sm mb-3">{v.description}</p>
                <p className="text-sm">
                  <span className="font-semibold text-green-700">Économie chauffage :</span>{' '}
                  {v.economie}
                </p>
                <p className="text-xs text-charcoal-400 mt-2">{v.note}</p>
              </div>
            ))}
          </div>
        </section>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {fenetresComparatif.map((f) => (
              <div
                ...
                className="bg-white rounded-xl shadow-sm border border-sand-200 p-6"
              >
                <h3 className="text-lg font-bold text-charcoal-900 mb-2">{f.type}</h3>
                ...
                <p className="text-charcoal-600 text-sm">{f.note}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="max-w-5xl mx-auto px-4 py-10">
              ...
              >
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                  <div className="flex-1">
                    <h3 className="text-lg font-bold text-charcoal-900 mb-1">{a.aide}</h3>
                    <span className="inline-block bg-green-100 text-green-800 text-sm font-semibold px-3 py-1 rounded-full mb-3">
                      {a.montant}
                    </span>
                    <p className="text-charcoal-600 text-sm mb-2">{a.detail}</p>
          ...
          <div className="mt-6 p-4 bg-green-50 rounded-xl border border-green-200">
            <p className="text-green-800 text-sm font-medium flex items-start gap-2">
              ...
              <span>
                {
                  "Toutes ces aides sont cumulables entre elles. Un accompagnateur France Rénov' (gratuit) vous aide à monter le dossier et à maximiser les aides. Appelez le 0 808 800 700."
                }
              </span>
            </p>
          </div>
        ...
        <section className="max-w-5xl mx-auto px-4 py-10">
          ...
          <div className="overflow-x-auto">
            <table className="w-full bg-white rounded-xl shadow-sm border border-sand-200 overflow-hidden">
              <thead>
                <tr className="bg-sand-50 border-b border-sand-300">
                  <th className="text-left p-4 font-semibold text-charcoal-900">Poste</th>
                  <th className="text-left p-4 font-semibold text-charcoal-900">Investissement</th>
                  <th className="text-left p-4 font-semibold text-charcoal-900">Économie / an</th>
                  <th className="text-left p-4 font-semibold text-charcoal-900">
              ...
              <tbody>
                {roiParPoste.map((item, i) => (
                  <tr key={item.poste} className={i % 2 === 0 ? 'bg-white' : 'bg-sand-50/50'}>
                    <td className="p-4 font-semibold text-charcoal-900 text-sm">{item.poste}</td>
                    <td className="p-4 text-sm text-charcoal-600">{item.investissement}</td>
                    <td className="p-4 text-green-700 font-semibold text-sm">{item.economieAn}</td>
                    <td className="p-4 text-primary-600 font-semibold text-sm">{item.roi}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          </div>
          <p className="text-charcoal-500 text-sm mt-4 text-center">
            {
            ...
            {services.map((s) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="font-semibold text-charcoal-900 group-hover:text-green-700 transition-colors">
                    {s.label}
                  </span>
        ...
        <section className="max-w-5xl mx-auto px-4 py-10">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <Link
              ...
              className="group bg-white rounded-xl border border-sand-200 p-5 hover:shadow-md hover:border-green-200 transition-all"
            >
              <h3 className="font-semibold text-charcoal-900 group-hover:text-green-600 transition-colors mb-1">
                {"MaPrimeRénov' 2026"}
              </h3>
              <p className="text-sm text-charcoal-500">
                {'Montants, conditions et démarches détaillées.'}
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Comment vérifier la certification et trouver un pro.'}
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Toutes les aides cumulables pour vos travaux.'}
              </p>
            </Link>
          </div>
        </section>
        ...
        <RgeGuideBlock variant="generic" title="Artisans RGE pour votre rénovation énergétique" />
