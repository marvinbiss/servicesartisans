  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-teal-50/60 to-white">
        ...
        {/* Obligation légale */}
        <section className="max-w-5xl mx-auto px-4 py-10">
          <div className="bg-gradient-to-br from-teal-600 to-accent-700 rounded-2xl p-8 md:p-10 text-white">
        ...
        <section className="max-w-5xl mx-auto px-4 py-12">
          <div className="bg-gradient-to-r from-teal-600 to-accent-600 rounded-2xl p-8 md:p-12 text-center text-white">
