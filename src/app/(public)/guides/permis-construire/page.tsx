      ...
      <div className="min-h-screen bg-sand-50">
        ...
        <div className="bg-white border-b">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <Breadcrumb
              items={[{ label: 'Guides', href: '/guides' }, { label: 'Permis de Construire' }]}
            />
          </div>
        </div>
        ...
        <div className="bg-gradient-to-b from-primary-50 to-sand-50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
            <div className="flex items-center gap-2 text-sm text-primary-500 font-medium mb-4">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <nav className="bg-white rounded-xl border border-sand-300 p-6 mb-10">
            ...
            <ol className="space-y-2 text-sm">
              {[
                ...
                <li
                  key={i}
                  className="flex items-center gap-2 text-charcoal-600 hover:text-primary-500"
                >
          ...
          <section className="mb-12">
            ...
            <div className="bg-white rounded-xl border border-sand-300 p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {[
                  {
                    title: 'Extension de 5 à 20 m²',
                    desc: 'En zone sans PLU, ou de 5 à 40 m² en zone PLU (si surface totale < 150 m²)',
                  },
                  {
                    title: 'Modification de façade',
                    desc: 'Changement de fenêtres, de matériaux, de couleur de façade ou de toiture',
                  },
                  {
                    title: 'Construction légère',
                    desc: 'Piscine de 10 à 100 m², mur de plus de 2 m, clôture en secteur protégé',
                  },
                  {
                    title: 'Changement de destination',
                    desc: 'Sans modification de structure porteuse ni de façade (ex : bureau en chambre)',
                  },
                ].map((item) => (
                  <div
                    key={item.title}
                  ...
                  >
                    ...
                    <div>
                      <h3 className="font-medium text-charcoal-900 text-sm">{item.title}</h3>
                      <p className="text-xs text-charcoal-600 mt-1">{item.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-white rounded-xl border border-sand-300 p-6">
              ...
              <div className="mt-4 p-3 bg-green-50 rounded-lg">
                <p className="text-sm text-green-800">
                  ...
                  {
                    ' en secteur protégé (site classé, abords de monument historique, secteur sauvegardé), même les travaux dispensés de formalités en zone ordinaire peuvent nécessiter une autorisation. Renseignez-vous auprès de votre mairie.'
                  }
                </p>
              </div>
            </div>
              ...
              <div className="space-y-3">
                {documentsRequis.map((doc) => (
                  <div key={doc.code} className="flex items-start gap-3 p-3 bg-sand-50 rounded-lg">
                    <span className="inline-flex items-center justify-center min-w-[60px] h-7 bg-primary-100 text-primary-600 text-xs font-mono font-semibold rounded">
                      {doc.code}
                    </span>
                    <span className="text-sm text-charcoal-700">{doc.label}</span>
                  </div>
                ))}
              </div>
              <p className="text-sm text-charcoal-500 mt-4">
          ...
          <section className="mb-12">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-charcoal-900">{'Délais et procédure'}</h2>
            </div>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-sand-200">
                      {[
                        {
                          poste: 'Architecte (si obligatoire, > 150 m²)',
                          cout: '5 % à 12 % des travaux',
                        },
                        ...
                        <tr key={row.poste}>
                          <td className="py-3 px-4 text-charcoal-700">{row.poste}</td>
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              >
                ...
                <p className="text-sm text-charcoal-500">
                  {'Guide et formulaire pour les travaux de 5 à 20 m².'}
                </p>
              </Link>
              <Link
