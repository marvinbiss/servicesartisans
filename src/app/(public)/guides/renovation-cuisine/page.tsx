...
const prixParPoste = [
  {
    ...
    detail:
      'Entrée de gamme (mélaminé, caissons 16 mm) : 2 000-4 000 €. Milieu de gamme (laqué, soft-close) : 4 000-8 000 €. Premium (bois massif, veinage apparent) : 8 000-15 000 €.',
    icon: LayoutGrid,
  },
  {
    ...
    detail:
      'Stratifié (500-1 000 €), quartz (1 500-3 000 €), granit (2 000-4 000 €), céramique grand format (2 500-5 000 €). Prix pour 3 mètres linéaires, fourni posé.',
    icon: Hammer,
  },
  {
    ...
    detail:
      'Pack essentiel (four + plaque + hotte) : 1 000-2 500 €. Milieu de gamme + lave-vaisselle + réfrigérateur : 3 000-5 000 €. Premium (induction, pyrolyse, tiroir chauffant) : 5 000-8 000 €.',
    icon: Zap,
  },
  {
    poste: 'Plomberie',
    ...
    detail:
      "Raccordement évier et lave-vaisselle, robinetterie avec douchette extractible. Plus cher si déplacement de l'évier ou création d'un îlot avec arrivée d'eau.",
    icon: Wrench,
  },
  {
    poste: 'Électricité',
    ...
    detail:
      'Mise aux normes, circuit 32A dédié plaque, prises plan de travail, éclairage LED. Ajoutez 300-500 € pour une hotte en évacuation extérieure (gaine + percement).',
    icon: Zap,
  },
  {
    poste: 'Crédence',
    ...
    detail:
      'Verre laqué (200-600 €), carrelage métro (300-800 €), inox brossé (400-1 000 €), pierre naturelle (800-2 000 €). Prix pour environ 2 m².',
    icon: Home,
  },
]
...
const budgetTotal = [
  {
    ...
    prix: '3 000 – 6 000 €',
    description:
      "Repeindre les façades, changer les poignées, nouvelle crédence, remplacement de la robinetterie et de l'éclairage. Pas de changement de meubles.",
  ...
  },
  {
    ...
    prix: '8 000 – 20 000 €',
    description:
      'Nouveaux meubles, plan de travail, électroménager, plomberie/électricité aux normes, crédence, sol. La fourchette la plus courante en France.',
  ...
  },
  {
    ...
    prix: '20 000 – 50 000 €',
    description:
      'Cuisine sur-mesure en bois massif, électroménager haut de gamme, îlot central avec cuisson et rangement, domotique, éclairage architectural.',
...
const typesImplantation = [
  {
    type: 'Linéaire (I)',
    description:
      'Tous les éléments sur un seul mur. Idéal pour les petites cuisines ou cuisines ouvertes. Longueur recommandée : 2,5 à 4 m.',
    ideal: 'Studios, petits appartements',
  },
  {
    type: 'En L',
    description:
      "Deux murs adjacents. L'implantation la plus polyvalente, qui respecte naturellement le triangle d'activité. Convient aux cuisines de 8-15 m².",
    ideal: 'Maisons, grands appartements',
  },
  {
    type: 'En U',
    description:
      "Trois murs utilisés. Maximum de rangement et de plan de travail. Nécessite une largeur de pièce d'au moins 2,4 m entre les deux rangées.",
    ideal: 'Cuisines fermées 10 m²+',
  },
  {
    type: 'Îlot central',
    description:
      "Un bloc central en plus des meubles muraux. Permet de cuisiner face aux invités. Nécessite au moins 12 m² et 90 cm de passage autour de l'îlot.",
    ideal: 'Grandes pièces de vie ouvertes',
  },
  {
    type: 'Parallèle (II)',
    description:
      "Deux rangées de meubles face à face. Très efficace pour le triangle d'activité. L'allée centrale doit mesurer 120 cm minimum.",
...
const materiauxPlanDeTravail = [
  {
    ...
    entretien: 'Facile',
    duree: '10-15 ans',
    note: 'Le plus économique. Large choix de décors. Sensible aux brûlures et aux rayures profondes.',
  },
  {
    materiau: 'Quartz (Silestone, Caesarstone)',
    prix: '200–500 €/ml',
    resistance: 'Très élevée',
    entretien: 'Très facile',
    duree: '25 ans+',
    note: 'Surface non poreuse, résistant aux taches. Le meilleur rapport qualité-prix en milieu de gamme.',
  },
  {
    materiau: 'Granit',
    prix: '250–600 €/ml',
    resistance: 'Très élevée',
    entretien: 'Facile (à traiter)',
    duree: '30 ans+',
    note: 'Pierre naturelle, chaque plan est unique. Nécessite un traitement hydrofuge tous les 2-3 ans.',
  },
  {
    ...
    entretien: 'Exigeant',
    duree: '15-20 ans',
    note: "Chêne, hêtre ou noyer. Chaleureux mais sensible à l'eau. Huilage régulier obligatoire.",
  },
  {
    materiau: 'Inox',
    prix: '300–700 €/ml',
    ...
    entretien: 'Moyen',
    duree: '25 ans+',
    note: 'Hygiénique et professionnel. Se raye facilement mais les rayures font partie du cachet.',
  },
  {
    materiau: 'Céramique (Dekton, Neolith)',
    prix: '350–800 €/ml',
    resistance: 'Extrême',
    entretien: 'Très facile',
    duree: '30 ans+',
    note: 'Résiste à la chaleur, aux UV, aux taches. Peut se poser en fine épaisseur (12 mm). Le plus résistant du marché.',
  },
]
...
const tendances2026 = [
  {
    ...
    description:
      "La verrière d'atelier permet de cloisonner visuellement sans fermer l'espace. Elle bloque les odeurs et le bruit tout en laissant passer la lumière.",
  },
  {
    title: 'Façades sans poignées',
    description:
      'Ouverture push-to-open ou gorge intégrée. Lignes épurées et nettoyage facilité. Associées aux couleurs mates (vert sauge, bleu nuit, terracotta).',
  },
  {
    title: 'Îlot multifonction',
    description:
      'Îlot avec cuisson, évier de préparation, rangement et coin repas intégré. Le cœur de la pièce de vie dans les maisons modernes.',
  },
  {
    title: 'Électroménager encastré invisible',
    description:
      "Réfrigérateur, lave-vaisselle et four intégrés derrière des façades identiques aux meubles. L'effet « tout intégré » pour une esthétique cohérente.",
  },
  {
    title: 'Matériaux naturels',
    description:
      'Bois, pierre, terrazzo, laiton brossé. Retour au naturel et aux matériaux durables, en opposition au tout-laqué des années précédentes.',
  },
]
...
const breadcrumbItems = [{ label: 'Guides', href: '/guides' }, { label: 'Rénovation cuisine' }]
            ...
            <ol className="space-y-6">
              {etapes.map((e) => (
                <li key={e.num} className="flex items-start gap-4">
                  <span className="bg-primary-100 text-primary-600 rounded-full w-10 h-10 flex items-center justify-center text-sm font-bold shrink-0">
                    {e.num}
                  </span>
                  <div>
                    <strong className="text-charcoal-900 text-lg">{e.title}</strong>
                    <p className="mt-1 text-charcoal-600">{e.description}</p>
                  </div>
                </li>
              ))}
            </ol>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-charcoal-900">{p.poste}</h3>
                      <span className="text-primary-600 font-semibold text-sm">{p.fourchette}</span>
                    </div>
                  </div>
                  <p className="text-charcoal-600 text-sm">{p.detail}</p>
                </div>
              )
            })}
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {typesImplantation.map((t) => (
              <div
                ...
                className="bg-white rounded-xl shadow-sm border border-sand-200 p-6"
              >
                <h3 className="text-lg font-bold text-charcoal-900 mb-2">{t.type}</h3>
                <p className="text-charcoal-600 text-sm mb-3">{t.description}</p>
                <span className="inline-block bg-primary-50 text-primary-600 text-xs font-medium px-3 py-1 rounded-full">
                  {t.ideal}
                </span>
              </div>
            ))}
            ...
            <table className="w-full bg-white rounded-xl shadow-sm border border-sand-200 overflow-hidden">
              <thead>
                <tr className="bg-sand-50 border-b border-sand-300">
                  <th className="text-left p-4 font-semibold text-charcoal-900">Matériau</th>
                  <th className="text-left p-4 font-semibold text-charcoal-900">Prix / ml</th>
                  <th className="text-left p-4 font-semibold text-charcoal-900">Résistance</th>
                  <th className="text-left p-4 font-semibold text-charcoal-900">Entretien</th>
                  <th className="text-left p-4 font-semibold text-charcoal-900">Durée de vie</th>
                </tr>
              </thead>
              <tbody>
                {materiauxPlanDeTravail.map((m, i) => (
                  <tr key={m.materiau} className={i % 2 === 0 ? 'bg-white' : 'bg-sand-50/50'}>
                    <td className="p-4">
                      <span className="font-semibold text-charcoal-900">{m.materiau}</span>
                      <p className="text-xs text-charcoal-500 mt-1">{m.note}</p>
                    </td>
                    <td className="p-4 text-primary-600 font-semibold text-sm">{m.prix}</td>
                    <td className="p-4 text-sm text-charcoal-600">{m.resistance}</td>
                    <td className="p-4 text-sm text-charcoal-600">{m.entretien}</td>
                    <td className="p-4 text-sm text-charcoal-600">{m.duree}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {tendances2026.map((t) => (
              <div
                ...
                className="bg-white rounded-xl shadow-sm border border-sand-200 p-6"
              >
                <h3 className="text-lg font-bold text-charcoal-900 mb-2">{t.title}</h3>
                <p className="text-charcoal-600 text-sm">{t.description}</p>
              </div>
            ))}
          </div>
        </section>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Étapes, prix et conseils pour votre salle de bain.'}
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Guide complet : isolation, chauffage, aides 2026.'}
              </p>
            </Link>
            <Link
