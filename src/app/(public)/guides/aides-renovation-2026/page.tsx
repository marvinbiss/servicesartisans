...
const aides = [
  {
    ...
    conditions:
      'Résidence principale > 15 ans, gain de 2 classes DPE minimum, audit énergétique obligatoire',
    cumulable: 'CEE, éco-PTZ, chèque énergie',
    lien: '/guides/maprimerenov-2026',
    couleur: 'bg-primary-50 text-primary-600 border-primary-200',
  },
  {
    ...
    conditions:
      'Résidence principale > 15 ans (2 ans pour les chaudières gaz), artisan RGE obligatoire',
    cumulable: 'CEE, éco-PTZ, chèque énergie',
    lien: '/guides/maprimerenov-2026',
    couleur: 'bg-primary-50 text-primary-600 border-primary-200',
  },
  ...
  },
  {
    ...
    conditions:
      'Logement > 2 ans, résidence principale, sans condition de revenus, durée max 20 ans',
  ...
  },
  {
    ...
    conditions:
      'Logement > 2 ans, travaux de rénovation énergétique, appliquée directement sur la facture',
  ...
  },
  {
    ...
    montant: '48 à 277 €/an',
    conditions:
      'Envoyé automatiquement selon le revenu fiscal de référence, sans démarche nécessaire',
    cumulable: 'Toutes les autres aides',
    lien: null,
  ...
  },
  {
    ...
    conditions:
      "Dépendent de chaque région, département ou commune. Consultez l'ANIL ou votre mairie.",
...
const breadcrumbItems = [{ label: 'Guides', href: '/guides' }, { label: 'Aides rénovation 2026' }]
            ...
            <table className="w-full bg-white rounded-2xl shadow-sm border border-sand-200 overflow-hidden">
              <thead>
                <tr className="bg-sand-50 border-b border-sand-300">
                  <th className="text-left px-6 py-4 font-bold text-charcoal-900">Aide</th>
                  <th className="text-left px-6 py-4 font-bold text-charcoal-900">Montant max</th>
                  <th className="text-left px-6 py-4 font-bold text-charcoal-900">
              ...
              <tbody>
                {aides.map((aide, index) => {
                  ...
                  return (
                    <tr
                      key={index}
                      className="border-b border-sand-200 last:border-0 hover:bg-sand-50/50"
                    >
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <div
                            className={`w-9 h-9 rounded-lg flex items-center justify-center ${aide.couleur.split(' ')[0]}`}
                          >
                          ...
                          {aide.lien ? (
                            ...
                            <span className="font-semibold text-charcoal-900">{aide.nom}</span>
                          )}
                        </div>
                      </td>
                      <td className="px-6 py-4 font-bold text-charcoal-900">{aide.montant}</td>
                      <td className="px-6 py-4 text-charcoal-600 text-sm">{aide.conditions}</td>
                      <td className="px-6 py-4 text-charcoal-600 text-sm">{aide.cumulable}</td>
                    </tr>
                  )
                })}
              </tbody>
              ...
              return (
                <div key={index} className={`rounded-xl border p-5 ${aide.couleur}`}>
                  ...
                  <div className="space-y-2 text-sm">
                    <p>
                      <span className="font-semibold">Montant :</span> {aide.montant}
                    </p>
                    <p>
                      <span className="font-semibold">Conditions :</span> {aide.conditions}
                    </p>
                    <p>
                      <span className="font-semibold">Cumulable avec :</span> {aide.cumulable}
                    </p>
                  </div>
                </div>
              )
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-sand-200 p-8">
            <div className="grid md:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <h3 className="font-bold text-charcoal-900 mb-2">{"MaPrimeRénov'"}</h3>
                <p className="text-sm text-charcoal-600">
                  {'Déposez votre dossier sur maprimerenov.gouv.fr avant le début des travaux'}
                </p>
              </div>
              <div className="text-center">
                ...
                <h3 className="font-bold text-charcoal-900 mb-2">Prime CEE</h3>
                <p className="text-sm text-charcoal-600">
                  {
                    "Signez l'offre CEE avec un fournisseur d'énergie avant d'accepter le devis de l'artisan"
                  }
                </p>
              </div>
              <div className="text-center">
                ...
                <h3 className="font-bold text-charcoal-900 mb-2">Éco-PTZ</h3>
                <p className="text-sm text-charcoal-600">
                  {"Demandez l'éco-PTZ à votre banque pour financer le reste à charge à taux zéro"}
                </p>
              </div>
              <div className="text-center">
                ...
                <h3 className="font-bold text-charcoal-900 mb-2">TVA 5,5 %</h3>
                <p className="text-sm text-charcoal-600">
                  {"Automatiquement appliquée par l'artisan sur la facture des travaux éligibles"}
                </p>
              </div>
            </div>
            <div className="mt-8 p-4 bg-primary-50 rounded-xl flex items-start gap-3">
              ...
              <p className="text-sm text-primary-800">
                ...
                {
                  "La demande de CEE doit être faite avant la signature du devis. La demande MaPrimeRénov' doit être déposée avant le début des travaux. L'éco-PTZ peut être demandé jusqu'à 6 mois après la fin des travaux."
                }
              </p>
            </div>
          </div>
        ...
        <section className="max-w-6xl mx-auto px-4 py-10">
          ...
          <div className="bg-gradient-to-br from-primary-500 to-primary-600 rounded-2xl p-8 md:p-10 text-white">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between py-3 border-b border-primary-400/40">
                <span className="text-primary-100 text-lg">{'Coût total des travaux'}</span>
              ...
              <div className="flex items-center justify-between py-4 bg-white/10 rounded-xl px-4 mt-2">
                ...
                <div className="text-right">
                  ...
                  <span className="block text-sm text-primary-100">
                    financé à taux zéro sur 20 ans
                  </span>
                </div>
              </div>
            </div>
        ...
        <section className="max-w-6xl mx-auto px-4 py-10">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl shadow-sm border border-sand-200 p-6">
              ...
              <h3 className="text-lg font-bold text-charcoal-900 mb-2">Résidence principale</h3>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-sand-200 p-6">
              ...
              <h3 className="text-lg font-bold text-charcoal-900 mb-2">Ancienneté du logement</h3>
              <p className="text-charcoal-600">
                {
            ...
            <div className="bg-white rounded-xl shadow-sm border border-sand-200 p-6">
              ...
              <h3 className="text-lg font-bold text-charcoal-900 mb-2">Conditions de revenus</h3>
              <p className="text-charcoal-600">
                {
