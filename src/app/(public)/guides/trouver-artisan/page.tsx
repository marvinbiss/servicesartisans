...
const breadcrumbItems = [{ label: 'Guides', href: '/guides' }, { label: 'Trouver un artisan' }]
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="text-lg font-bold text-charcoal-900">{item.name}</h3>
                  </div>
            ...
            <div className="space-y-6">
              {verificationsIndispensables.map((item, index) => (
                <div key={index} className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-charcoal-900 mb-1">{item.title}</h3>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {questionsAvantSignature.map((question, index) => (
                <div key={index} className="flex items-start gap-3">
                  ...
                  <span className="text-primary-50">{question}</span>
                </div>
              ))}
            </div>
          </div>
            ...
            {labels.map((label) => (
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="text-lg font-bold text-charcoal-900">{label.name}</h3>
                </div>
                <p className="text-charcoal-600">{label.description}</p>
              </div>
            ))}
          </div>
        </section>
              ...
              <div>
                ...
                <ul className="space-y-3 text-indigo-50">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      {
                        '14 jours de rétractation pour tout contrat signé hors établissement (à domicile, en ligne, par téléphone) — article L221-18 du Code de la consommation'
                      }
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      {
                        "Ce délai court à compter de la signature du devis. L'artisan ne peut pas commencer les travaux avant l'expiration du délai, sauf renonciation expresse et écrite de votre part."
                      }
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      {
                        "Attention : pas de droit de rétractation si vous avez sollicité l'artisan et signé le devis dans ses locaux professionnels."
                      }
                    </span>
                  </li>
                </ul>
              ...
              <div>
                ...
                <ul className="space-y-3 text-indigo-50">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      {
                        "Garantie de parfait achèvement : 1 an — l'artisan doit réparer tous les désordres signalés à la réception ou dans l'année qui suit"
                      }
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      {
                        'Garantie biennale : 2 ans — couvre les équipements dissociables (chaudière, volets, robinetterie)'
                      }
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-sand-200 p-8 md:p-10">
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-charcoal-900 mb-1">Dialogue direct</h3>
                  <p className="text-charcoal-600">
                    {
                      "Contactez l'artisan par écrit (email ou courrier) pour expliquer le problème et demander une solution. Conservez une copie de tous les échanges."
                    }
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-charcoal-900 mb-1">Mise en demeure</h3>
                  <p className="text-charcoal-600">
                    {
                      'Envoyez un courrier recommandé avec AR détaillant les manquements constatés et fixant un délai de 15 jours pour y remédier. Ce courrier constitue une preuve juridique.'
                    }
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-charcoal-900 mb-1">Médiation</h3>
                  <p className="text-charcoal-600">
                    {
                      'Saisissez le médiateur de la consommation. Depuis 2016, tout professionnel doit mentionner un médiateur sur ses documents (devis, factures, site web). La médiation est gratuite pour le consommateur.'
                    }
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-charcoal-900 mb-1">Signalement à la DGCCRF</h3>
                  <p className="text-charcoal-600">
                    {
                      'En cas de pratique frauduleuse, signalez sur SignalConso (signal.conso.gouv.fr) ou contactez la DGCCRF de votre département. Pour les litiges importants, un avocat ou une association de consommateurs (UFC-Que Choisir, CLCV) peut vous accompagner.'
                    }
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-charcoal-900 mb-1">Action en justice</h3>
                  <p className="text-charcoal-600">
                    {
                      "En dernier recours, saisissez le tribunal judiciaire (litige > 10 000 €) ou le tribunal de proximité (litige < 10 000 €). Pour les litiges inférieurs à 5 000 €, la procédure simplifiée ne nécessite pas d'avocat."
                    }
                  </p>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Les mentions obligatoires et comment bien comparer.'}
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Tout comprendre sur cette protection essentielle.'}
              </p>
            </Link>
            <Link
