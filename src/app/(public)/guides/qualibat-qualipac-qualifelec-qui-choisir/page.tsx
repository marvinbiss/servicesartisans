...
const qualifs = [
  {
    ...
    travaux: ["Isolation des combles, murs, planchers", "ITE (Isolation Thermique par l'Extérieur)", "Menuiseries extérieures performantes", "Couverture et toiture isolée", "Plâtrerie isolante ITI"],
    details:
  ...
  },
  {
    ...
    travaux: ["Pompe à chaleur air/eau", "Pompe à chaleur géothermique", "Pompe à chaleur hybride", "Chauffe-eau thermodynamique", "Climatisation réversible"],
    details:
  ...
  },
  {
    ...
    travaux: ["Chauffe-eau solaire individuel (CESI)", "Système solaire combiné (SSC)", "Solaire thermique collectif"],
    details:
  ...
  },
  {
    ...
    travaux: ["Panneaux photovoltaïques en toiture", "Ombrières photovoltaïques", "Solutions hybrides PV + autoconsommation"],
    details:
  ...
  },
  {
    ...
    travaux: ["Bornes de recharge IRVE", "Installations photovoltaïques", "Éclairage performant tertiaire", "Pilotage et domotique énergétique"],
    details:
  ...
  },
  {
    ...
    travaux: ["Poêle à bûches", "Poêle à granulés", "Chaudière biomasse individuelle", "Insert et foyer fermé bois"],
    details:
...
export default function QualificationsRgePage() {
  ...
  const articleSchema = {
    "@context": "https://schema.org",
    "@type": "Article",
    headline: "Qualibat, QualiPAC, Qualifelec, QualiSol : quelle qualification RGE choisir selon vos travaux ?",
    description:
      ...
      <div className="min-h-screen bg-gradient-to-b from-green-50/60 to-white">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-x-auto">
            <table className="w-full text-sm min-w-[700px]">
              <thead className="bg-gray-50">
                <tr>
                  <th className="text-left font-semibold text-gray-700 p-4">Qualification</th>
                  <th className="text-left font-semibold text-gray-700 p-4">Organisme</th>
                  <th className="text-left font-semibold text-gray-700 p-4">Domaine principal</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-t border-gray-100">
                  <td className="p-4 font-semibold text-gray-900">Qualibat RGE</td>
                  <td className="p-4 text-gray-600">Qualibat</td>
                  <td className="p-4 text-gray-600">Enveloppe du bâtiment : isolation, menuiseries, toiture, ITE</td>
                </tr>
                <tr className="border-t border-gray-100">
                  <td className="p-4 font-semibold text-gray-900">QualiPAC</td>
                  <td className="p-4 text-gray-600">Qualit&apos;EnR</td>
                  <td className="p-4 text-gray-600">Pompes à chaleur aérothermiques et géothermiques</td>
                </tr>
                <tr className="border-t border-gray-100">
                  <td className="p-4 font-semibold text-gray-900">QualiSol</td>
                  <td className="p-4 text-gray-600">Qualit&apos;EnR</td>
                  <td className="p-4 text-gray-600">Solaire thermique : chauffe-eau solaire, SSC</td>
                </tr>
                <tr className="border-t border-gray-100">
                  <td className="p-4 font-semibold text-gray-900">QualiPV</td>
                  <td className="p-4 text-gray-600">Qualit&apos;EnR</td>
                  <td className="p-4 text-gray-600">Photovoltaïque : panneaux solaires électriques</td>
                </tr>
                <tr className="border-t border-gray-100">
                  <td className="p-4 font-semibold text-gray-900">Qualifelec RGE</td>
                  <td className="p-4 text-gray-600">Qualifelec</td>
                  <td className="p-4 text-gray-600">Électricité performante, bornes de recharge, domotique</td>
                </tr>
                <tr className="border-t border-gray-100">
                  <td className="p-4 font-semibold text-gray-900">Qualibois</td>
                  <td className="p-4 text-gray-600">Qualit&apos;EnR</td>
                  <td className="p-4 text-gray-600">Poêles et chaudières biomasse</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section className="max-w-5xl mx-auto px-4 py-10">
          ...
          <div className="space-y-6">
            {qualifs.map((q) => {
              const Icon = q.icon
              return (
                <div key={q.nom} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
                  <div className="flex items-start gap-4 mb-4">
                    <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${q.couleur}`}>
                      <Icon className="w-6 h-6" />
                    </div>
                    <div>
                      <h3 className="text-xl font-bold text-gray-900">{q.nom}</h3>
                      <p className="text-sm text-gray-500">Délivrée par {q.organisme}</p>
                    </div>
                  </div>
                  <p className="text-gray-700 mb-4 leading-relaxed">{q.details}</p>
                  <div>
                    <div className="text-sm font-semibold text-gray-700 mb-2">Travaux couverts :</div>
        ...
        <section className="max-w-5xl mx-auto px-4 py-10">
          ...
          <div className="space-y-4">
            {cas.map((c) => (
              <div key={c.situation} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                <div className="font-bold text-gray-900 mb-2">{c.situation}</div>
          ...
          <div className="bg-gradient-to-br from-green-600 to-emerald-700 rounded-2xl p-8 md:p-10 text-white">
            ...
            <ul className="space-y-3 text-green-50 mb-6">
              <li className="flex items-start gap-3">
                ...
                <span><strong>Annuaire France Rénov&apos; (ADEME)</strong> — annuaire national de référence, mis à jour quotidiennement.</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 mt-0.5 shrink-0" />
                <span><strong>Sites des organismes</strong> : qualibat.com, qualit-enr.org, qualifelec.fr pour une vérification directe.</span>
              </li>
            </ul>
            <a
