...
const profilColors = [
  {
    nom: "MaPrimeRénov' Bleu",
    revenus: 'Ménages aux revenus très modestes',
    couleur: 'bg-primary-100 text-primary-800 border-primary-200',
  },
  {
    nom: "MaPrimeRénov' Jaune",
    revenus: 'Ménages aux revenus modestes',
    couleur: 'bg-yellow-100 text-yellow-800 border-yellow-200',
  },
  {
    nom: "MaPrimeRénov' Violet",
    revenus: 'Ménages aux revenus intermédiaires',
    couleur: 'bg-purple-100 text-purple-800 border-purple-200',
  },
  {
    nom: "MaPrimeRénov' Rose",
    revenus: 'Ménages aux revenus supérieurs',
    couleur: 'bg-pink-100 text-pink-800 border-pink-200',
  },
]
...
const travaux = [
  ...
  {
    categorie: 'Ventilation & audit',
    items: [
      'VMC double flux',
      'Audit énergétique RGE (préalable au parcours accompagné)',
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Guides', item: `${SITE_URL}/guides` },
      {
        '@type': 'ListItem',
        position: 3,
        name: "MaPrimeRénov' 2026 : critères RGE",
        item: PAGE_URL,
      },
    ],
  }
        ...
        <section className="max-w-5xl mx-auto px-4 py-10">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {travaux.map((t) => (
              ...
              >
                <h3 className="font-bold text-charcoal-900 mb-3">{t.categorie}</h3>
