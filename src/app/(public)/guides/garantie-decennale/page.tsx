...
const breadcrumbItems = [{ label: 'Guides', href: '/guides' }, { label: 'Garantie décennale' }]
            ...
            <div className="prose prose-lg max-w-none text-charcoal-700">
              ...
              <ul className="space-y-2 mt-4">
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-primary-500 mt-0.5 shrink-0" />
                  <span>
                    <strong>Obligation</strong> — imposée par la loi à tout constructeur (artisan,
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-primary-500 mt-0.5 shrink-0" />
                  <span>
                    <strong>Assurance</strong> — l{"'"}artisan doit souscrire une assurance RC
                    décennale avant le chantier
                  </span>
                </li>
              </ul>
            </div>
        ...
        <section className="max-w-5xl mx-auto px-4 py-10">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl shadow-sm border border-sand-200 p-6">
              ...
              <h3 className="text-lg font-bold text-charcoal-900 mb-2">10 ans ferme</h3>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-sand-200 p-6">
              ...
              <h3 className="text-lg font-bold text-charcoal-900 mb-2">Réception des travaux</h3>
              <p className="text-charcoal-600">
                {
            ...
            <div className="bg-white rounded-xl shadow-sm border border-sand-200 p-6">
              ...
              <h3 className="text-lg font-bold text-charcoal-900 mb-2">Autres garanties</h3>
              <p className="text-charcoal-600">
                {
              ...
              <div>
                ...
                <ul className="space-y-3 text-red-50">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      {
                        'Dommages purement esthétiques (fissures superficielles, défauts de peinture)'
                      }
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <ul className="space-y-3 text-red-50">
                  ...
                  <li className="flex items-start gap-3">
                    <AlertTriangle className="w-5 h-5 mt-0.5 shrink-0" />
                    <span>
                      {'Équipements dissociables (chaudière, volets) → garantie biennale'}
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <ol className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1">
                      {
                        "Prenez des photos, notez les dates d'apparition des désordres et conservez tous les documents (devis, factures, PV de réception)."
                      }
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1">
                      {
                        'Envoyez une lettre recommandée AR décrivant les désordres et demandant la réparation dans un délai raisonnable (15 à 30 jours).'
                      }
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1">
                      {
                        "Si l'artisan ne répond pas ou a cessé son activité, contactez directement son assureur. Les coordonnées figurent sur l'attestation décennale."
                      }
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1">
                      {
                        "L'assureur désigne un expert sous 60 jours. Si la responsabilité décennale est engagée, l'indemnisation couvre les travaux de réparation."
                      }
                    </p>
                  </div>
                </li>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Le complément indispensable de la décennale côté client.'}
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Comment comparer les devis et vérifier les assurances.'}
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Certification et vérification des professionnels.'}
              </p>
            </Link>
          </div>
        </section>
