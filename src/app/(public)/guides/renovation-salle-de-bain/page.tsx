...
const prixParPoste = [
  {
    ...
    detail:
      'Receveur extra-plat + paroi verre 8 mm + robinetterie encastrée. Le prix varie selon la taille et le type de colonne (thermostatique, effet pluie).',
    icon: Droplets,
  },
  {
    poste: 'Baignoire',
    ...
    detail:
      'Baignoire acrylique standard (800 €) à îlot en Solid Surface (3 000 €+). Ajoutez 300-600 € pour un tablier carrelé sur mesure.',
    icon: Home,
  },
  {
    poste: 'Meuble vasque',
    ...
    detail:
      'Meuble suspendu 60 cm avec vasque intégrée dès 300 €. Double vasque 120 cm en chêne massif + plan céramique : 1 200-2 000 €.',
    icon: Home,
  },
  {
    ...
    fourchette: '30 – 120 €/m²',
    detail:
      "Grès cérame standard 30-50 €/m², imitation bois 50-80 €/m², zellige ou pierre naturelle 80-120 €/m². Main-d'œuvre incluse.",
    icon: Hammer,
  },
  {
    ...
    detail:
      'Déplacement des arrivées et évacuations, remplacement des canalisations. Plus cher si modification du réseau principal.',
    icon: Wrench,
  },
  {
    poste: 'Électricité',
...
const budgetTotal = [
  {
    ...
    prix: '3 000 – 5 000 €',
    description:
      'Peinture, remplacement robinetterie, nouveau meuble vasque, accessoires. Pas de modification de plomberie.',
  ...
  },
  {
    ...
    prix: '8 000 – 15 000 €',
    description:
      'Dépose totale, nouvelle plomberie, carrelage sol et murs, douche italienne, meuble vasque, électricité aux normes.',
  ...
  },
  {
    ...
    prix: '15 000 – 30 000 €',
    description:
      'Matériaux premium (pierre naturelle, robinetterie design), douche XXL, double vasque, chauffage au sol, domotique.',
...
const tendances = [
  {
    ...
    description:
      'Receveurs de 120×90 cm minimum, voire walk-in sans porte avec paroi fixe en verre 10 mm. Le confort hôtelier à domicile.',
  },
  {
    title: 'Meuble vasque suspendu',
    description:
      "Facilite le nettoyage du sol, agrandit visuellement l'espace. Les tiroirs à sortie totale avec amortisseur sont devenus le standard.",
  },
  {
    title: 'Robinetterie noire mate',
    description:
      'Mitigeurs, douchettes et accessoires en noir mat ou gunmetal. Associés au carrelage clair, ils créent un contraste élégant et intemporel.',
  },
  {
    title: 'Carreaux grand format',
    description:
      'Dalles 60×120 ou 120×120 cm : moins de joints, aspect épuré, nettoyage facilité. Nécessitent un sol parfaitement plan (ragréage).',
  },
  {
    title: 'Niche encastrée',
    description:
      'Étagère intégrée dans le mur de la douche pour ranger shampoings et gels sans encombrer. Prévoir le renfort du mur à la construction.',
  },
]
              ...
              <div>
                ...
                <ul className="space-y-3 text-green-50">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      <strong>MaPrimeAdapt{"'"}</strong> — Jusqu{"'"}à 70 % des travaux (sous
                      conditions de revenus et d{"'"}âge/handicap)
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 mt-0.5 shrink-0" />
                    <span>
                      <strong>Crédit d{"'"}impôt autonomie</strong> — 25 % plafonné à 5 000 €
                      (personne seule) ou 10 000 € (couple)
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 mt-0.5 shrink-0" />
                    <span>
                      <strong>TVA à 5,5 %</strong> — Sur les équipements spécialement conçus pour
              ...
              <div>
                ...
                <ul className="space-y-3 text-green-50">
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 mt-0.5 shrink-0" />
                    <span>
                      <strong>TVA à 10 %</strong> — Pour tout logement achevé depuis plus de 2 ans
                      (au lieu de 20 %)
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 mt-0.5 shrink-0" />
                    <span>
                      <strong>Éco-PTZ</strong> — Si les travaux incluent un volet énergétique
                      (isolation, chauffe-eau thermodynamique)
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 mt-0.5 shrink-0" />
                    <span>
                      ...
                      des subventions pour la rénovation de l{"'"}habitat
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="max-w-5xl mx-auto px-4 py-10">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl shadow-sm border border-sand-200 p-6">
              ...
              <h3 className="text-lg font-bold text-charcoal-900 mb-2">Rafraîchissement</h3>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-sand-200 p-6">
              ...
              <h3 className="text-lg font-bold text-charcoal-900 mb-2">Rénovation complète</h3>
              <p className="text-2xl font-extrabold text-primary-600 mb-2">1 à 2 semaines</p>
              <p className="text-charcoal-600 text-sm">
                {
            ...
            <div className="bg-white rounded-xl shadow-sm border border-sand-200 p-6">
              ...
              <h3 className="text-lg font-bold text-charcoal-900 mb-2">Haut de gamme</h3>
          ...
          <div className="bg-gradient-to-br from-primary-500 to-primary-600 rounded-2xl p-8 md:p-10 text-white">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <ol className="space-y-3 text-primary-50">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      {
                        'Demandez au moins 3 devis détaillés (prix unitaires, pas un montant global)'
                      }
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      {
                        'Privilégiez un artisan qui se déplace pour voir les lieux avant de chiffrer'
                      }
                    </span>
                  </li>
                </ol>
              ...
              <div>
                ...
                <Link
                  href="/recherche"
                  className="inline-flex items-center gap-2 bg-white text-primary-600 px-5 py-2.5 rounded-lg font-semibold hover:bg-primary-50 transition-colors"
                >
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-sm text-charcoal-500">
                {'Étapes, prix et conseils pour rénover votre cuisine.'}
              </p>
            </Link>
            <Link
