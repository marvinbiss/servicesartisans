...
export const metadata: Metadata = {
  ...
  description:
    'Procédure de notification de violation de données personnelles conforme aux articles 33 et 34 du RGPD.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'ServicesArtisans — Violation de données',
      },
    ],
  },
  twitter: {
    ...
    <div className="min-h-screen bg-sand-50">
      ...
      <section className="bg-white border-b">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <Breadcrumb
            items={[{ label: 'Notification de violation de données' }]}
            className="mb-4"
          />
          <PageHeroH1 size="article">Notification de violation de données</PageHeroH1>
      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-xl shadow-sm p-8 prose prose-gray max-w-none">
            ...
            <p>
              Tout incident de sécurité entraînant la destruction, la perte, l&apos;altération, la
              divulgation non autorisée ou l&apos;accès non autorisé à des données personnelles.
            </p>
            ...
            <ol>
              ...
              <li>
                <strong>Remédiation :</strong> Correction de la faille, renforcement des mesures de
                sécurité, documentation complète de l&apos;incident.
              </li>
            </ol>

            <h2>4. Signaler une faille de sécurité</h2>
            <p>Si vous découvrez une faille de sécurité ou suspectez une violation de données :</p>
            <ul>
              <li>
                <strong>Email :</strong>{' '}
                <a
            ...
            <p>Nous nous engageons à accuser réception de votre signalement sous 24 heures.</p>

            <h2>5. Registre des violations</h2>
            <p>
              Conformément à l&apos;article 33.5 du RGPD, nous tenons un registre interne de toutes
              les violations de données, qu&apos;elles aient ou non été notifiées à la CNIL.
            </p>
