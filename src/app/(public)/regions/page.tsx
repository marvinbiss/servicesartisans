...
export const metadata: Metadata = {
  title: 'Artisans par région - Toutes les régions de France | ServicesArtisans',
...
const regions = [
  { name: 'Île-de-France', slug: 'ile-de-france', departments: ['Paris (75)', 'Seine-et-Marne (77)', 'Yvelines (78)', 'Essonne (91)', 'Hauts-de-Seine (92)', 'Seine-Saint-Denis (93)', 'Val-de-Marne (94)', 'Val-d\'Oise (95)'], population: '12,2 millions' },
  { name: 'Auvergne-Rhône-Alpes', slug: 'auvergne-rhone-alpes', departments: ['Ain (01)', 'Allier (03)', 'Ardèche (07)', 'Cantal (15)', 'Drôme (26)', 'Isère (38)', 'Loire (42)', 'Haute-Loire (43)', 'Puy-de-Dôme (63)', 'Rhône (69)', 'Savoie (73)', 'Haute-Savoie (74)'], population: '8,0 millions' },
  { name: 'Nouvelle-Aquitaine', slug: 'nouvelle-aquitaine', departments: ['Charente (16)', 'Charente-Maritime (17)', 'Corrèze (19)', 'Creuse (23)', 'Dordogne (24)', 'Gironde (33)', 'Landes (40)', 'Lot-et-Garonne (47)', 'Pyrénées-Atlantiques (64)', 'Deux-Sèvres (79)', 'Vienne (86)', 'Haute-Vienne (87)'], population: '6,0 millions' },
  { name: 'Occitanie', slug: 'occitanie', departments: ['Ariège (09)', 'Aude (11)', 'Aveyron (12)', 'Gard (30)', 'Haute-Garonne (31)', 'Gers (32)', 'Hérault (34)', 'Lot (46)', 'Lozère (48)', 'Hautes-Pyrénées (65)', 'Pyrénées-Orientales (66)', 'Tarn (81)', 'Tarn-et-Garonne (82)'], population: '5,9 millions' },
  { name: 'Hauts-de-France', slug: 'hauts-de-france', departments: ['Aisne (02)', 'Nord (59)', 'Oise (60)', 'Pas-de-Calais (62)', 'Somme (80)'], population: '6,0 millions' },
  { name: 'Provence-Alpes-Côte d\'Azur', slug: 'provence-alpes-cote-azur', departments: ['Alpes-de-Haute-Provence (04)', 'Hautes-Alpes (05)', 'Alpes-Maritimes (06)', 'Bouches-du-Rhône (13)', 'Var (83)', 'Vaucluse (84)'], population: '5,1 millions' },
  { name: 'Grand Est', slug: 'grand-est', departments: ['Ardennes (08)', 'Aube (10)', 'Marne (51)', 'Haute-Marne (52)', 'Meurthe-et-Moselle (54)', 'Meuse (55)', 'Moselle (57)', 'Bas-Rhin (67)', 'Haut-Rhin (68)', 'Vosges (88)'], population: '5,6 millions' },
  { name: 'Pays de la Loire', slug: 'pays-de-la-loire', departments: ['Loire-Atlantique (44)', 'Maine-et-Loire (49)', 'Mayenne (53)', 'Sarthe (72)', 'Vendée (85)'], population: '3,8 millions' },
  { name: 'Bretagne', slug: 'bretagne', departments: ['Côtes-d\'Armor (22)', 'Finistère (29)', 'Ille-et-Vilaine (35)', 'Morbihan (56)'], population: '3,4 millions' },
  { name: 'Normandie', slug: 'normandie', departments: ['Calvados (14)', 'Eure (27)', 'Manche (50)', 'Orne (61)', 'Seine-Maritime (76)'], population: '3,3 millions' },
  { name: 'Bourgogne-Franche-Comté', slug: 'bourgogne-franche-comte', departments: ['Côte-d\'Or (21)', 'Doubs (25)', 'Jura (39)', 'Nièvre (58)', 'Haute-Saône (70)', 'Saône-et-Loire (71)', 'Yonne (89)', 'Territoire de Belfort (90)'], population: '2,8 millions' },
  { name: 'Centre-Val de Loire', slug: 'centre-val-de-loire', departments: ['Cher (18)', 'Eure-et-Loir (28)', 'Indre (36)', 'Indre-et-Loire (37)', 'Loir-et-Cher (41)', 'Loiret (45)'], population: '2,6 millions' },
  { name: 'Corse', slug: 'corse', departments: ['Corse-du-Sud (2A)', 'Haute-Corse (2B)'], population: '340 000' },
]
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 text-center">
            <Link href="/departements" className="inline-flex items-center gap-2 px-6 py-3 bg-blue-50 text-blue-700 rounded-xl hover:bg-blue-100 font-medium transition-colors">
