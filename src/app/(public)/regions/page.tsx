      ...
      <section className="relative bg-charcoal-950 text-white overflow-hidden">
        <div className="absolute inset-0">
          <div
            ...
            style={{
              background:
                'radial-gradient(ellipse 80% 50% at 50% -10%, rgba(61,139,104,0.22) 0%, transparent 60%), radial-gradient(ellipse 60% 60% at 80% 110%, rgba(200, 73, 42,0.10) 0%, transparent 50%)',
            }}
          />
          <div
