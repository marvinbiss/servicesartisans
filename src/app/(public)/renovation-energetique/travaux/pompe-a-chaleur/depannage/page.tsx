    ...
    <>
      ...
      <div className="bg-sand-50 min-h-screen">
        <div className="max-w-3xl mx-auto px-4 py-8">
          ...
          <PrixComparatif
            title="Garanties & SAV 2026 : 5 marques de PAC"
            caption="La garantie constructeur conditionne le prix moyen d'un dépannage. Source : conditions générales constructeurs, retours SAV 2026."
            withSchema
            rows={[
              {
                ...
                rating: 4.5,
                notes: 'Garantie record marché, SAV France',
                highlight: true,
              },
              {
                brand: 'Daikin',
                ...
                warranty: '5 ans',
                rating: 4.5,
                notes: '600 techniciens SAV FR, pièces 10 ans',
              },
              {
                brand: 'Hitachi',
                model: 'Yutaki S',
              ...
              },
              {
                ...
                warranty: '2 – 5 ans',
                rating: 4.0,
                notes: 'Garantie variable selon installateur',
              },
              {
                brand: 'Daikin',
                ...
                warranty: '5 ans',
                rating: 4.5,
                notes: 'Hybride = double SAV (PAC + gaz)',
              },
            ]}
          />
          <SimulateurAideBox
