...
export const metadata: Metadata = {
  ...
  description: 'Exercez votre droit d\'opposition RGPD (Art. 21) ou votre droit à l\'effacement (Art. 17). Demandez la suppression de votre fiche artisan sur ServicesArtisans.',
  ...
  openGraph: {
    title: 'Droit d\'opposition - ServicesArtisans',
    description: 'Exercez votre droit d\'opposition RGPD. Demandez la suppression de votre fiche artisan.',
    url: `${SITE_URL}/droit-opposition`,
    type: 'website',
    images: [{ url: `${SITE_URL}/opengraph-image`, width: 1200, height: 630, alt: 'ServicesArtisans — Droit d\'opposition' }],
  },
  twitter: {
      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-xl shadow-sm p-8 prose prose-gray max-w-none">
            ...
            <h2>1. Vos droits</h2>
            <p>
              Conformément au Règlement Général sur la Protection des Données (RGPD), vous disposez notamment :
            </p>
            <ul>
              <li>
                <strong>Droit d&apos;opposition (Art. 21 RGPD) :</strong> vous pouvez vous opposer
                à tout moment au traitement de vos données personnelles lorsque ce traitement est
                fondé sur l&apos;intérêt légitime.
              </li>
              <li>
                <strong>Droit à l&apos;effacement (Art. 17 RGPD) :</strong> vous pouvez demander
            ...
            <p>
              ...
              repose sur notre intérêt légitime (Art. 6.1.f du RGPD). Les données proviennent
              de sources publiques, notamment les registres professionnels officiels (répertoire SIREN/SIRET).
            ...
            <p>
              ...
              bouton <strong>&laquo;&nbsp;Demander la suppression de cette fiche&nbsp;&raquo;</strong>.
              Un formulaire vous permettra de soumettre votre demande directement.
            </p>
            ...
            <p>
              Adressez votre demande par courrier à :
            </p>
            ...
            <ul>
              <li>
                <strong>Accusé de réception :</strong> sous 48 heures ouvrées à compter
                de la réception de votre demande.
              </li>
              <li>
                <strong>Traitement :</strong> sous 30 jours maximum, conformément à
                l&apos;article 12.3 du RGPD.
              </li>
              <li>
                <strong>Désindexation :</strong> dès réception de votre demande, nous ajoutons
                une directive <code>noindex</code> sur votre fiche pour demander aux moteurs
                de recherche de la retirer de leurs résultats.
              </li>
            </ul>
            ...
            <ol>
              <li>
                <strong>Désindexation immédiate :</strong> votre fiche est marquée <code>noindex</code> dès
                réception de la demande. Les moteurs de recherche cessent de l&apos;afficher
                dans leurs résultats.
              </li>
              <li>
                <strong>Désactivation de la fiche :</strong> après validation de votre identité,
                la fiche est désactivée et n&apos;apparaît plus sur le site.
              </li>
              <li>
                <strong>Conservation légale :</strong> conformément à nos obligations légales,
                les données sont conservées pendant 1 an à des fins de preuve, puis
