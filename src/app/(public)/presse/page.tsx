...
export const metadata: Metadata = {
  title: 'Espace presse',
  description:
    "Espace presse de ServicesArtisans : communiqués, kit média et contacts presse de l'annuaire d'artisans RGE certifiés en France.",
      ...
      <section className="relative bg-charcoal-950 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-28 md:pt-14 md:pb-36">
          ...
          <p className="text-xl text-charcoal-400 max-w-3xl">
            Retrouvez toutes les informations presse de ServicesArtisans, l'annuaire des artisans
            référencés SIREN en France.
          </p>
        </div>
      </section>
