...
// ---------------------------------------------------------------------------
// Static params: top 50 cities x 15 services = 750 pages
// ---------------------------------------------------------------------------

const tradeSlugs = getTradesSlugs()

// Parse population string like '2 104 000' into a number
...
export function generateStaticParams() {
  ...
  for (const service of tradeSlugs) {
    for (const ville of top10Cities) {
...
/** Regional pricing multiplier based on region name */
...
export default async function TarifsServiceVillePage({
  ...
  const breadcrumbSchema = getBreadcrumbSchema([
    ...
    { name: `Tarifs ${tradeLower}`, url: `/tarifs-artisans/${service}` },
    { name: villeData.name, url: `/tarifs-artisans/${service}/${villeSlug}` },
  ])
  ...
  // Related city links (other top cities for same service)
  const relatedCities = top10Cities
    .filter((v) => v.slug !== villeSlug)
    .slice(0, 6)

  // Related services for the same city
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-28 md:pt-14 md:pb-36">
          <Breadcrumb
            items={[
              ...
              { label: `Tarifs ${tradeLower}`, href: `/tarifs-artisans/${service}` },
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            ...
            {/* Number of artisans / competition */}
            <LocalFactorCard
      ...
      {/* Related: same service in other cities */}
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-3xl">
            {relatedCities.map((v) => (
              <Link
                key={v.slug}
                href={`/tarifs-artisans/${service}/${v.slug}`}
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
            {otherTrades.map((slug) => {
              ...
              return (
                <Link
                  key={slug}
                  href={`/tarifs-artisans/${slug}/${villeSlug}`}
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div>
              ...
              <div className="space-y-2">
                <Link href={`/tarifs-artisans/${service}`} className="block text-sm text-gray-600 hover:text-blue-600 py-1">
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                {otherTrades.slice(0, 3).map((slug) => (
                  <Link key={slug} href={`/tarifs-artisans/${slug}/${villeSlug}`} className="block text-sm text-gray-600 hover:text-blue-600 py-1">
