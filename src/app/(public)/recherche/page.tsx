...
export default function RecherchePage() {
  return (
    <div className="min-h-screen bg-sand-50">
      ...
      <section className="relative bg-gradient-to-br from-charcoal-900 via-primary-800 to-charcoal-900 text-white py-20">
        <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
          <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-primary-400 rounded-full blur-[150px] opacity-30" />
          <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] bg-primary-500 rounded-full blur-[150px] opacity-30" />
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {services.map((service) => (
              <Link
                ...
                className="bg-sand-50 hover:bg-primary-50 border border-sand-300 hover:border-primary-300 rounded-xl p-4 text-center transition-all group"
              >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {regions.map((region) => (
              <Link
                ...
                className="bg-sand-50 hover:bg-primary-50 border border-sand-300 hover:border-primary-300 rounded-xl p-4 transition-all group"
              >
                <div className="font-semibold text-charcoal-900 group-hover:text-primary-500 transition-colors">
                  {region.name}
                </div>
      ...
      <section className="py-16 bg-primary-500">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            href="/services"
            className="inline-flex items-center gap-2 bg-white text-primary-500 px-8 py-3 rounded-lg font-semibold hover:bg-primary-50 transition-colors"
          >
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              <h3 className="font-semibold text-charcoal-900 mb-4">Pages utiles</h3>
              <div className="space-y-2">
                <Link
                  href="/comment-ca-marche"
                  className="block text-sm text-charcoal-600 hover:text-primary-500 py-1 transition-colors"
                >
                  Comment ça marche
                </Link>
                <Link
