    ...
    <div className="min-h-screen bg-sand-50">
      ...
      <section className="relative bg-charcoal-950 text-white overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute inset-0" style={{
            background: 'radial-gradient(ellipse 80% 50% at 50% -10%, rgba(232,107,75,0.18) 0%, transparent 60%), radial-gradient(ellipse 60% 60% at 80% 110%, rgba(61,139,104,0.12) 0%, transparent 50%)',
          }} />
        ...
        <div className="relative max-w-6xl mx-auto px-4 pt-10 pb-28 md:pt-14 md:pb-36">
          ...
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary-400/15 backdrop-blur-sm rounded-full border border-primary-400/25 mb-6">
          ...
          <div className="flex flex-wrap justify-center gap-4 md:gap-6 mt-10">
            <div className="flex items-center gap-3 px-5 py-3 bg-white/10 backdrop-blur-sm rounded-xl border border-white/10">
              ...
              <div className="text-left">
                ...
                <div className="text-xs text-charcoal-400">Villes</div>
              </div>
            </div>
            <div className="flex items-center gap-3 px-5 py-3 bg-white/10 backdrop-blur-sm rounded-xl border border-white/10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {sortedRegions.map(([region, regionVilles]) => {
          ...
          return (
            <details key={region} id={`region-${regionId}`} className="mb-4 bg-white rounded-2xl border border-sand-300 shadow-soft group">
              <summary className="flex items-center gap-3 p-4 cursor-pointer list-none select-none hover:bg-sand-50 rounded-2xl transition-colors">
                <Building2 className="w-5 h-5 text-accent-500 flex-shrink-0" />
                <h3 className="font-heading text-base font-bold text-charcoal-900 tracking-tight">{region}</h3>
                <span className="text-sm text-charcoal-500 font-medium">({regionVilles.length} villes)</span>
                <ChevronRight className="w-4 h-4 text-charcoal-400 ml-auto group-open:rotate-90 transition-transform" />
              </summary>
                  ...
                  {regionVilles.map((ville, i) => (
                    <span key={ville.slug}>
                      <Link
                        ...
                        className="text-sm text-charcoal-600 hover:text-primary-400 hover:underline transition-colors"
                      >
                        {ville.name}
                      </Link>
      ...
      <section className="py-16 bg-white border-t border-sand-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {/* Regions */}
            <div>
              <h3 className="text-sm font-semibold text-charcoal-900 uppercase tracking-wider mb-4">Par région</h3>
            ...
            {/* Departements */}
            <div>
              <h3 className="text-sm font-semibold text-charcoal-900 uppercase tracking-wider mb-4">Par département</h3>
              <div className="space-y-2">
