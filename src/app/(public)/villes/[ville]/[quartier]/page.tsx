    ...
    <div className="min-h-screen bg-sand-50">
      ...
      <section className="relative bg-charcoal-950 text-white overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div
            ...
            style={{
              background:
                'radial-gradient(ellipse 80% 50% at 50% -10%, rgba(61,139,104,0.18) 0%, transparent 60%), radial-gradient(ellipse 60% 60% at 80% 110%, rgba(200, 73, 42,0.10) 0%, transparent 50%), radial-gradient(ellipse 50% 40% at 10% 90%, rgba(61,139,104,0.06) 0%, transparent 50%)',
            }}
          />
          <div
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="bg-white rounded-2xl border border-sand-300 p-6">
            <div className="grid md:grid-cols-3 gap-6 mb-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-charcoal-900">Type de bâti</p>
                  <p className="text-sm text-charcoal-500">{content.profile.eraLabel}</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-charcoal-900">Densité urbaine</p>
                  <p className="text-sm text-charcoal-500">{content.profile.densityLabel}</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 bg-primary-100 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <div>
                  ...
                  <p className="text-sm text-charcoal-500">{ville.population} habitants</p>
                </div>
              </div>
            </div>
                ...
                {(() => {
                  ...
                  return selected.map((issue, i) => (
                    <li key={i} className="flex items-start gap-2 text-sm text-charcoal-600">
                      <Wrench className="w-3.5 h-3.5 text-accent-500 mt-0.5 flex-shrink-0" />
                      {issue}
                    </li>
                  ))
                })()}
        ...
        <section className="mb-16 prose prose-slate max-w-none">
          ...
          <p className="text-charcoal-600 leading-relaxed">{content.servicesDemandes}</p>

          <h3 className="font-heading text-xl font-semibold text-charcoal-900 tracking-tight mt-8">
            Conseils pour vos travaux à {quartierName}
          </h3>
          <p className="text-charcoal-600 leading-relaxed">{content.conseils}</p>

          <h3 className="font-heading text-xl font-semibold text-charcoal-900 tracking-tight mt-8">
            Pourquoi choisir un artisan proche de {quartierName} ?
          </h3>
          <p className="text-charcoal-600 leading-relaxed">{content.proximite}</p>
        </section>
          ...
          <section className="mb-16 space-y-8">
            ...
            <div className="bg-gradient-to-br from-amber-50/50 to-orange-50/30 rounded-2xl border border-amber-100 p-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-heading text-xl font-semibold text-charcoal-900 tracking-tight">
          ...
          <div className="bg-sand-100 rounded-2xl border border-sand-300 p-6">
            ...
            {content.dataDriven?.dataSources && content.dataDriven.dataSources.length > 0 && (
              <p className="text-xs text-charcoal-400 mt-2">
                <strong className="text-charcoal-500">Sources :</strong>{' '}
          ...
          <section className="mb-16">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-charcoal-500">{quartiers.length} autres quartiers</p>
              </div>
            </div>
            <div className="bg-white rounded-2xl border border-sand-300 p-6">
        ...
        <section className="mb-16">
          ...
          <div className="space-y-4">
            {content.faqItems.map((item) => (
              <div key={item.question} className="bg-white rounded-2xl border border-sand-300 p-6">
                <h3 className="font-semibold text-charcoal-900 mb-2">{item.question}</h3>
                <p className="text-sm text-charcoal-600 leading-relaxed">{item.answer}</p>
              </div>
            ))}
          </div>
        </section>
