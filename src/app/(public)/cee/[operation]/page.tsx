    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
        ...
        <dl className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-5 text-sm mt-8 rounded-2xl border border-emerald-100 bg-emerald-50/50 p-6">
          <div>
            <dt className="font-semibold text-gray-900">Code officiel</dt>
            <dd className="text-gray-700">{operation.code}</dd>
          </div>
          <div>
            <dt className="font-semibold text-gray-900">Secteur</dt>
            <dd className="text-gray-700">Résidentiel</dd>
          </div>
          <div>
            <dt className="font-semibold text-gray-900">Domaine</dt>
            <dd className="text-gray-700">{domaineInfo?.label || operation.domaine}</dd>
          </div>
          {operation.unite_mesure && (
            <div>
              <dt className="font-semibold text-gray-900">Unité de mesure</dt>
          ...
          <div>
            <dt className="font-semibold text-gray-900">&Eacute;ligibilité</dt>
            <dd className="text-gray-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {sameDomain.map((op) => (
              ...
              >
                ...
                <div className="font-bold text-slate-900 text-lg mt-1 group-hover:text-emerald-700 transition">
                  {op.nom}
                </div>
