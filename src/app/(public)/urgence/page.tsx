...
export const metadata: Metadata = {
  title: 'Artisans d\'urgence 24h/24 - Plombier, Électricien, Serrurier | ServicesArtisans',
  description:
    'Besoin d\'un artisan en urgence ? Plombier, électricien, serrurier, chauffagiste, vitrier — intervention rapide 24h/24, 7j/7, week-ends et jours fériés.',
  alternates: {
    canonical: 'https://servicesartisans.fr/urgence',
  },
  openGraph: {
    title: 'Artisans d\'urgence 24h/24 | ServicesArtisans',
    description:
      'Intervention rapide d\'artisans qualifiés : plombier, électricien, serrurier, chauffagiste, vitrier. Disponibles 24h/24, 7j/7.',
    url: 'https://servicesartisans.fr/urgence',
  },
}
...
export default function UrgencePage() {
  const breadcrumbItems = [{ label: 'Urgences' }]
      ...
      <div className="bg-gradient-to-r from-red-600 to-red-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <Breadcrumb
            ...
            className="mb-4 text-red-200 [&_a]:text-red-200 [&_a:hover]:text-white [&_svg]:text-red-300 [&>span]:text-white"
          />
          ...
          <div className="bg-white rounded-xl p-4 md:p-6 max-w-2xl">
            <h2 className="text-gray-900 font-semibold mb-4">Appelez un artisan d&apos;urgence</h2>
