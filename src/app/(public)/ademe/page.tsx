...
export default async function AdemePage() {
  ...
  return (
    <>
      ...
      {/* Hero */}
      <section className="relative bg-gradient-to-br from-slate-800 via-slate-900 to-emerald-950 text-white py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <p className="text-lg md:text-xl text-slate-200 max-w-3xl leading-relaxed">
            {hasStats ? (
              <>
                ...
                référencés sur ServicesArtisans, synchronisés chaque semaine
                depuis le référentiel officiel France Rénov&apos; publié en
                open data par l&apos;ADEME.
              </>
            ) : (
              <>
                Toutes les données d&apos;artisans RGE affichées sur notre site
                proviennent directement du référentiel officiel France
                Rénov&apos; publié en open data par l&apos;ADEME, synchronisé
                chaque semaine.
              </>
            )}{' '}
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white text-slate-900 font-semibold shadow-lg hover:bg-slate-100 transition"
            >
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10 grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="text-sm text-slate-600 mt-2 leading-relaxed">
              Entreprises RGE uniques recensées en France dans le référentiel
              ADEME.
            </div>
          </div>
          <div>
            ...
            <div className="text-sm text-slate-600 mt-2 leading-relaxed">
              Qualifications RGE actives (une entreprise peut en cumuler
              plusieurs).
            </div>
          </div>
          <div>
            ...
            <div className="text-sm text-slate-600 mt-2 leading-relaxed">
              Fréquence de notre synchronisation avec le référentiel officiel
              ADEME.
            </div>
          </div>
          <div>
            ...
            <div className="text-sm text-slate-600 mt-2 leading-relaxed">
              Organismes certificateurs accrédités COFRAC : Qualibat,
      ...
      <section className="bg-white border-b border-slate-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-14">
          ...
          <div className="space-y-5 text-slate-700 leading-relaxed">
            <p>
              L&apos;<strong>ADEME</strong> — Agence de l&apos;Environnement et
              de la Maîtrise de l&apos;Énergie — est un établissement public à
              caractère industriel et commercial (EPIC) placé sous la tutelle
              conjointe des ministères de la Transition écologique et de la
              Recherche. Créée en 1991 par la fusion de trois agences
              préexistantes, elle emploie environ 1 100 agents et dispose
              d&apos;un budget annuel de plusieurs milliards d&apos;euros
              dédiés à la transition énergétique.
            </p>
            <p>
              Son rôle en matière de rénovation énergétique résidentielle est
              central : elle pilote pour le compte de l&apos;État le
              référentiel officiel des entreprises titulaires d&apos;une
              qualification RGE (Reconnu Garant de l&apos;Environnement), qui
              conditionne l&apos;accès à l&apos;ensemble des aides publiques
              majeures — <strong>MaPrimeRénov&apos;</strong> (Anah),{' '}
              <strong>Certificats d&apos;Économies d&apos;Énergie (CEE)</strong>,{' '}
              <strong>TVA réduite à 5,5 %</strong>, <strong>Éco-PTZ</strong>.
              Ce référentiel est accessible au grand public sur{' '}
              <a
            ...
            <p>
              ...
              <strong>aucune aide publique n&apos;est mobilisable</strong>.
              C&apos;est cette règle simple qui fait de la vérification RGE la
              première étape incontournable de tout projet de rénovation
              énergétique sérieux en France.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-slate-50 border-y border-slate-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-14">
          ...
          <div className="space-y-5 text-slate-700 leading-relaxed">
            <p>
              Le jeu de données « <strong>Annuaire des entreprises RGE</strong> »
              publié par l&apos;ADEME sur{' '}
              <a
              ...
              est la source légale unique pour vérifier qu&apos;une entreprise
              du bâtiment est bien titulaire d&apos;une qualification RGE
              active. Ce fichier contient environ{' '}
              <strong>165 000 lignes</strong> correspondant à ~60 000
              entreprises uniques — une entreprise pouvant cumuler plusieurs
              qualifications (Qualibat + QualiPAC + Qualifelec par exemple).
            </p>
            <p>
              Chaque ligne du référentiel comprend : le SIRET de
              l&apos;entreprise, sa raison sociale, son adresse, le code de la
              qualification (ex. 7143 pour l&apos;ITE, 8611 pour les pompes à
              chaleur), le domaine de travaux couvert, la date de début et de
              fin de validité de la mention, et l&apos;organisme certificateur
              qui l&apos;a délivrée (Qualibat, Qualit&apos;EnR, Qualifelec,
              Certibat). L&apos;ADEME met ce fichier à jour quotidiennement au
              rythme des qualifications délivrées et révoquées.
            </p>
            <p>
              Le référentiel est publié sous{' '}
              <strong>Licence Ouverte 2.0 (Etalab)</strong>, ce qui autorise sa
              réutilisation libre à des fins commerciales ou non, à condition
              de mentionner la source. C&apos;est ce cadre légal qui permet à
              ServicesArtisans de construire son annuaire RGE en toute
      ...
      <section className="bg-white border-b border-slate-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-14">
          ...
          <p className="text-slate-700 leading-relaxed mb-8">
            Nous avons mis en place un pipeline de synchronisation automatique
            entre le référentiel ADEME et notre base de données, exécuté
            <strong> chaque semaine</strong> par un cron serveur sans aucune
            intervention manuelle. Voici les étapes du process :
          </p>
      ...
      <section className="bg-emerald-50/40 border-y border-emerald-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-14">
          ...
          <p className="text-slate-700 leading-relaxed mb-8">
            Avant de signer un devis de rénovation énergétique, prenez
            systématiquement ces trois précautions. Aucune aide publique
            n&apos;est versée si la qualification RGE n&apos;est pas active à
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed mb-3">
                    Notre moteur de recherche consulte notre base synchronisée
                    ADEME et retourne en temps réel le statut exact de la
                    qualification : active, expirée, ou inexistante. Saisissez
                    le nom de l&apos;entreprise, son SIRET, ou sa ville.
                  </p>
                  <Link
                    href="/verifier-artisan"
            ...
            <div className="p-6 bg-white rounded-2xl border border-emerald-200">
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed mb-3">
                    En cas de doute ou pour une vérification à la seconde
                    (sans latence de 7 jours), consultez directement le site
                    officiel de l&apos;ADEME — c&apos;est la source légale de
            ...
            <div className="p-6 bg-white rounded-2xl border border-emerald-200">
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed">
                    Tout artisan RGE de bonne foi dispose d&apos;un certificat
                    daté et signé par son organisme certificateur (Qualibat,
                    Qualit&apos;EnR, Qualifelec). Demandez-le avant signature
                    du devis — un refus ou un délai suspect doit vous alerter.
                    Ne vous fiez jamais à un simple logo RGE imprimé sur un
                    document commercial : c&apos;est la première fraude
      ...
      <section className="bg-white border-b border-slate-100">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-14">
          ...
          <p className="text-slate-600 max-w-3xl mb-10 leading-relaxed">
            Les sources publiques que nous consultons et vous recommandons
            pour aller plus loin sur la transition énergétique résidentielle
            en France.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {[
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group p-6 bg-white rounded-2xl border border-slate-200 hover:border-emerald-400 hover:shadow-md transition"
              >
                <div className="flex items-start justify-between gap-3 mb-2">
                  ...
                  <ExternalLink
                    className="w-4 h-4 text-slate-400 group-hover:text-emerald-600 flex-shrink-0 mt-1"
                    aria-hidden="true"
                  />
                </div>
                <p className="text-sm text-slate-600 leading-relaxed">
      ...
      <section className="bg-slate-50 border-y border-slate-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10">
          <div className="flex items-start gap-3 p-6 bg-white rounded-2xl border border-slate-200">
            <FileCheck2
            ...
            <div>
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                Données issues du référentiel &laquo; Annuaire des entreprises
                RGE &raquo; publié par l&apos;ADEME sur data.ademe.fr, mis à
                disposition sous{' '}
                <a
                ...
                . ServicesArtisans est un réutilisateur indépendant de ces
                données ; nous ne sommes pas affiliés à l&apos;ADEME, à
                l&apos;Anah ou à aucun organisme certificateur. Pour toute
                correction à la source, contactez directement l&apos;organisme
                ayant délivré la qualification (Qualibat, Qualit&apos;EnR,
                Qualifelec, Certibat).
              </p>
            </div>
          </div>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 py-14">
        ...
        <p className="text-slate-600 mb-10 leading-relaxed">
          Tout ce que vous devez savoir sur la provenance, la fiabilité et la
          mise à jour de nos données d&apos;artisans RGE.
        </p>
      ...
      {/* CTA final */}
      <section className="bg-gradient-to-br from-slate-800 to-emerald-900 text-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 text-center">
          ...
          <p className="text-slate-200 max-w-2xl mx-auto mb-8 leading-relaxed">
            Notre annuaire est synchronisé chaque semaine avec le référentiel
            officiel ADEME. Aucune saisie manuelle, aucune donnée
            auto-déclarée — vous accédez à la source officielle, reformatée
            pour une recherche fluide.
          </p>
