...
export const metadata: Metadata = {
  title: 'Partenaire CEE — Leads exclusifs RGE',
  description:
...
export default function DevenirPartenaireCeePage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/*  HERO                                                        */}
      {/* ============================================================ */}
      <section className="bg-gradient-to-br from-charcoal-900 via-charcoal-800 to-accent-900 text-white py-16 md:py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="inline-flex items-center gap-2 bg-accent-500/20 border border-accent-400/30 rounded-full px-4 py-1.5 mb-5">
            ...
            <span className="text-sm font-medium text-accent-100">Programme partenaire CEE</span>
          </div>
          <h1
            data-speakable="true"
          ...
          <p className="text-lg text-accent-50/90 max-w-3xl leading-relaxed mb-6">
          ...
          <div className="flex flex-wrap gap-3">
            <PartnerCtaLink
              ...
              className="inline-flex items-center gap-2 px-6 py-3.5 rounded-xl bg-accent-600 text-white font-semibold shadow-lg hover:bg-accent-500 transition"
            >
            ...
            <PartnerCtaPhone
              ...
              className="inline-flex items-center gap-2 px-6 py-3.5 rounded-xl border border-accent-400/30 text-accent-100 font-semibold hover:bg-accent-800/40 transition"
            >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-12">
            {[
              ...
              <div
                key={stat.label}
                className="bg-accent-800/30 border border-accent-400/20 rounded-xl p-4 text-center"
              >
                <div className="font-heading text-2xl md:text-3xl font-extrabold text-accent-300">
                  {stat.value}
                </div>
                <div className="text-sm text-accent-100/80 mt-1">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-sand-50 border-y border-charcoal-100">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
          <div className="flex items-center gap-2 mb-6">
            <Zap className="w-5 h-5 text-accent-700" aria-hidden="true" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {BENEFITS.map((b) => {
              ...
              return (
                ...
                >
                  <div className="w-10 h-10 rounded-xl bg-accent-50 border border-accent-100 flex items-center justify-center mb-3">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
        <div className="flex items-center gap-2 mb-3">
          <LayoutDashboard className="w-5 h-5 text-accent-700" aria-hidden="true" />
          <h2 className="font-heading text-2xl md:text-3xl font-extrabold text-charcoal-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          <article className="p-6 bg-white rounded-2xl border border-charcoal-200 hover:border-accent-400 transition">
            <div className="w-10 h-10 rounded-xl bg-accent-50 border border-accent-100 flex items-center justify-center mb-3">
              <FolderOpen className="w-5 h-5 text-accent-700" aria-hidden="true" />
            </div>
            <h3 className="font-heading font-bold text-lg text-charcoal-900 mb-2">
          ...
          <article className="p-6 bg-white rounded-2xl border border-charcoal-200 hover:border-accent-400 transition">
            <div className="w-10 h-10 rounded-xl bg-accent-50 border border-accent-100 flex items-center justify-center mb-3">
              <LineChart className="w-5 h-5 text-accent-700" aria-hidden="true" />
            </div>
            <h3 className="font-heading font-bold text-lg text-charcoal-900 mb-2">
      ...
      <section className="bg-sand-50 border-y border-charcoal-100">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
          <div className="flex items-center gap-2 mb-6">
            <Users className="w-5 h-5 text-accent-700" aria-hidden="true" />
            <h2 className="font-heading text-2xl md:text-3xl font-extrabold text-charcoal-900">
            ...
            <table className="w-full text-sm">
              <thead className="bg-sand-200 text-charcoal-700">
                <tr>
                  ...
                  <th className="text-left p-4 font-semibold text-accent-700">ServicesArtisans</th>
                  ...
                  <tr key={row.label} className="border-t border-charcoal-100">
                    ...
                    <td className="p-4 align-top">
                      <div className="flex items-start gap-2">
                        <CheckCircle2 className="w-4 h-4 text-accent-600 flex-shrink-0 mt-0.5" />
                        <span className="text-accent-700 font-semibold">{row.detail}</span>
                      </div>
                    </td>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {ELIGIBLE_OPERATIONS.map((op) => (
            <Link
              ...
              className="group p-5 bg-white rounded-2xl border border-charcoal-200 hover:border-accent-400 hover:shadow-lg transition"
            >
              <span className="inline-flex items-center px-2.5 py-1 rounded-full bg-accent-50 border border-accent-100 text-xs font-semibold text-accent-700 mb-2">
                {op.code}
              </span>
              <h3 className="font-heading font-bold text-charcoal-900 group-hover:text-accent-700 transition">
                {op.nom}
              </h3>
              <p className="text-sm text-accent-700 font-semibold mt-2">Prime : {op.prime}</p>
            </Link>
          ))}
        </div>
        <div className="mt-6">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 pt-6 pb-12">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 p-5 bg-sand-50 border border-charcoal-200 rounded-2xl">
          ...
          <PartnerCtaLink
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-accent-600 text-white font-semibold text-sm shadow hover:bg-accent-700 transition whitespace-nowrap"
          >
