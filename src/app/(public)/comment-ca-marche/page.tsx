    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'ServicesArtisans — Comment ça marche',
      },
    ],
  },
  twitter: {
...
const steps = [
  ...
  },
  {
    ...
    title: 'Contactez',
    description:
      'Contactez directement les artisans qui vous intéressent. Demandez des devis, appelez-les ou consultez leurs coordonnées complètes sans intermédiaire.',
    details: [
...
const trustReasons = [
  {
    ...
    description:
      "Chaque artisan est référencé via l'API officielle SIREN de l'État. Numéro SIRET, statut d'activité, date de création : des données fiables et à jour.",
  },
  {
    icon: MapPin,
  ...
  },
  {
    ...
    description:
      "Accédez à toutes les informations sans créer de compte. Pas de frais cachés, pas d'abonnement, pas de commission sur les travaux.",
  },
  {
    icon: FileText,
    title: 'Données officielles vérifiables',
    description:
      "Nous affichons uniquement des données vérifiables issues des registres officiels de l'État français (API SIREN, INSEE).",
  },
]
...
const faqs = [
  {
    ...
    answer:
      'Oui, ServicesArtisans est 100% gratuit pour les particuliers. Vous pouvez rechercher des artisans, consulter leurs profils et les contacter sans aucun frais ni inscription. Nous ne prenons aucune commission sur les travaux.',
  },
  {
    question: "D'où viennent les données des artisans ?",
    answer:
      "Les données proviennent de l'API SIREN de l'INSEE, la base de données officielle du gouvernement français qui recense toutes les entreprises. Chaque artisan est identifié par son numéro SIRET, ce qui garantit la fiabilité des informations.",
  },
  {
    question: 'Comment savoir si un artisan est toujours en activité ?',
    answer:
      "Les données SIREN incluent le statut d'activité de l'entreprise. Nous affichons uniquement les entreprises dont le statut est actif. Les informations sont régulièrement mises à jour grâce à l'API gouvernementale.",
  },
  {
    question: 'Puis-je demander un devis directement sur le site ?',
    answer:
      'Oui, vous pouvez remplir notre formulaire de demande de devis gratuit. Votre demande sera transmise aux artisans correspondant à votre besoin et à votre localisation. Vous recevrez des devis détaillés sans engagement.',
  },
  {
    question: "Quelle est la différence avec les autres annuaires d'artisans ?",
    answer:
      "ServicesArtisans se distingue par l'utilisation des données officielles de l'API SIREN gouvernementale, l'absence de faux avis, la gratuité totale sans inscription, et la couverture des 101 départements français.",
  },
  {
    question: 'Comment sont sélectionnés les artisans affichés ?',
    answer:
      "Nous n'effectuons pas de sélection subjective. Tous les artisans présents sur ServicesArtisans sont des entreprises inscrites aux registres officiels avec un code APE correspondant à une activité artisanale. La transparence est notre priorité.",
  },
]
...
export default async function CommentCaMarchePage() {
  ...
  const howToSchema = getHowToSchema([
    {
      name: 'Recherchez',
      text: "Trouvez le bon professionnel dans notre annuaire d'artisans. Recherchez par type de service et par ville dans les 101 départements français.",
    },
    {
      name: 'Comparez',
      text: 'Consultez les profils détaillés avec données SIREN officielles. Comparez les entreprises en toute transparence grâce aux données gouvernementales.',
    },
    {
      name: 'Contactez',
      text: 'Contactez directement les artisans. Demandez des devis, appelez-les ou consultez leurs coordonnées complètes sans intermédiaire.',
    },
  ])
    ...
    <>
      ...
      <div className="min-h-screen bg-sand-50">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-28 md:pt-14 md:pb-36">
            ...
            <div className="text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4 mt-8">
                ...
                <Link
                  href="/devis"
                  className="inline-flex items-center gap-2 text-charcoal-300 hover:text-white font-medium px-6 py-3 transition-colors"
                >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 w-full">
                      <div
                        className={`relative bg-gradient-to-br ${step.gradient} rounded-2xl p-12 text-white text-center overflow-hidden`}
                      >
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-4 mb-4">
                        <div className="w-12 h-12 bg-primary-100 rounded-xl flex items-center justify-center text-primary-500 font-bold text-xl">
                          {step.number}
                        </div>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-charcoal-600 max-w-2xl mx-auto">
                ServicesArtisans s'appuie sur les données officielles de l'État pour vous garantir
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {trustReasons.map((item) => {
                ...
                return (
                  <div
                    key={item.title}
                    className="text-center p-6 rounded-xl bg-sand-50 hover:bg-primary-50 transition-colors"
                  >
            ...
            {/* Stats bar */}
            <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 bg-gradient-to-r from-primary-500 to-primary-700 rounded-2xl p-8 text-white text-center">
              <div>
              ...
              <div>
                ...
                <div className="text-primary-100 text-sm mt-1">Départements couverts</div>
              </div>
              <div>
                <div className="text-3xl md:text-4xl font-bold">100%</div>
                <div className="text-primary-100 text-sm mt-1">Gratuit</div>
              </div>
              <div>
                <div className="text-3xl md:text-4xl font-bold">0</div>
                <div className="text-primary-100 text-sm mt-1">Faux avis</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-sand-50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-charcoal-900 mb-4">Questions fréquentes</h2>
        ...
        <section className="py-12 bg-white border-t">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-xl font-bold text-charcoal-900 mb-6">En savoir plus</h2>
            <div className="grid md:grid-cols-3 gap-6">
              <Link
                href="/services"
                className="bg-sand-50 p-6 rounded-xl hover:bg-primary-50 transition-colors border border-sand-300"
              >
                <h3 className="font-semibold text-charcoal-900 mb-2">Tous les services</h3>
              ...
              <Link
                ...
                className="bg-sand-50 p-6 rounded-xl hover:bg-primary-50 transition-colors border border-sand-300"
              >
                <h3 className="font-semibold text-charcoal-900 mb-2">Guide des prix</h3>
                <p className="text-charcoal-600 text-sm mb-3">
