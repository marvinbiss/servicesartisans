                ...
                {getQuartiersByVille(locationSlug).length > 0 && (
                  <div className="not-prose flex flex-wrap gap-2 mt-4">
                    {getQuartiersByVille(locationSlug).slice(0, 10).map(({ name, slug }) => (
                      <Link key={slug} href={`/villes/${locationSlug}/${slug}`} className="text-sm bg-sand-100 text-primary-600 px-3 py-1.5 rounded-full hover:bg-primary-50 hover:text-primary-700 transition-colors">
                        {name}
                      </Link>
                    ))}
                  </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            {locationContent.dataDriven.socioEconomic && (
              <div className="bg-gradient-to-br from-sand-50 to-clay-50/30 rounded-2xl border border-slate-100 p-8">
                ...
                <p className="text-charcoal-700 leading-relaxed">{locationContent.dataDriven.socioEconomic}</p>
                {communeData && (
                  <div className="mt-6 grid grid-cols-2 sm:grid-cols-4 gap-4">
                    {communeData.revenu_median && (
                      <div className="text-center p-3 bg-white rounded-xl border border-slate-100">
                        <div className="text-lg font-bold text-primary-600">{formatEuro(communeData.revenu_median)}</div>
                        <div className="text-xs text-charcoal-500 mt-1">Revenu médian/an</div>
                      </div>
                    )}
                    {communeData.nb_logements && (
                      <div className="text-center p-3 bg-white rounded-xl border border-slate-100">
                        <div className="text-lg font-bold text-primary-600">{formatNumber(communeData.nb_logements)}</div>
                    ...
                    {communeData.part_maisons_pct !== null && communeData.part_maisons_pct !== undefined && (
                      <div className="text-center p-3 bg-white rounded-xl border border-slate-100">
                        <div className="text-lg font-bold text-primary-600">{communeData.part_maisons_pct}%</div>
                        <div className="text-xs text-charcoal-500 mt-1">Maisons individuelles</div>
                      </div>
                    )}
                    {communeData.densite_population && (
                      <div className="text-center p-3 bg-white rounded-xl border border-slate-100">
                        <div className="text-lg font-bold text-primary-600">{formatNumber(Math.round(communeData.densite_population))}</div>
            ...
            {locationContent.dataDriven.immobilier && (
              <div className="bg-gradient-to-br from-amber-50/50 to-orange-50/30 rounded-2xl border border-amber-100 p-8">
                ...
                <p className="text-charcoal-700 leading-relaxed">{locationContent.dataDriven.immobilier}</p>
            ...
            {locationContent.dataDriven.marcheArtisanal && (
              <div className="bg-gradient-to-br from-emerald-50/50 to-green-50/30 rounded-2xl border border-emerald-100 p-8">
                ...
                <p className="text-charcoal-700 leading-relaxed">{locationContent.dataDriven.marcheArtisanal}</p>
                {communeData && (
                  <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 gap-4">
            ...
            {locationContent.dataDriven.energetique && (
              <div className="bg-gradient-to-br from-orange-50/50 to-red-50/30 rounded-2xl border border-orange-100 p-8">
                ...
                <p className="text-charcoal-700 leading-relaxed">{locationContent.dataDriven.energetique}</p>
                  ...
                  <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 gap-4">
                    {communeData.pct_passoires_dpe !== null && communeData.pct_passoires_dpe !== undefined && (
                      <div className="text-center p-3 bg-white rounded-xl border border-orange-100">
                        ...
                        <div className="text-xs text-charcoal-500 mt-1">Passoires thermiques (F/G)</div>
                      </div>
                    )}
            ...
            {locationContent.dataDriven.climatData && (
              <div className="bg-gradient-to-br from-sky-50/50 to-cyan-50/30 rounded-2xl border border-sky-100 p-8">
                ...
                <p className="text-charcoal-700 leading-relaxed">{locationContent.dataDriven.climatData}</p>
            ...
            {locationContent.dataDriven.demandeLocale && (
              <div className="bg-gradient-to-br from-violet-50/50 to-purple-50/30 rounded-2xl border border-violet-100 p-8">
                ...
                <p className="text-charcoal-700 leading-relaxed">{locationContent.dataDriven.demandeLocale}</p>
              </div>
            )}
            ...
            {locationContent.dataDriven.reglementation && (
              <div className="bg-gradient-to-br from-rose-50/50 to-pink-50/30 rounded-2xl border border-rose-100 p-8">
                ...
                <p className="text-charcoal-700 leading-relaxed">{locationContent.dataDriven.reglementation}</p>
              </div>
            )}
          </div>
        </section>
