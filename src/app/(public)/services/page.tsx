      ...
      <section className="relative bg-gradient-hero text-white py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 mb-6">
            ...
            <span className="text-sm font-medium text-white/90">{staticServicesList.length} m&eacute;tiers du b&acirc;timent</span>
          </div>
          ...
          <p className="text-xl text-sand-300 max-w-2xl mx-auto mb-10">
            Trouvez le professionnel id&eacute;al pour tous vos travaux.
            Artisans r&eacute;f&eacute;renc&eacute;s, devis gratuits.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <div className="flex items-center gap-3 px-5 py-3 bg-white/10 backdrop-blur-sm rounded-xl border border-white/10">
              ...
              <div className="text-left">
                ...
                <div className="text-xs text-sand-400">Temps de r&eacute;ponse</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="font-heading text-3xl md:text-4xl font-bold text-white mb-4 tracking-tight">
            Vous ne trouvez pas votre m&eacute;tier ?
          </h2>
          <p className="text-xl text-sand-300 mb-10 max-w-xl mx-auto">
            Contactez-nous et nous vous aiderons &agrave; trouver le bon artisan pour votre projet.
          </p>
          <Link
            href="/contact"
