    ...
    <>
      ...
      <div className="min-h-screen bg-sand-50">
        ...
        <section className="relative bg-charcoal-950 text-white overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-28 md:pt-14 md:pb-36">
            ...
            <div className="text-center">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-primary-400/10 text-primary-200 rounded-full text-sm font-medium mb-6 border border-primary-400/20">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 relative z-10 pb-16">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-sand-200 p-6 text-center">
              ...
              <div className="text-sm text-charcoal-500 mt-1">Villes couvertes</div>
            </div>
            <div className="bg-white rounded-2xl shadow-lg border border-sand-200 p-6 text-center">
              ...
              <div className="text-sm text-charcoal-500 mt-1">Taux de vérification</div>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link
              ...
              className="hidden sm:inline-flex items-center gap-2 text-sm font-medium text-primary-500 hover:text-primary-800"
            >
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-4 mt-1.5 text-xs text-charcoal-500">
                  ...
                  <ArrowRight className="w-4 h-4 text-sand-500 group-hover:text-primary-400 transition-colors flex-shrink-0" />
                </Link>
              )
            })}
          </div>
          ...
          <div className="mt-6 sm:hidden text-center">
            <Link
              href="/barometre/tarifs"
              className="inline-flex items-center gap-2 text-sm font-medium text-primary-500 hover:text-primary-800"
            >
              Voir tous les métiers <ArrowRight className="w-4 h-4" />
            </Link>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {topVilles.map((v, idx) => {
                ...
                return (
                  <div
                    key={v.ville_slug}
                    className="flex items-center gap-4 bg-sand-50 rounded-xl border border-sand-300 p-4"
                  >
                    <span className="text-lg font-bold text-charcoal-400 w-8 text-center flex-shrink-0">
                      {idx + 1}
                    </span>
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-1">
                        <span className="font-semibold text-charcoal-900">{v.ville}</span>
                        <span className="text-sm font-medium text-charcoal-600">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="bg-gradient-to-br from-charcoal-900 to-charcoal-800 rounded-2xl p-8 md:p-12 text-white">
            <div className="flex items-center gap-3 mb-4">
              <Code className="w-6 h-6 text-primary-300" />
              <h2 className="text-2xl font-bold">Citer ces données</h2>
            </div>
            <p className="text-charcoal-300 mb-6 max-w-2xl">
              Vous pouvez utiliser les données du Baromètre des Artisans dans vos articles, études
              ou sites web. Merci de toujours inclure l'attribution suivante :
            </p>
            <div className="bg-charcoal-950/50 rounded-lg p-4 font-mono text-sm text-charcoal-300 mb-6 overflow-x-auto">
              <code>
                Source : &lt;a href=&quot;{SITE_URL}/barometre&quot;&gt;{SITE_NAME} — Baromètre des
                Artisans&lt;/a&gt;
              </code>
            </div>
        ...
        <section className="bg-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="bg-sand-50 rounded-xl border border-sand-300 p-6 text-left mb-6">
                <p className="font-mono text-sm text-charcoal-700 mb-2">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-xl border border-sand-300 p-6">
              ...
              <h3 className="font-semibold text-charcoal-900 mb-2">Avis authentifiés</h3>
              <p className="text-sm text-charcoal-600">
                Les avis sont collectés auprès de clients ayant effectivement fait appel à
                l'artisan. Chaque avis est modéré avant publication.
              </p>
            </div>
            <div className="bg-white rounded-xl border border-sand-300 p-6">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              ...
              <div>
                <p className="font-semibold text-charcoal-900 group-hover:text-primary-500">
                  Tous les métiers
                </p>
                <p className="text-sm text-charcoal-500">Stats par corps de métier</p>
              </div>
            </Link>
            <Link
              href="/barometre/regions"
