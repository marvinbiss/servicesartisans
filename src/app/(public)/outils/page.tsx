        ...
        <section className="relative bg-[#0a0f1e] text-white overflow-hidden">
          <div className="absolute inset-0">
            <div
              ...
              style={{
                background:
                  'radial-gradient(ellipse 80% 50% at 50% -10%, rgba(37,99,235,0.18) 0%, transparent 60%), radial-gradient(ellipse 60% 60% at 80% 110%, rgba(99,102,241,0.1) 0%, transparent 50%)',
              }}
            />
            <div
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-28 md:pt-16 md:pb-36">
            <div className="text-center max-w-3xl mx-auto">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-500/20 backdrop-blur-sm border border-blue-400/30 rounded-full mb-6">
                ...
                <span className="text-sm font-semibold text-blue-200">{tools.length} outils gratuits</span>
              </div>
              ...
              <p className="text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed">
                Estimez le coût de vos travaux ou trouvez le bon artisan en quelques clics.
                Nos outils sont gratuits, sans inscription et disponibles 24h/24.
              </p>
            </div>
          </div>
        </section>
              ...
              {tools.map((tool) => {
                ...
                return (
                  <Link
                    key={tool.href}
                    href={tool.href}
                    className={`group bg-white rounded-xl border border-gray-200 p-6 hover:shadow-lg ${tool.borderHover} transition-all`}
                  >
                    <div className="flex items-start gap-4">
                      <div className={`flex-shrink-0 w-14 h-14 ${tool.bg} rounded-xl flex items-center justify-center`}>
            ...
            <div className="grid gap-4 md:grid-cols-3">
              {relatedPages.map((page) => (
                <Link
                  key={page.href}
                  href={page.href}
                  className="group bg-gray-50 rounded-lg border border-gray-200 p-5 hover:shadow-md hover:border-blue-200 transition-all"
                >
