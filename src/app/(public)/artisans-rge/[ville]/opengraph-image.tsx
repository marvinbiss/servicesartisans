...
export const alt = 'ServicesArtisans — Annuaire des artisans RGE'
export const size = {
  width: 1200,
  height: 630,
}
    ...
    >
      <div
        style={{
          ...
          bottom: 0,
          background:
            'radial-gradient(ellipse at 30% 20%, rgba(16, 185, 129, 0.35) 0%, transparent 50%), radial-gradient(ellipse at 70% 80%, rgba(245, 158, 11, 0.18) 0%, transparent 55%)',
          display: 'flex',
        }}
      />
      <div
      ...
      >
        ...
        >
          Source officielle ADEME · MaPrimeRénov&apos; · CEE
        </div>
        <div
          style={{
            display: 'flex',
