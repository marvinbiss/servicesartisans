      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <main id="main-content">
          ...
          >
            ...
            <p>
              La messagerie interne est en lecture seule : vos clients ne reçoivent plus de nouveaux
              messages ici. Pour les recontacter, utilisez le téléphone ou l'email indiqués dans la
              demande de devis.
            </p>
          </div>
          {error && (
                ...
                {selectedConversation ? (
                  <>
                    ...
                    <div className="p-4 border-t bg-sand-50 text-center text-sm text-charcoal-500">
                      Messagerie en lecture seule. Recontactez ce client via le téléphone ou l'email
                      de sa demande de devis.
                    </div>
                  </>
                ) : (
