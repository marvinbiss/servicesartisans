  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2">
        ...
        <h3 className="text-base font-semibold text-charcoal-900">Créneaux de disponibilité</h3>
      </div>

      <p className="text-sm text-charcoal-500">
        Ajoutez des créneaux sur lesquels vos clients peuvent prendre rendez-vous. Les horaires
        d&apos;ouverture ci-dessus définissent vos heures générales ; les créneaux ci-dessous sont
        les plages horaires précises ouvertes à la réservation.
      </p>
      ...
      <div className="bg-sand-50 border border-sand-200 rounded-xl p-4 space-y-4">
        ...
        <div className="flex flex-wrap items-end gap-3">
          ...
          <button
            ...
            aria-busy={saving}
            className="inline-flex items-center gap-2 px-4 py-2 bg-primary-500 text-white rounded-lg text-sm font-medium hover:bg-primary-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        return (
          <div key={date} className="border border-sand-200 rounded-xl overflow-hidden">
            ...
            <div className="bg-sand-50 px-4 py-2.5 flex items-center gap-2 border-b border-sand-200">
              ...
              <span className="text-sm text-charcoal-500">{formatDateLabel(date)}</span>
