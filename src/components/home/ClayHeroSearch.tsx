...
export function ClayHeroSearch() {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex items-center gap-2" role="search" aria-label="Rechercher un artisan" onKeyDown={handleKeyDown}>
      {/* Service input */}
      <div ref={serviceRef} className="relative flex-1 min-w-0">
        <div className="flex items-center gap-2 bg-white border border-stone-200 rounded-xl px-3 h-11 focus-within:border-clay-400 focus-within:ring-1 focus-within:ring-clay-400/20 transition-all">
