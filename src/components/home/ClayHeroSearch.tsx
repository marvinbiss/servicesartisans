  ...
  return (
    <form onSubmit={handleSubmit} className="flex items-center gap-3" role="search" aria-label="Rechercher un artisan" onKeyDown={handleKeyDown}>
      ...
      <div ref={serviceRef} className="relative flex-1 min-w-0">
        <div className="flex items-center gap-2.5 bg-white border border-stone-200 rounded-2xl px-4 h-14 focus-within:border-clay-400 focus-within:ring-2 focus-within:ring-clay-400/20 transition-all">
      ...
      <button
        type="submit"
        className="bg-clay-400 hover:bg-clay-600 text-white font-bold text-base px-7 h-14 rounded-2xl shrink-0 transition-colors duration-200"
      >
        Trouver
      </button>
    </form>
