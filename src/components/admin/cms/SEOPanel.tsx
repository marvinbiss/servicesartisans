    ...
    <div className="bg-white rounded-xl shadow-sm border border-sand-100 overflow-hidden">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="font-medium text-charcoal-900">Référencement (SEO)</span>
      ...
      {/* Collapsible content */}
      {isOpen && (
        <div className="border-t border-sand-100 p-4 space-y-6">
          {/* Meta title */}
          <div>
            <div className="flex items-center justify-between mb-1.5">
              <label className="text-sm font-medium text-charcoal-700">Titre meta</label>
              <span
                className={`text-xs ${
                  titleLength > titleMax ? 'text-red-600 font-medium' : 'text-charcoal-400'
                }`}
              >
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              <label className="text-sm font-medium text-charcoal-700">Meta description</label>
              <span
                className={`text-xs ${
