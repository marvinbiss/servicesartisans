...
export function CeeFunnelChart({ steps }: CeeFunnelChartProps) {
  ...
  return (
    <div className="bg-white border border-sand-200 shadow-sm rounded-xl p-5">
      <h3 className="text-sm font-semibold text-charcoal-700 mb-4">Funnel des dossiers</h3>
          ...
          return (
            <div key={step.label}>
              <div className="flex items-center justify-between mb-1">
                <span className="text-xs text-charcoal-600">{step.label}</span>
                <span className="text-xs font-semibold text-charcoal-900">{step.count}</span>
              </div>
              <div className="w-full h-4 bg-sand-100 rounded-full overflow-hidden">
                <div
