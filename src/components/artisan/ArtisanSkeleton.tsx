...
export function ArtisanPageSkeleton() {
  return (
    <div className="min-h-screen bg-sand-50 pb-24 md:pb-8">
      {/* Header skeleton */}
      <div className="bg-white border-b border-sand-200 sticky top-0 z-40">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-sand-200 p-6">
              ...
              <div className="space-y-3">
                {[1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="flex justify-between items-center p-4 rounded-xl bg-sand-50"
                  >
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-sand-200 p-6">
              ...
              <div className="space-y-6">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="pb-6 border-b border-sand-200">
      ...
      {/* Mobile CTA Skeleton */}
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-sand-300 p-4 md:hidden">
        <div className="flex gap-3">
...
export function ArtisanHeroSkeleton() {
  return (
...
export function ArtisanSidebarSkeleton() {
  return (
    <div className="bg-white rounded-2xl shadow-lg border border-sand-200 p-6 sticky top-24">
