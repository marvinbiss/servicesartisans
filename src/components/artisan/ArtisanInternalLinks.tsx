              ...
              <div className="flex flex-wrap gap-2">
                {nearbyCities.map(city => (
                  <Link
                    ...
                    className="inline-flex items-center px-3 py-1.5 bg-gray-100 hover:bg-primary-100 text-gray-700 hover:text-primary-700 rounded-full text-sm transition-colors"
                  >
                    {city.name}
                  </Link>
                ))}
            ...
            <div className="space-y-2">
              {region && (
                <Link
                  ...
                  className="block px-3 py-2 bg-gray-100 hover:bg-primary-100 text-gray-700 hover:text-primary-700 rounded-lg text-sm transition-colors"
                >
                  Artisans en {region}
                </Link>
              )}
