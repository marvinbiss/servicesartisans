...
export function SocialProofBadge({ specialty, city }: SocialProofBadgeProps) {
  return (
    <div className="animate-fade-in-up bg-accent-50 border border-accent-200 rounded-xl px-4 py-3 flex items-center gap-3">
      ...
      <p className="text-sm font-medium text-accent-800 leading-snug">
        ...
        <span className="font-semibold">
          {specialty.toLowerCase()}s à {city}
        </span>{' '}
        sont disponibles pour vos travaux
      </p>
    </div>
  )
}
