...
export default function ProviderCard({
  ...
  return (
    <div
      className={`relative overflow-hidden rounded-2xl border border-gray-100/80 bg-white p-6 transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] before:absolute before:inset-x-0 before:top-0 before:h-[3px] before:bg-gradient-to-r before:from-blue-500 before:via-blue-400 before:to-indigo-500 before:opacity-0 before:transition-opacity before:duration-300 ${
        isHovered
    ...
    >
      ...
      <div className="flex gap-3">
        <Link
          ...
          className="flex-1 py-3 text-center bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700 hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200"
        >
          Demander un devis
        </Link>
        {provider.phone && (
          <a
            ...
            className="group flex-1 flex items-center justify-center gap-2 py-3 border-2 border-gray-300 text-gray-700 rounded-xl font-semibold hover:bg-gray-50 hover:border-gray-400 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200"
          >
