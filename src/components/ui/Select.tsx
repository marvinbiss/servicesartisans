  ...
  (
    ...
    return (
      <div className={clsx('w-full', containerClassName)}>
        {label && (
          <label htmlFor={selectId} className="block text-sm font-medium text-charcoal-700 mb-1">
            {label}
        ...
        <div className="relative">
          ...
          <select
            ...
            className={clsx(
              ...
              'px-4 py-2.5 pr-10 text-charcoal-900',
          ...
          <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none text-charcoal-400">
