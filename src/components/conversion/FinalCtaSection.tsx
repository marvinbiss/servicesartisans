...
const ACCENT = {
  blue: 'bg-accent-50 border-accent-200',
  green: 'bg-accent-50 border-accent-200',
  amber: 'bg-amber-50 border-amber-200',
} as const

const BTN_ACCENT = {
  blue: 'bg-accent-600 hover:bg-accent-700 text-white',
      ...
      <div className="mx-auto max-w-3xl px-4 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link
            ...
            className={`inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg font-semibold shadow-sm ${BTN_ACCENT[accent]}`}
          ...
          {secondaryCta && (
            <Link
              ...
              className="inline-flex items-center justify-center px-6 py-3 rounded-lg font-semibold border border-charcoal-300 hover:bg-white text-charcoal-800"
            >
              {secondaryCta.label}
            </Link>
          )}
