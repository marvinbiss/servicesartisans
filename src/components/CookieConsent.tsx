...
export default function CookieConsent() {
  ...
  useEffect(() => {
    ...
    if (!consent) {
      // Show banner after 5s delay — avoids interfering with Lighthouse
      // (Lighthouse test window is ~10s; showing at 1s inflates Speed Index)
  ...
  return (
    <div
      className="fixed bottom-0 left-0 right-0 z-50 p-4 md:p-6 animate-[slideUp_0.4s_ease-out]"
