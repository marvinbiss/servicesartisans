...
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `profiles`        | id, email, full_name, company_name, role, is_admin, phone_e164, avatar_url, address, city, postal_code, subscription_plan, subscription_status, stripe_customer_id, two_factor_enabled | discriminateur = `role` ('client'/'artisan'/'super_admin'). PAS de colonne `user_type`/`average_rating`/`review_count`. **RLS réactivé mig 532** (était OFF depuis drift Feb 13) |
